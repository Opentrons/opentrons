...
def run(protocol: ProtocolContext) -> None:
    ...
    try:
        ...
        if STEP_EZ_FRERAT:
            ...
            p1000.dispense(
                FRERATVol, location=sample_plate_1.wells_by_name()["A1"].bottom()
            )
        ...
        if STEP_MC_ERAT:
            ...
            p1000.dispense(
                ERATVol, location=sample_plate_1.wells_by_name()["A1"].bottom()
            )
        ...
        if STEP_LIG:
            ...
            p1000.aspirate(AdapterVol + 1, location=Adapter.bottom())
            p1000.dispense(
                AdapterVol, location=sample_plate_1.wells_by_name()["A1"].bottom()
            )
            ...
            p1000.flow_rate.blow_out = p96x_50_flow_rate_blow_out_default * 0.5
            # ===============================================
            p1000.aspirate(LIGVol, location=LIG.bottom())
            p1000.default_speed = 100
            p1000.move_to(LIG.top(z=3))
            protocol.delay(seconds=1)
            p1000.default_speed = 400
            p1000.dispense(LIGVol, location=sample_plate_1["A1"].bottom())
            p1000.move_to(sample_plate_1["A1"].bottom(z=dot_bottom))
        ...
        if STEP_CLEANUP_1:
            ...
            p1000.aspirate(ETOHMaxVol + 10, location=ETOH_Reservoir["A1"].bottom())
            ...
            p1000.aspirate(RSBVol, location=RSB.bottom())
        ...
        if STEP_PCR:
            ...
            p1000.aspirate(PCRVol, location=PCR.bottom())
            p1000.dispense(PCRVol, location=sample_plate_2["A1"].bottom())
        ...
        if STEP_CLEANUP_2:
            ...
            p1000.prepare_to_aspirate()
            p1000.aspirate(CleanupBeadVol, location=CleanupBead.bottom())
