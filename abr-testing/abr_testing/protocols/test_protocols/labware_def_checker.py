...
def add_parameters(parameters: ParameterContext) -> None:
    ...
    parameters.add_str(
            ...
            choices=[
                {"display_name": "Axygen 500 ul Well Plate", "value": "axygen_96_wellplate_500ul"},
                {"display_name": "Corn96Wellplate 360 ul Lid", "value": "corning_96_wellplate_360ul_lid"},
                {"display_name": "SMC384well Read Plate", "value": "smc_384_read_plate"},
                {"display_name": "ibidi96 SqrWellFltBtmPlt300µL", "value": "ibidi_96_square_well_plate_300ul"}
            ],
...
def run(protocol: ProtocolContext) -> None:
    labware_type = protocol.params.labware_type 
    heater_shaker = protocol.params.heater_shaker
