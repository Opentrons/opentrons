...
def run(ctx: protocol_api.ProtocolContext):
    ...
    nunc_filter_plate = manifold_collar.load_labware("nunc_96_well_filter_plate", "Nunc Filter Plate") 
    ...
    silica_plate = silica_plate_base.load_labware("luna_silica_96_plate", 'Silica membrane plate')
