...
def run(ctx: protocol_api.ProtocolContext) -> None:
    ...
    nunc_filter_plate = manifold_collar.load_labware(
        "nunc_96_well_filter_plate", "Nunc Filter Plate"
    )
    ...
    silica_plate = silica_plate_base.load_labware(
        "luna_silica_96_plate", "Silica membrane plate"
    )
    ...
    pip_96_1000 = ctx.load_instrument(
        "flex_96channel_1000",
        "left",
        # tip_racks=[tips_1000_1, tips_1000_2, tips_1000_3, tips_1000_4, tips_1000_5, tips_1000_6]
        tip_racks=tip_racks,
    )
