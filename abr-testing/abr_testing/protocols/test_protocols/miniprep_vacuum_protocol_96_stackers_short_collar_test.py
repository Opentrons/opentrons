...
def run(ctx: protocol_api.ProtocolContext):
    ...
    manifold_collar = vm_mod.load_adapter(
    ...
    if total_tipboxes > 2 and process_by == 'plate':
        stacker_tips = ctx.load_module("flexStackerModuleV1", "C3")
        tipboxes_on_deck = 2
    ...
    if lysis_type == 'pipette':
        with ctx.group_steps(name="Step 1 - P1 Buffer Dispensing and Pellet Resuspension", description="Add P1 Buffer to Sample plate and resuspend pellet"):
    ...
    if lysis_type == 'vortex':
        ...
        # ║  STEP 2 — P2 BUFFER DISPENSING AND MIXING                            ║
        # ╚══════════════════════════════════════════════════════════════════════╝
        with ctx.group_steps(name="Step 4 - P2 Buffer Dispensing and Mixing", description="Add P2 Buffer to Sample plate and mix"):
            ctx.comment("=== Adding P2 Buffer to Sample plate ===")
        ...
        # ║  STEP 3 — N3 BUFFER DISPENSING, MIXING, AND TRANSFER TO FILTER PLATES║
        # ╚══════════════════════════════════════════════════════════════════════╝
        with ctx.group_steps(name="Step 5 - N3 Buffer Dispensing, Mixing, and Transfer to Filter Plates", description="Add N3 Buffer to Sample plate and mix"):
            ctx.comment("=== Adding N3 Buffer to Sample plate ===")
    ...
    # ╚══════════════════════════════════════════════════════════════════════╝
    with ctx.group_steps(name="Step 6 - Vacuum Filter Plate", description="Vacuum the filter plate"):
    ...
    # ╚══════════════════════════════════════════════════════════════════════╝
    with ctx.group_steps(name="Step 7 - Transfer from Collection Plate to Silica Membrane Plate", description="Transfer the collection plate to the silica membrane plate"):
    ...
    # ╚══════════════════════════════════════════════════════════════════════╝
    with ctx.group_steps(name="Step 8 - Vacuum Silica Membrane Plate and Wash", description="Vacuum the silica membrane plate and wash"):
    ...
    # ║  STEP 7 — ELUTE                                                      ║
    # ╚══════════════════════════════════════════════════════════════════════╝
    with ctx.group_steps(name="Step 9 - Elute DNA from Silica Plate", description="Elute DNA from the silica plate"):
