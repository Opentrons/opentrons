...
metadata = {
    "protocolName": """Duolink PLA for Microscopy (Multiwell Plate Assay
    with 96 Square Well Culture Plate) - Day 1""",
...
def run(ctx: ProtocolContext) -> None:
    ...
    def heat(min: float) -> None:
        """Heat the plate to 37 degree C for a specified time."""
    ...
    def transfer(start: Well, vol: float) -> None:
        """Transfer liquid from start to rxn_full and rxn_remainder wells."""
