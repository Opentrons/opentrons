...
silica membrane plate on its C1 base, redistributes recovered liquid into the
reagent reservoir (liquid-setup style), restores the parked sample and filter
plates, and resets tip racks.
"""
...
metadata = {
    "author": "Opentrons",
    "protocolName": "Reverse Minipreps with 96-Channel Pipette (Return Tips)",
