...
def plate_reader_commands(file_results: Dict[str,Any], hellma_plate_standards: List[Dict[str, Any]])-> Dict[str, float]:
    ...
    initialize_count, avg_initialize_time = count_command_in_run_data(commandData, "absorbanceReader/initialize", True)
        ...
        if commandType == "absorbanceReader/openLid" or commandType == "absorbanceReader/closeLid":
            ...
            for item in hellma_plate_standards:
                ...
                if str(wavelength) == str(wavelength_of_interest):
                    error_cells = plate_reader.check_byonoy_data_accuracy(result_ndarray, item, False)
