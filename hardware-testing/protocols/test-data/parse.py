...
GRAV_FILE_NAME = 'ot2-p300-single-channel-gravimetric_run-220726195548_GravimetricRecorder-P3HSV212021030505.csv'
PIP_FILE_NAME = 'ot2-p300-single-channel-gravimetric_run-220726195548_PipetteLiquidClass-P3HSV212021030505.csv'
GRAV_PATH = Path(__file__).parent / GRAV_FILE_NAME
PIP_PATH = Path(__file__).parent / PIP_FILE_NAME

if __name__ == '__main__':
    ctx = get_api_context('2.12', is_simulating=True)
