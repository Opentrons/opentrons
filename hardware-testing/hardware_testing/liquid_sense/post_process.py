        ...
        with open(final_report_file, "w", newline="") as final_report:
            ...
            if google_sheet:
                try:
                    ...
                    google_sheet.batch_update_cells(
                        pressure_header_for_google_sheet, "G", 10, sheet_id
                    )
            ...
            for tip in tips:
                ...
                if google_sheet:
                    ...
                    try:
                        google_sheet.batch_update_cells(
                            transposed_pressure_rows, "G", 11, sheet_id
                        )
                    except google_sheets_tool.google_interaction_error:
...
def process_google_sheet(
    ...
    adjusted_height_range = "F11:E" + str(last_trial_row)
    ...
    heights_range = "C11:B" + str(last_trial_row)
