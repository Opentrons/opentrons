...
def run(protocol: protocol_api.ProtocolContext):
    ...
    hs_deepwell_adapter = protocol.load_adapter('opentrons_96_deep_well_adapter', location=protocol_api.OFF_DECK)
    ...
    tiprack_200 = protocol.load_labware('opentrons_flex_96_tiprack_200ul', location = "B2")
    tiprack_1000 = protocol.load_labware('opentrons_flex_96_tiprack_1000ul', location = "C2")

    # LOAD PIPETTES
    p1000 = protocol.load_instrument("flex_1channel_1000", "left", tip_racks=[tiprack_1000, tiprack_200, tiprack_50])
    m1000 = protocol.load_instrument("flex_8channel_1000", "right", tip_racks=[tiprack_1000, tiprack_200, tiprack_50])



    # # GRIPPER MOVED
    def move_to_new_location(labware, slot, p_x_off=0, p_y_off=0, p_z_off=0, d_x_off=0, d_y_off=0, d_z_off=0):
