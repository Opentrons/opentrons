...
def build_arg_parser():
    ...
    arg_parser.add_argument('-a', '--axis', choices=['x','y','z'], required=False, help='Sets the axis for testing', default='y')
...
if __name__ == '__main__':
    ...
    test = Gripper_Center_Test(args.simulate, args.cycles, args.force, args.time, args.slot)
