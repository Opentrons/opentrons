...
async def _main(is_simulating: bool) -> None:
    ...
    for cycle in range(CYCLES):
        ...
        ### time.sleep(1)
        await home_ot3(api, [OT3Axis.X, OT3Axis.Y, OT3Axis.Z_R])
        # MOVE_POS = Point(227.826, 362.808, 250.0) #Point(235.414, 385.308, 509.15)
        # FIXTURE_POS = Point(227.826, 362.808, 44.61) #Point(235.414, 385.308, 303.965)
        await api.move_to(MOUNT, Point(228.019, 159.318, 250.00)) #, speed = 50) ### Y-Axis Point(x=80.72599999999997, y=366.30600000000004, z=108.41000000000003)
        await api.move_to(MOUNT, Point(228.019, 159.318, 65.012)) #, speed = 50) ### Y-Axis
        await api.move_to(MOUNT, Point(228.019, 169.318, 65.012)) ### Y-Axis ### Point(x=236.21799999999996, y=66.227, z=371.85900000000004)
        ### x=208.219, y=153.517, z=109.00900000000001)
        ### Point(x=209.02999999999997, y=255.93, z=109.71000000000004) X-Axis
        ### Point(x=228.019, y=164.318, z=65.01200000000006)Y-Axis
        ...
        print("\n--STALLING--\n")
        await api.move_to(MOUNT, Point(228.019, 159.318, 65.012)) #, speed = 50)
        ### await api.move_to(MOUNT, Point(214.03, 255.93, 150.00)) #, speed = 50) #uncomment for x
        await api.move_to(MOUNT, Point(228.019, 10.318, 65.012)) #, speed = 50)
        ### Point(x=-23.251000000000033, y=433.3, z=509.15)
        ### Point(x=-25.952000000000055, y=255.93, z=150.71300000000002)
        try:
        ...
        await api.move_to(MOUNT, Point(228.019, 10.318, 65.012)) #, speed = 50) ### Y-Axis
        await api.move_to(MOUNT, Point(228.019, 159.318, 65.012)) #, speed = 50) ### Y-Axis
        ### await api.move_to(MOUNT, Point(214.03, 255.93, 109.71)) #, speed = 50) ### Y-Axis
        await api.move_to(MOUNT, Point(228.019, 169.318, 65.012)) #, speed = 50) ### Y-Axis
        ...
        await api.move_to(MOUNT, Point(228.019, 159.318, 65.012))
        await api.move_to(MOUNT, Point(228.019, 159.318, 200.0)) ### X-Axis
