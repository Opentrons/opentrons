...
class Plot:
    def __init__(self, data):
        ...
        self.PLOT_FONT = 16
        self.PLOT_PATH = "plot_gripper_lifetime/"
    ...
    def gripper_jaw_plot(self):
        ...
        y_avg_text = f"Avg Displacement = {y_avg}mm ± {y_range}mm"
        ...
        self.plot_param["title"] = f"Gripper Jaw Encoder (State = {state}, Period = 1/4 Lifetime)"
