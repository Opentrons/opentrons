...
async def _main(is_simulating: bool, mount: types.OT3Mount) -> None:
    ...
    slot_loc = {
        "A1": helpers_ot3.get_theoretical_a1_position(
        10, "opentrons_flex_96_tiprack_50ul")+ Point(z=1),
        "A2": helpers_ot3.get_theoretical_a1_position(
        11, "opentrons_flex_96_tiprack_200ul"),
        "A3": helpers_ot3.get_theoretical_a1_position(
        12, "opentrons_flex_96_tiprack_1000ul"),
        "B1": helpers_ot3.get_theoretical_a1_position(
        7, "opentrons_flex_96_tiprack_50ul"),
        "B2": helpers_ot3.get_theoretical_a1_position(
        8, "opentrons_flex_96_tiprack_200ul"),
        "B3": helpers_ot3.get_theoretical_a1_position(
        9, "opentrons_flex_96_tiprack_1000ul"),
        "C1":helpers_ot3.get_theoretical_a1_position(
        4, "opentrons_flex_96_tiprack_50ul"),
        "C2": helpers_ot3.get_theoretical_a1_position(
        5, "opentrons_flex_96_tiprack_200ul"),
        "C3": helpers_ot3.get_theoretical_a1_position(
        6, "opentrons_flex_96_tiprack_1000ul"),
        "D1":helpers_ot3.get_theoretical_a1_position(
        1, "opentrons_flex_96_tiprack_50ul"),
        "D2": helpers_ot3.get_theoretical_a1_position(
        2, "opentrons_flex_96_tiprack_200ul"),
        "D3": helpers_ot3.get_theoretical_a1_position(
                ...
                for row in range(ROWS):
                    ...
                    for pick_up in range(PICKUPS_PER_TIP):
                        ...
                        if check_tip_presence:
                            #tip_presence_pick_up = await api.get_tip_presence_status(mount)

                            tip_presence_pick_up2 = await api.get_tip_presence_status(mount)
                            print("tip_presence_eject",tip_presence_pick_up2)
                            #print("TipPresenceStatus.from_hw_state(status)2",TipPresenceStatus.from_hw_state(tip_presence_pick_up2))
                            tip_presence_pick_up = TipPresenceStatus.from_hw_state(tip_presence_pick_up2)
                            print("tip_presence_pick_up",tip_presence_pick_up,type(tip_presence_pick_up))
                            #pick_up_keys = list(tip_presence_pick_up.keys())
                            if tip_presence_pick_up == TipPresenceStatus.PRESENT:#(tip_presence_pick_up[pick_up_keys[0]]):
                                print("\t>> Tip detected!\n")
                        ...
                        if check_tip_presence:
                            tip_presence_eject2 = await api.get_tip_presence_status(mount)
                            print("tip_presence_eject",tip_presence_eject2)
                            #print("TipPresenceStatus.from_hw_state(status)",TipPresenceStatus.from_hw_state(tip_presence_eject2))
                            tip_presence_eject = TipPresenceStatus.from_hw_state(tip_presence_eject2)
                            print("tip_presence_eject:",tip_presence_eject)
                            #drop_tip_keys = list(tip_presence_eject.keys())
                            if tip_presence_eject != TipPresenceStatus.ABSENT:#(tip_presence_eject[drop_tip_keys[0]]):
                                print("GET Tip presenc{}".format(tip_presence_eject))
