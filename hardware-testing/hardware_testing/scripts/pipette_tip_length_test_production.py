...
async def _main() -> None:
    ...
    tip_overlap = 10.5
    tip_length = {"T1K": 95.6-tip_overlap, "T200": 58.35-tip_overlap, "T50": 57.9-tip_overlap, "T20": 52-tip_overlap}
    dial_data = {
                "Pipette id": None,
                "Noz_Height(mm)": None,
                "Tip_Height(mm)": None,
    ...
    if args.dial_indicator:
        ...
        dial_point = Point(slot_loc[args.dial_slot][0],
    ...
    if args.tiprack:
        cp = CriticalPoint.NOZZLE
        tiprack_point = Point(slot_loc[args.tiprack_slot][0],
