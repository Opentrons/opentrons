...
# Normal high-throughput plunger settings for the Flex 96-channel pipettes.
# These match the OT-3 motion defaults and the p200_96_v3.1/p1000_96_v3.4
# pipette definitions used by this script.
SPEEDS_TO_TEST: float = 15
...
async def main(args: argparse.Namespace, cfg: TestConfig) -> None:
    ...
    default_acceleration = settings.acceleration
    ...
    testing_data_dir = Path("/data/testing_data")
    testing_data_dir.mkdir(parents=True, exist_ok=True)
    csv_path = testing_data_dir / f"P200H_LT_{pip_id}_{today}.csv"
    print(f"Test data file: {csv_path}")
