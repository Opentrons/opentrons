...
class TestConfig:
    ...
    simulate: bool
    pipette: Literal[200, 1000,50]
    blowout:int
    blowoutnum:int
    pipettetype:Literal[96,8,1]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cycles", type=int, default=75000)
    parser.add_argument("--simulate", action="store_true")
    parser.add_argument("--pipette", type=int, choices=[200, 1000], default=200)
    parser.add_argument("--pipettetype", type=int, choices=[1,8,96], default=8)
    parser.add_argument("--blowout", type=int, default=1)
    parser.add_argument("--blowoutnum",type=int,default=100)
    args = parser.parse_args()
    _config = TestConfig(simulate=args.simulate, pipette=args.pipette,blowout=args.blowout,blowoutnum=args.blowoutnum,pipettetype=args.pipettetype)
