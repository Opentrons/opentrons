...
def _create_attached_instruments_dict(
    pipette_left: Optional[str] = None, pipette_right: Optional[str] = None, gripper: Optional[str] = None
    ...
    fake_id_gripper = "GRPV1020221101A02" if gripper else None  # FIXME: EVT grippers all have same ID
    ...
    return {OT3Mount.LEFT: sim_pip_left, OT3Mount.RIGHT: sim_pip_right, OT3Mount.GRIPPER: sim_gripper}
...
async def build_async_ot3_hardware_api(
    ...
    if is_simulating:
        ...
        #                - 96-channel
        #                - modules
        sim_pips = _create_attached_instruments_dict(pipette_left, pipette_right, gripper)
