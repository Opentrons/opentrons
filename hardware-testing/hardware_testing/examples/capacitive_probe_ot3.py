...
ASSUMED_Z_LOCATION = types.Point(x=200, y=200, z=0)
ASSUMED_XY_LOCATION = types.Point(x=185, y=185, z=0)
...
async def _main(is_simulating: bool) -> None:
    ...
    # align the non-probing axes (in this case XY)
    # and safely position the probing axis (in this case Z)
    safe_above_z = ASSUMED_Z_LOCATION + types.Point(z=100)
    await helpers_ot3.move_to_arched_ot3(api, mount, safe_above_z)

    # probe to find the deck's Z location
