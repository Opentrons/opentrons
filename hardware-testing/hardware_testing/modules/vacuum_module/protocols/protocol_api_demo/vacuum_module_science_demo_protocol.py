"""Vacuum Module Science Demo Protocol."""
...
metadata = {
    "protocolName": "Vacuum Module Science Demo",
...
def run(ctx: ProtocolContext) -> None:
    ...
    for cycle in range(ctx.params.cycles):  # type: ignore[attr-defined]
        ...
        pip.dispense(500, white_filter_plate.wells()[0].top(-15))
        pip.return_tip()
        tiprack_1000.reset()
        ...
        pip.dispense(150, white_filter_plate.wells()[0].top(-15))
        pip.return_tip()
        tiprack_200.reset()
