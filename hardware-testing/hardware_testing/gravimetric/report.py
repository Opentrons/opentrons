        ...
        sections=[
            ...
            CSVSection(
                ...
                lines=[
                    ...
                    or trial < (config.NUM_BLANK_TRIALS * cavity_racks)
                ],
            ),
            CSVSection(
                title="ENCODER",
...
def store_trial(
    ...
    report(
        "TRIALS",
        f"trial-{trial + 1}-asp_evap-{vol_in_tag}-ul-channel_{channel + 1}",
        [asp_evap],
    )
    report(
        "TRIALS",
        f"trial-{trial + 1}-disp_evap-{vol_in_tag}-ul-channel_{channel + 1}",
        [disp_evap],
    )
