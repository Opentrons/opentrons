...
PRESSURE_ASPIRATE_DELTA_SPEC = {
    ...
    96: {
        200: {"delta": 4000.0, "margin": 0.99},  # absolute value  # percent of delta
        1000: {"delta": 4000.0, "margin": 0.99},  # absolute value  # percent of delta
    },
}
...
PRESSURE_ASPIRATED_P200 = PressureEventConfig(
    min=-8000.0,
    max=8000.0,
    stability_delay=DEFAULT_STABILIZE_SECONDS,
    stability_threshold=200.0,
...
PRESSURE_FIXTURE_EVENT_CONFIGS: Dict[PressureEvent, PressureEventConfig] = {
    ...
    PressureEvent.ASPIRATE_P200:PRESSURE_ASPIRATED_P200,
