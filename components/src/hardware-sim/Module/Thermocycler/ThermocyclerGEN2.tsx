...
function ClosedThermocyclerGEN2Layers(props: { ledLightColor: string }): JSX.Element {
  return (
    <g id="closed_thermocycler_gen2">
      <path style={{ fill: COLORS.white }} d="M145.2,232.7V186c0-4-2.7-7.2-6-7.2H32.5c-3.3,0-5.7,3.2-5.7,7.2v46.7H0.4V0.4h171.2v232.3H145.2z"></path>
      <path style={{ fill: "#E6E6E6" }} d="M139.1,178.8h-106c-3.3,0-6,2.7-6,6v47.9h118v-47.9C145.1,181.5,142.4,178.8,139.1,178.8z"> </path>
      <rect x="4.2" y="0.4" style={{ fill: "#E6E6E6" }} width="163.4" height="38.3"></rect>
      <path style={{ fill: COLORS.white }} d="M141,191.8H31.1c-1.1,0-2,0.9-2,2v49.2c0,1.1,0.9,2,2,2H141c1.1,0,2-0.9,2-2v-49.2 C143,192.7,142.1,191.8,141,191.8z"> </path>
      <rect x="32.7" y="195.4" style={{ fill: "#E6E6E6" }} width="106.8" height="49.5"></rect>
      <path style={{ fill: COLORS.white }} d="M130.8,18.5H41.2c-1.6,0-3,1.3-3,3l0,0c0,1.7,1.3,3,3,3h89.6c1.6,0,3-1.3,3-3l0,0 C133.8,19.9,132.5,18.5,130.8,18.5z"> </path>
      <path fill={props.ledLightColor} stroke={COLORS.black} strokeWidth={0.5} d="M130.8,18.3H41.2c-1.7,0-3.2,1.4-3.2,3.2c0,1.7,1.4,3.2,3.2,3.2h89.6c1.7,0,3.2-1.4,3.2-3.2 C133.9,19.8,132.5,18.3,130.8,18.3z"> </path>
      ...
      <ellipse style={{ fill: COLORS.white }} cx="150.6" cy="21.5" rx="5.8" ry="5.8"></ellipse>
      ...
      <ellipse style={{ fill: "#E6E6E6" }} cx="150.6" cy="21.5" rx="3.8" ry="3.8"></ellipse>
...
function OpenThermocyclerGEN2Layers(): JSX.Element {
  return (
    <g id="open_thermocycler_gen2">
      <g id="shading">
        <path style={{ fill: COLORS.white }} d="M51.7,247.3c0,2.4,0,9.8,0,11.1c0,1.4,0,2.8,1.1,3.9c1.2,1.2,2.6,1.2,4.1,1.2c1.6,0,58,0,59.1,0 c1.3,0,2.5-0.3,3.3-1.3c1.3-1.4,1-3.3,1-5c0-1.8,0-8.4,0-9.9"> </path>
        <rect x="55.6" y="246.9" style={{ fill: "#E6E6E6" }} width="60.7" height="12.7"></rect>
        <path style={{ fill: COLORS.white }} d="M171.6,38.7H0.4v206.3c0,1.1,0.9,2,2,2h167.3c1.1,0,2-0.9,2-2L171.6,38.7L171.6,38.7z"></path>
      ...
      <g id="base_grey">
        <rect x="4.4" y="39.1" style={{ fill: "#E6E6E6" }} width="163.4" height="203.4"></rect>
        <path style={{ fill: COLORS.white }} d="M19.3,70.9v-4.4c0-1.2,1-2.2,2.2-2.2h129c1.2,0,2.2,1,2.2,2.2v4.4h-5.9c-0.6,0-1,0.4-1,1v2.5 c0,0.6,0.4,1,1,1h5.9v65.3h-5.9c-0.6,0-1,0.4-1,1v2.5c0,0.6,0.4,1,1,1h5.9V156c0,1.2-1,2.2-2.2,2.2h-129l0,0 c-1.2,0-2.2-1-2.2-2.2v0v-10.8h5.9c0.6,0,1-0.4,1-1v-2.5c0-0.6-0.4-1-1-1h-5.9V75.4h5.9c0.6,0,1-0.4,1-1v-2.5c0-0.6-0.4-1-1-1 L19.3,70.9"> </path>
        <path style={{ fill: COLORS.white }} d="M143,203v-9.2c0-1.1-0.9-2-2-2H31.1c-1.1,0-2,0.9-2,2v9.2"></path>
        <polyline style={{ fill: "#E6E6E6" }} points="139.5,203.1 139.5,195.4 32.8,195.4 32.8,203.3 			"></polyline>
      </g>
      <g id="stroke">
