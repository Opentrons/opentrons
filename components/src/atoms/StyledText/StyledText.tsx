...
export const helixProductStyleMap = {
  ...
  headingMediumSemiBold: { className: 'heading_medium_semi_bold', as: 'h3' },
  headingSmallRegular: { className: 'heading_small_regular', as: 'h4' },
  headingSmallBold: { className: 'heading_small_bold', as: 'h4' },
  headingSmallSemiBold: { className: 'heading_small_semi_bold', as: 'h4' },
  bodyLargeSemiBold: { className: 'body_large_semi_bold', as: 'p' },
  bodyLargeRegular: { className: 'body_large_regular', as: 'p' },
  bodyDefaultSemiBold: { className: 'body_default_semi_bold', as: 'p' },
  bodyDefaultRegular: { className: 'body_default_regular', as: 'p' },
  bodyDefaultRegLink: { className: 'body_default_reg_link', as: 'p' },
  captionSemiBold: { className: 'caption_semi_bold', as: 'label' },
...
export const ODDStyleMap = {
  ...
  smallBodyTextSemiBold: {
    className: 'small_body_text_semi_bold',
    as: 'label',
  },
