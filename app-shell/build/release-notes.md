...
- Error recovery in the app or on the Flex touchscreen can't successfully resolve overpressure errors that occur during some pipetting actions, including pipetting relative to the liquid meniscus or during a dynamic aspirate or dispense. We recommend canceling the protocol when these errors occur.
