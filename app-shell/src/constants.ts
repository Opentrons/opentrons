import type {
  ...
  APP_RESTART_TYPE,
  CAMERA_STREAM_OPEN_TYPE,
  CHANGE_AUDIT_LOG_DIRECTORY_TYPE,
  ...
  DOWNLOAD_AUDIT_LOG_TYPE,
  DOWNLOAD_AUDIT_LOGS_TYPE,
...
export const CHANGE_AUDIT_LOG_DIRECTORY: CHANGE_AUDIT_LOG_DIRECTORY_TYPE =
  'audit:CHANGE_AUDIT_LOG_DIRECTORY'

export const DOWNLOAD_AUDIT_LOG: DOWNLOAD_AUDIT_LOG_TYPE =
  'audit:DOWNLOAD_AUDIT_LOG'

export const DOWNLOAD_AUDIT_LOGS: DOWNLOAD_AUDIT_LOGS_TYPE =
  'audit:DOWNLOAD_AUDIT_LOGS'
...
export const OT2_APP_OPEN: OT2_APP_OPEN_TYPE = 'shell:OT2_APP_OPEN'
