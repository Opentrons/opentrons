import type {
  ...
  SEND_LOG_TYPE,
  ADD_ANALYSIS_TYPE,
  ANALYZE_CREATE_PROTOCOL_ERROR_TYPE,
} from './types'
...
export const ADD_ANALYSIS: ADD_ANALYSIS_TYPE = 'protocolStorage:ADD_ANALYSIS'
export const ANALYZE_CREATE_PROTOCOL: ANALYZE_CREATE_PROTOCOL_TYPE =
  'protocolStorage:ANALYZE_CREATE_PROTOCOL'
export const ANALYZE_CREATE_PROTOCOL_ERROR: ANALYZE_CREATE_PROTOCOL_ERROR_TYPE =
