...
export type CHANGE_AUDIT_LOG_DIRECTORY_TYPE = 'audit:CHANGE_AUDIT_LOG_DIRECTORY'
...
export type CUSTOM_LABWARE_LIST_FAILURE_TYPE =
  'labware:CUSTOM_LABWARE_LIST_FAILURE'
export type CHANGE_CUSTOM_LABWARE_DIRECTORY_TYPE =
...
export type ADD_CUSTOM_LABWARE_FAILURE_TYPE =
  'labware:ADD_CUSTOM_LABWARE_FAILURE'
export type ADD_CUSTOM_LABWARE_FILE_FROM_CREATOR_TYPE =
  'labware:ADD_CUSTOM_LABWARE_FILE_BLOB'
export type CLEAR_ADD_CUSTOM_LABWARE_FAILURE_TYPE =
...
export type OPEN_CUSTOM_LABWARE_DIRECTORY_TYPE =
  'labware:OPEN_CUSTOM_LABWARE_DIRECTORY'
export type DELETE_CUSTOM_LABWARE_FILE_TYPE =
...
export type OPEN_PYTHON_DIRECTORY_TYPE =
  'protocol-analysis:OPEN_PYTHON_DIRECTORY'
export type CHANGE_PYTHON_PATH_OVERRIDE_TYPE =
...
export type UPDATE_PROTOCOL_LIST_FAILURE_TYPE =
...
export type NETWORK_INTERFACES_CHANGED_TYPE =
