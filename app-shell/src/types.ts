...
export type ADD_ANALYSIS_TYPE = 'protocolStorage:ADD_ANALYSIS'
...
export type ANALYZE_CREATE_PROTOCOL_TYPE = 'protocolStorage:ANALYZE_CREATE_PROTOCOL'
export type ANALYZE_CREATE_PROTOCOL_ERROR_TYPE = 'protocolStorage:ANALYZE_CREATE_PROTOCOL_ERROR'
