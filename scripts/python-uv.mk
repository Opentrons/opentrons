...
$(if $(findstring robot-stack,$(1)),$(git_describe_base)=v*,$(if $(findstring ot3,$(1)),git describe --dirty --tags --long --match=internal@??.??.??*,$(error "Unknown project $(1) (valid: ot3, robot-stack)")))
endef
