...
type LegacyActionTypeValue =
  | 'robot:SET_DECK_POPULATED'
  | 'robot:MOVE_TO_FRONT'
  | 'robot:MOVE_TO_FRONT_RESPONSE'
  | 'robot:PROBE_TIP'
  | 'robot:PROBE_TIP_RESPONSE'
  | 'robot:RETURN_TIP'
  | 'robot:RETURN_TIP_RESPONSE'
  | 'robot:CONFIRM_LABWARE'
  | 'robot:RUN'
  | 'robot:RUN_RESPONSE'
  | 'robot:PAUSE'
  | 'robot:PAUSE_RESPONSE'
  | 'robot:RESUME'
  | 'robot:RESUME_RESPONSE'
  | 'robot:CANCEL'
  | 'robot:CANCEL_RESPONSE'
  | 'robot:TICK_RUN_TIME'
// TODO(mc, 2018-01-23): refactor to use type above
//   DO NOT ADD NEW ACTIONS HERE
export const actionTypes: Record<string, LegacyActionTypeValue> = {
  // calibration
