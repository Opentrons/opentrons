...
export const OT2_MANIFEST_URL =
  'https://opentrons-buildroot-ci.s3.us-east-2.amazonaws.com/releases.json' as const
export const OT3_MANIFEST_URL =
  'https://ot3-development.builds.opentrons.com/ot3-oe/releases.json' as const
