...
export const PROFILE_ROBOT_NAME = 'Robot Name'
export const PROFILE_ROBOT_API_VERSION = 'Robot API Version'
export const PROFILE_ROBOT_SMOOTHIE_VERSION = 'Robot Smoothie Version'
