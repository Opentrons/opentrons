...
export const ANALYTICS_PROTOCOL_RUN_AGAIN = 'runAgain'
export const ANALYTICS_PROTOCOL_RUN_FINISH = 'runFinish'
export const ANALYTICS_PROTOCOL_RUN_PAUSE = 'runPause'
export const ANALYTICS_PROTOCOL_RUN_START = 'runStart'
export const ANALYTICS_PROTOCOL_RUN_RESUME = 'runResume'
export const ANALYTICS_PROTOCOL_RUN_CANCEL = 'runCancel'
...
export const ANALYTICS_TOUCHSCREEN_APP_ERROR = 'touchScreenAppUnexpectedError'
