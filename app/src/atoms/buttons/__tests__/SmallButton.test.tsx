...
describe('SmallButton', () => {
  ...
  it('renders the primary button and it works as expected', () => {
    ...
    expect(getByRole('button')).toHaveStyle(`border-radius: ${BORDERS.borderRadiusSize4}`)
  })
  ...
  it('renders the rounded button category', () => {
    ...
    const { getByRole } = render(props)
    expect(getByRole('button')).toHaveStyle(`border-radius: ${BORDERS.borderRadiusSize5}`)
  })
