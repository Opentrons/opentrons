  ...
  it('renders the InlineNotification', () => {
    ...
    expect(vi.mocked(InlineNotification)).toHaveBeenCalledWith(
      expect.objectContaining({
        type: 'alert',
        heading:
          'Overpressure is usually caused by a tip contacting labware, a clog, or moving viscous liquid too quickly. If the issue persistsn, cancel the run and make the necessary changes to the protocol.',
      }),
      {}
    )
  })
