...
export const STEP_ORDER: StepOrder = {
  ...
  [REPLACE_LABWARE_IN_HOOPER_AND_RETRY.ROUTE]: [
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.EMPTY_STACKER,
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.PREPARE_TRACK_FOR_HOMING,
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.CONFIRM_LABWARE_IN_LATCH,
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.RELEASE_FROM_LATCH,
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.REENGAGE_LATCH,
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.CONFIRM_RETRY,
    REPLACE_LABWARE_IN_HOOPER_AND_RETRY.STEPS.RETRY,
  ],
