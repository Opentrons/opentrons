...
export const ERROR_KINDS = {
  ...
  STACKER_STALLED: 'STACKER_STALLED',
...
export const STEP_ORDER: StepOrder = {
  ...
  [HOPPER_MANUAL_LOAD_AND_RETRY.ROUTE]: [
    HOPPER_MANUAL_LOAD_AND_RETRY.STEPS.CONFIRM_RETRY,
    HOPPER_MANUAL_LOAD_AND_RETRY.STEPS.RETRY,
  ],
  [HOPPER_MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.ROUTE]: [
    HOPPER_MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.HOPPER_MANUAL_REPLACE,
    HOPPER_MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.CONFIRM_RETRY,
    HOPPER_MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.SKIP,
  ],
  [REPLACE_LABWARE_IN_HOPPER_AND_RETRY.ROUTE]: [
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.EMPTY_STACKER,
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.PREPARE_TRACK_FOR_HOMING,
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.CONFIRM_LABWARE_IN_LATCH,
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.RELEASE_FROM_LATCH,
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.REENGAGE_LATCH,
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.CONFIRM_RETRY,
    REPLACE_LABWARE_IN_HOPPER_AND_RETRY.STEPS.RETRY,
  ],
  [MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.ROUTE]: [
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.EMPTY_STACKER,
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.PREPARE_TRACK_FOR_HOMING,
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.CONFIRM_LABWARE_IN_LATCH,
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.RELEASE_FROM_LATCH,
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.REENGAGE_LATCH,
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.CONFIRM_RETRY,
    MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.SKIP,
  ],
...
export const RECOVERY_MAP_METADATA: RecoveryRouteStepMetadata = {
  ...
  [HOPPER_MANUAL_LOAD_AND_RETRY.ROUTE]: {
    ...
    [HOPPER_MANUAL_LOAD_AND_RETRY.STEPS.RETRY]: { allowDoorOpen: false },
  },
  [HOPPER_MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.ROUTE]: {
    [HOPPER_MANUAL_LOAD_ON_SHUTTLE_AND_SKIP.STEPS.HOPPER_MANUAL_REPLACE]: {
      allowDoorOpen: false,
