...
import { RUN_STATUS_FAILED, type CommandData, type HostConfig } from '@opentrons/api-client'
...
export const PipetteWizardFlows = (
  ...
  } else if (errorMessage != null && isExiting || maintenanceRunData?.data.status === RUN_STATUS_FAILED) {
