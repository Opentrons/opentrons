export const SECTIONS = {
  ...
  DETACH_MOUNTING_PLATE: 'DETACH_MOUNTING_PLATE',
  REATTACH_CARRIAGE: 'REATTACH_CARRIAGE',
  ATTACH_MOUNTING_PLATE: 'ATTACH_MOUNTING_PLATE',
  UNSCREW_CARRIAGE: 'UNSCREW_CARRIAGE',
} as const
