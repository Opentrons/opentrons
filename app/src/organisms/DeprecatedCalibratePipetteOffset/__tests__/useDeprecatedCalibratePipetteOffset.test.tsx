...
import { useDeprecatedCalibratePipetteOffset } from '../useDeprecatedCalibratePipetteOffset'
import { INTENT_TIP_LENGTH_OUTSIDE_PROTOCOL } from '../../DeprecatedCalibrationPanels'
import { pipetteOffsetCalibrationStarted } from '../../../redux/analytics'

import type { Invoker } from '../useDeprecatedCalibratePipetteOffset'
...
describe('useDeprecatedCalibratePipetteOffset hook', () => {
  ...
  const TestUseCalibratePipetteOffset = (): JSX.Element => {
    const [
      _startCalibration,
      _CalWizardComponent,
    ] = useDeprecatedCalibratePipetteOffset(
      robotName,
      {
        mount: mountString,
