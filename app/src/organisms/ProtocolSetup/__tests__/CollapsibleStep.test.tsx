...
describe('CollapsibleStep', () => {
  let render: (props?: Partial<React.ComponentProps<typeof CollapsibleStep>>) => ReturnType<typeof renderWithProviders>
  ...
  beforeEach(() => {
    ...
    render = ({
      ...
      return renderWithProviders(
        <CollapsibleStep {...{expanded, title, description, label, toggleExpanded, children}} />,
        { i18nInstance: i18n }
      )
    }
  })
