...
describe('DeckCalibrationModal', () => {
  ...
  it('should render the correct body', () => {
    ...
    expect(getByRole('heading', { name: 'Tip Length Calibration' })).toBeTruthy()
    getByText(
    ...
    expect(getByRole('heading', { name: 'Pipette Offset Calibration' })).toBeTruthy()
    getByText(
    ...
    getByText(
        'Redo Pipette Offset calibration after:'
      )
  })
