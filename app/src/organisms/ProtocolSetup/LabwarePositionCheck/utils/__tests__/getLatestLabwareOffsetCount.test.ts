...
describe('getLatestLabwareOffsetCount', () => {
  ...
  it('should return 1 when there is two offset records with the same labware and slot', () => {
    const labwareOffsets: LabwareOffset[] = [
      {
        definitionUri: 'some_definitionUri',
        location: { slotName: '1' },
  ...
  it('should return 1 when there is two offset records with the same labware and module id', () => {
    const labwareOffsets: LabwareOffset[] = [
      {
        definitionUri: 'some_definitionUri',
