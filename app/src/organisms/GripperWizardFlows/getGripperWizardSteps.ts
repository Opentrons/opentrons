import { GRIPPER_FLOW_TYPES, SECTIONS, MOVE_PIN_TO_FRONT_JAW, REMOVE_PIN_FROM_REAR_JAW, MOVE_PIN_FROM_FRONT_JAW_TO_REAR_JAW, SUCCESSFULLY_ATTACHED, SUCCESSFULLY_ATTACHED_AND_CALIBRATED, SUCCESSFULLY_DETACHED, SUCCESSFULLY_CALIBRATED } from './constants'
  ...
  switch (flowType) {
    case GRIPPER_FLOW_TYPES.RECALIBRATE: {
      return [
        ...
        { section: SECTIONS.SUCCESS, successfulAction: SUCCESSFULLY_CALIBRATED},
      ]
    }
    case GRIPPER_FLOW_TYPES.ATTACH: {
      return [
        ...
        { section: SECTIONS.MOVE_PIN, movement: MOVE_PIN_TO_FRONT_JAW},
        { section: SECTIONS.MOVE_PIN, movement: MOVE_PIN_FROM_FRONT_JAW_TO_REAR_JAW},
        { section: SECTIONS.MOVE_PIN, movement: REMOVE_PIN_FROM_REAR_JAW},
        { section: SECTIONS.SUCCESS, successfulAction: SUCCESSFULLY_ATTACHED_AND_CALIBRATED},
      ]
    }
