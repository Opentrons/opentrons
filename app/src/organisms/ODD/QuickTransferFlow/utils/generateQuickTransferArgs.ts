...
export function generateQuickTransferArgs(
  ...
  const commonFields = {
    ...
    aspirateSubmergeSpeed: quickTransferState.submergeAspirate?.speed,
    aspirateSubmergeXOffset: 0,
    aspirateSubmergeYOffset: 0,
    aspirateSubmergeZOffset: quickTransferState.submergeAspirate?.position,
    aspirateSubmergePositionReference:
      quickTransferState.submergeAspirate?.positionReference,
    aspirateSubmergeDelay: quickTransferState.submergeAspirate?.delayDuration,
    aspirateRetractSpeed: quickTransferState.retractAspirate?.speed,
    aspirateRetractXOffset: 0,
    aspirateRetractYOffset: 0,
    aspirateRetractZOffset: quickTransferState.retractAspirate?.position,
    aspirateRetractPositionReference:
      quickTransferState.retractAspirate?.positionReference,
    aspirateRetractDelay: quickTransferState.retractAspirate?.delayDuration,
    dispensePositionReference: POSITION_REFERENCE_BOTTOM,
    dispenseZOffset: quickTransferState.tipPositionDispense,
    dispenseSubmergeSpeed: quickTransferState.submergeDispense?.speed,
    dispenseSubmergeXOffset: 0,
    dispenseSubmergeYOffset: 0,
    dispenseSubmergeZOffset: quickTransferState.submergeDispense?.position,
    dispenseSubmergePositionReference:
      quickTransferState.submergeDispense?.positionReference,
    dispenseSubmergeDelay: quickTransferState.submergeDispense?.delayDuration,
    dispenseRetractSpeed: quickTransferState.retractDispense?.speed,
    dispenseRetractXOffset: 0,
    dispenseRetractYOffset: 0,
    dispenseRetractZOffset: quickTransferState.retractDispense?.position,
    dispenseRetractPositionReference:
      quickTransferState.retractDispense?.positionReference,
    dispenseRetractDelay: quickTransferState.retractDispense?.delayDuration,
