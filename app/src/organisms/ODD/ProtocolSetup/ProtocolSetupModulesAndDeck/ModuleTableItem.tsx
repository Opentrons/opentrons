...
export function ModuleTableItem({
    ...
    const [showHomeStackerWarning, setShowHomeStackerWarning] = useState<boolean>(false)
    const [
        ...
        return (
            <OddModal header={{ title: t('home_stacker') }}>
                <Flex
                    ...
                    width="100%"
                >
                    <InfoScreen content={t('home_stacker_warning_title')} subContent={t('home_stacker_warning_description')} backgroundColor={COLORS.yellow35} />
                    <Flex gridGap={SPACING.spacing8} width="100%">
                        <SmallButton width="100%" textTransform={TYPOGRAPHY.textTransformCapitalize} buttonType='secondary' buttonText={t('shared:cancel')} onClick={() => { setShowHomeStackerWarning(false) }} />
                        <SmallButton width="100%" buttonType='primary' buttonText={t('home_stacker')} onClick={homeStacker} />
                    </Flex>
                </Flex>
            </OddModal>
        )
                ...
                return (
                    <>
                        ...
                        <SmallButton
                            ...
                            onClick={() => { isDoorOpen ? setShowHomeStackerWarning(true) : homeStacker() }}
                        />
                    </>
                )
            case 'disconnected':
