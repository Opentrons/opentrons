...
describe('ShowLabwareOffsetSnippets', () => {
  ...
  it('renders the display show link to get labware offset data section', () => {
    ...
    screen.getByText(
      'Only for users who need to apply labware offset data outside of the Opentrons OT-2 App. When enabled, code snippets for Jupyter Notebook and SSH are available during protocol setup after configuring all required offsets.'
    )
