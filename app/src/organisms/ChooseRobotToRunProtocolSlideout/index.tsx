 ...
 * `ChooseRobotToRunProtocolSlideout` when the ff is removed
 */
export function DeprecatedChooseRobotToRunProtocolSlideout(
  props: ChooseRobotToRunProtocolSlideoutProps
): JSX.Element | null {
  const { t } = useTranslation(['protocol_details', 'shared', 'app_settings'])
  const { storedProtocolData, showSlideout, onCloseClick } = props
...
export function ChooseRobotToRunProtocolSlideout(
  ...
  return enableManualDeckStateMod ? (
    <ChooseRobotToRunProtocolSlideoutComponent {...props} />
  ) : (
    <DeprecatedChooseRobotToRunProtocolSlideout {...props} />
  )
}
