...
import vacuumModuleMilliporeManualQRCode from '/app/assets/images/vacuum_setup_instructions_qr.png'
...
// TODO: add vacuum module millipore manual url
const VACUUM_MODULE_MILLIPORE_MANUAL_URL = 'https://docs.opentrons.com/modules/'
...
export const ModuleSetupModal = (props: ModuleSetupModalProps): JSX.Element => {
  ...
  const instructionURL = (): string => {
    ...
    switch (moduleType) {
      ...
      case VACUUM_MODULE_TYPE:
        return VACUUM_MODULE_MILLIPORE_MANUAL_URL
      default:
  ...
  const instructionQRCode = (): string => {
    ...
    switch (moduleType) {
      ...
      case VACUUM_MODULE_TYPE:
        return vacuumModuleMilliporeManualQRCode
      default:
