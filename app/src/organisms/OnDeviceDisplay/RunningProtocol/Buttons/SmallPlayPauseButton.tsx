...
interface SmallPlayPauseButtonProps {
  onTogglePlayPause?: () => void
  runStatus?: RunStatus | null
}

export function SmallPlayPauseButton({
  onTogglePlayPause,
  runStatus,
}: SmallPlayPauseButtonProps): JSX.Element {
  ...
  return (
    ...
    >
      <Icon name={iconName} color={COLORS.white} size="2.5rem" />
    </Btn>
  )
}
