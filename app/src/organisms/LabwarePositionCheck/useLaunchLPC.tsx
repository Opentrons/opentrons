...
export function useLaunchLPC(runId: string): { launchLPC: () => void, LPCWizard: JSX.Element | null} {
  ...
  return {
    launchLPC: () => createMaintenanceRun({}, { onSuccess: (maintenanceRun) => setMaintenanceRunId(maintenanceRun.data.id) }),
    LPCWizard: maintenanceRunId != null ? (
