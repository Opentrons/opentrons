...
const render = (
  props: React.ComponentProps<typeof DeprecatedLabwareOffsetsSummary>
) => {
  return renderWithProviders(<DeprecatedLabwareOffsetsSummary {...props} />, {
    i18nInstance: i18n,
  })[0]
}

describe('DeprecatedLabwareOffsetsSummary', () => {
  let props: React.ComponentProps<typeof DeprecatedLabwareOffsetsSummary>
  beforeEach(() => {
    props = { offsetData: [] }
  })
