...
export const TouchControlButton = styled.button<{ selected: boolean }>`
    background-color: ${({ selected }) => selected ? COLORS.blueEnabled : COLORS.mediumBlueEnabled};
    cursor: default;
    ...
    &:focus {
      background-color: ${({ selected }) => selected ? COLORS.bluePressed : COLORS.mediumBluePressed};
      box-shadow: none;
    }
    &:hover {
      border: none;
