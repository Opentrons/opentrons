...
/**
 * @deprecated use `StepSizeControl` instead
 */

export function DeprecatedStepSizeControl(
  props: StepSizeControlProps
): JSX.Element {
  ...
  return (
    <DeprecatedControlContainer
      title={STEP_SIZE_TITLE}
      subtitle={STEP_SIZE_SUBTITLE}
    >
      <HandleKeypress
        preventDefault
        handlers={[
