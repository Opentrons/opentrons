...
import { COLOR_SUCCESS, Box, Flex, Icon, Text, SIZE_1, JUSTIFY_FLEX_START, ALIGN_FLEX_START, TEXT_TRANSFORM_CAPITALIZE, SPACING_3, SPACING_2, ALIGN_CENTER, JUSTIFY_END, JUSTIFY_FLEX_END, JUSTIFY_SPACE_BETWEEN, COLOR_WARNING_LIGHT, FONT_SIZE_BODY_1 } from '@opentrons/components'
      ...
      {mod.type === MAGNETIC_MODULE_TYPE ? (
        <>
          <Flex fontSize={FONT_SIZE_BODY_1} alignItems={ALIGN_CENTER}>
            <Icon name="circle" width="10px" color={mod.status === 'engaged' ? COLOR_SUCCESS : COLOR_WARNING_LIGHT} marginRight="0.375rem" />
