  ...
  describe('reducer', () => {
    const SPECS = [
      ...
      },
      {
        ...
        expected: {checking: false, available: true, info: {version: '1.0.0'}},
      },
      {
      ...
      },
      {
        ...
        initialState: {downloading: false, seen: false, error: {message: 'AH'}},
    ...
    const SPECS = [
      {
        ...
        state: {shell: {update: {available: false, info: {version: '1.0.0'}}}},
        expected: null,
      },
      {
        name: 'getAvailableShellUpdate with update available',
        selector: update.getAvailableShellUpdate,
        state: {shell: {update: {available: true, info: {version: '1.0.0'}}}},
        expected: '1.0.0',
      },
    ]
