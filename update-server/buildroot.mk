...
PYTHON_OPENTRONS_UPDATE_SERVER_SETUP_TYPE = hatch
...
PYTHON_OPENTRONS_UPDATE_SERVER_ENV = HATCH_VCS_TUNABLE_RAW_OPTIONS="root=$(shell realpath --relative-to=$(PYTHON_OPENTRONS_UPDATE_SERVER_BUILDDIR) $(BR2_EXTERNAL_OPENTRONS_MONOREPO_PATH))"
