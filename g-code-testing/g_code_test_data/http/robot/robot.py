...
ROBOT_HOME_ROBOT = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_home_robot.txt",
    executable=partial(
        post_home_robot,
...
ROBOT_HOME_LEFT_PIPETTE = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_home_left_pipette.txt",
    executable=partial(
        post_home_robot,
...
ROBOT_HOME_RIGHT_PIPETTE = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_home_right_pipette.txt",
    executable=partial(
        post_home_robot,
...
ROBOT_MOVE_LEFT_MOUNT = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_move_left_mount.txt",
    executable=partial(
        post_move_robot,
...
ROBOT_MOVE_LEFT_PIPETTE = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_move_left_pipette.txt",
    executable=partial(
        post_move_robot,
...
ROBOT_MOVE_RIGHT_MOUNT = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_move_right_mount.txt",
    executable=partial(
        post_move_robot,
        robot_move_target=RobotMoveTarget(
...
ROBOT_MOVE_RIGHT_PIPETTE = HTTPGCodeConfirmConfig(
    ...
    s3_path=f"{S3_BASE}/robot_move_right_pipette.txt",
    executable=partial(
        post_move_robot,
        robot_move_target=RobotMoveTarget(
