...
def run(protocol):
    ...
    pipette.transfer(volume, source_labware_C1["A6"], destination_labware_C2["A6"])
    ...
    pipette.transfer(volume, source_labware_B2["A6"], destination_labware_C3["A6"])
