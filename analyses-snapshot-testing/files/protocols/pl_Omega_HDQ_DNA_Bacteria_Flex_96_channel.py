def get_values(*names):
    ...
    _all_values = json.loads(
        """{"trash_chute":false,"USE_GRIPPER":true,"dry_run":false,"temp_mod":true,"heater_shaker":true,"tip_mixing":false,"wash_vol":600,"TL_vol":250,"AL_vol":230,"sample_vol":200,"bind_vol":320,"elution_vol":100,"protocol_filename":"Omega_HDQ_DNA_Bacteria-Flex_96_channel"}"""
    )
