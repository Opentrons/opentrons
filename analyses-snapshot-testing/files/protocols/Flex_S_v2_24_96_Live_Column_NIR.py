...
metadata = {"protocolName": "96 Channel column"}
...
def run(ctx):
    ...
    tip_config = find_partial_tip_config("ninety_six_column_left")
    ...
    water_source_columns = [source_A2.columns()[col] for col in WATER_SOURCE_COLUMNS]
    ethanol_source_columns = [source_A2.columns()[col] for col in ETHANOL_SOURCE_COLUMNS]
    glycerol_source_columns = [source_A2.columns()[col] for col in GLYCEROL_SOURCE_COLUMNS]
