...
metadata = {"protocolName": "P1000 8ch volume exceeds 1000ul tip volume - transfer, distribute, consolidate, _liquid"}
...
def run(ctx):
    ...
    tiprack_1 = ctx.load_labware("opentrons_flex_96_tiprack_1000ul", "B2")
    tiprack_3 = ctx.load_labware("opentrons_flex_96_tiprack_1000ul", "D3")
    tiprack_2 = ctx.load_labware("opentrons_flex_96_tiprack_1000ul", "B3")
    filter_tiprack_1 = ctx.load_labware("opentrons_flex_96_filtertiprack_1000ul", "C1")
    filter_tiprack_2 = ctx.load_labware("opentrons_flex_96_filtertiprack_1000ul", "C2")
    filter_tiprack_3 = ctx.load_labware("opentrons_flex_96_filtertiprack_1000ul", "C3")
