...
def run(ctx: protocol_api.ProtocolContext) -> None:
    ...
    STACKER_PARAMS = test.number_of_stackers  
    ...
    if STACKER_PARAMS == "1":
        ...
        stacker_A4.set_stored_labware(test.well_plate_name, count=2)
    ...
    if STACKER_PARAMS == "3":
        ...
        stacker_A4.set_stored_labware(test.reservoir_name, count=0)
        ...
        dest_pcr_plate = ctx.load_labware(test.well_plate_name, WELL_PLATE_STARTING_POSITION)
        source_reservoir = ctx.load_labware(test.reservoir_name, RESERVOIR_STARTING_POSITION)
