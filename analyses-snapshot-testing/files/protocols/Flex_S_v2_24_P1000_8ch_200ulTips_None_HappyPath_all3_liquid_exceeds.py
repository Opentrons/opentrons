...
metadata = {"protocolName": "P1000 8ch volume exceeds 200ul tip volume - transfer, distribute, consolidate, _liquid"}
...
def run(ctx):
    ...
    tiprack_1 = ctx.load_labware("opentrons_flex_96_tiprack_200ul", "B2")
    tiprack_3 = ctx.load_labware("opentrons_flex_96_tiprack_200ul", "D3")
    tiprack_2 = ctx.load_labware("opentrons_flex_96_tiprack_200ul", "B3")
    filter_tiprack_1 = ctx.load_labware("opentrons_flex_96_filtertiprack_200ul", "C1")
    filter_tiprack_2 = ctx.load_labware("opentrons_flex_96_filtertiprack_200ul", "C2")
    filter_tiprack_3 = ctx.load_labware("opentrons_flex_96_filtertiprack_200ul", "C3")
    ...
    pipette_8ch_1000.tip_racks = filter_tipracks
    new_tip = "once"
    # new_tip = "always"
