def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "trash_chute", "type": "dropDown", "label": "Trash Chute Present?", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "USE_GRIPPER", "type": "dropDown", "label": "Use Gripper", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "dry_run", "type": "dropDown", "label": "Dry Run", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "temp_mod", "type": "dropDown", "label": "Temperature Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "heater_shaker", "type": "dropDown", "label": "Heater-Shaker Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "tip_mixing", "type": "dropDown", "label": "Tip Mixing? (will heater-shaker be replaced with tip mixing-if h-s is present, this will be false)", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "wash1_vol", "type": "int", "label": "Wash 1 Volume", "default": 500}, {"name": "wash2_vol", "type": "int", "label": "Wash 2 Volume", "default": 900}, {"name": "wash3_vol", "type": "int", "label": "Wash 3 Volume", "default": 900}, {"name": "wash4_vol", "type": "int", "label": "Wash 4 Volume", "default": 900}, {"name": "lysis_vol", "type": "int", "label": "Lysis Volume", "default": 200}, {"name": "bind_vol", "type": "int", "label": "Binding Buffer Volume", "default": 600}, {"name": "bind2_vol", "type": "int", "label": "Second Binding Buffer Volume", "default": 500}, {"name": "elution_vol", "type": "int", "label": "Elution Volume", "default": 75}]""")
...
def run(ctx):
    ...
    try:
        [trash_chute,USE_GRIPPER,dry_run,temp_mod,heater_shaker,tip_mixing,wash1_vol,wash2_vol,wash3_vol,bind_vol,lysis_vol,elution_vol] = get_values(  # noqa: F821
        'trash_chute','USE_GRIPPER','dry_run','temp_mod','heater_shaker','tip_mixing','wash1_vol','wash2_vol','wash3_vol','bind_vol','lysis_vol','elution_vol')
