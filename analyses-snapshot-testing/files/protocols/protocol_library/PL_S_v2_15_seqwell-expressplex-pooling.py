def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "DryRun", "type": "dropDown", "label": "Is this a test run?", "options": [{"label": "No", "value": false}, {"label": "Yes", "value": true}]}, {"name": "Plates", "type": "dropDown", "label": "How many plates are being processed?", "options": [{"label": "4", "value": "4"}, {"label": "3", "value": "3"}, {"label": "2", "value": "2"}, {"label": "1", "value": "1"}]}, {"name": "columns", "type": "int", "label": "If pooling only 1 plate, how many columns on the plate will be pooled?", "default": 12}]""")
...
def run(ctx):
    ...
    try:
        [DryRun,Plates,columns] = get_values(  # noqa: F821
        "DryRun","Plates","columns")
    except (NameError):
        pass
    ...
    def Strip_tube_pooling(start,end):
        for x in range(columns):
            ...
            p20_multi.aspirate(12,start[x].bottom(z=.5), rate=.5)
