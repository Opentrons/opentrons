def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "num_samp", "type": "int", "label": "Number of Samples (1-96)", "default": 96}, {"name": "m300_mount", "type": "dropDown", "label": "P300 Multi-Channel Mount", "options": [{"label": "Left", "value": "left"}, {"label": "Right", "value": "right"}]}]""")
