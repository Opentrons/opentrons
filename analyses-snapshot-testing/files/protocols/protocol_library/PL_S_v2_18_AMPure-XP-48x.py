...
metadata = {'protocolName': 'AMPure XP 48x v8','author': 'Opentrons <protocols@opentrons.com>','source': 'Protocol Library',}
...
def add_parameters(parameters):
    ...
    #     display_name="Reservoir type slot C2",
    #     description="Res or deepwell",
    #     default="96",
    #     choices=[
    #         {"display_name":"Reservoir", "value": "res"},
    #         {"display_name":"96 Deepwell", "value": "96"}
    #     ]
    # )
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # RES_TYPE           = protocol.params.RES_TYPE
    ...
    TRASH_POSITION      = 'BIN'     # Default 'BIN' | 'BIN' or 'CHUTE'
    ...
    reservoir = protocol.load_labware('nest_12_reservoir_15ml','C2')  if RES_TYPE_96x == False else protocol.load_labware('nest_96_wellplate_2ml_deep','C2')
    # print(reservoir, RES_TYPE_96x, RES_TYPE)
    ...
    if NOLABEL == False:
        ...
        # ======== DEFINING LIQUIDS =======
        AMPure = protocol.define_liquid(name="Beads", description="AMPure Beads", display_color="#704848")                                       #704848 = 'AMPure Brown'
