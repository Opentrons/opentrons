def get_values(*names):
    import json
    _all_values = json.loads("""{"pipette_type": "p1000_single_gen2", "pipette_mount": "left", "sample_number": 24, "PCR_volume": 20, "bead_ratio": 1.8, "elution_buffer_volume": 20, "incubation_time": 1, "settling_time": 1, "drying_time": 5}""")
