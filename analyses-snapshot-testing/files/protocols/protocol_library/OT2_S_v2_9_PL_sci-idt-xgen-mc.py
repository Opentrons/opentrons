def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "SAMPLES", "type": "dropDown", "label": "Number of Samples", "options": [{"label": "8", "value": "8x"}, {"label": "16", "value": "16x"}, {"label": "24", "value": "24x"}]}, {"name": "PCRCYCLES", "type": "int", "label": "PCR Cycles", "default": 4}, {"name": "DRYRUN", "type": "dropDown", "label": "Dry Run", "options": [{"label": "Yes", "value": "YES"}, {"label": "No", "value": "NO"}]}, {"name": "NOMODULES", "type": "dropDown", "label": "Use Modules?", "options": [{"label": "Yes", "value": "NO"}, {"label": "NO", "value": "YES"}]}, {"name": "TIPREUSE", "type": "dropDown", "label": "Reuse Tips?", "options": [{"label": "Yes", "value": "YES"}, {"label": "No", "value": "NO"}]}, {"name": "OFFSET", "type": "dropDown", "label": "Use protocol specific z-offsets?", "options": [{"label": "Yes", "value": "YES"}, {"label": "No", "value": "NO"}]}, {"name": "STEP_ERAT", "type": "dropDown", "label": "Include End-Repair / A-Tailing Step?", "options": [{"label": "Yes", "value": "1"}, {"label": "No", "value": "0"}]}, {"name": "STEP_ERATDECK", "type": "dropDown", "label": "If yes, End-Repair / A-Tailing on deck or off deck?", "options": [{"label": "On Deck", "value": "1"}, {"label": "Off Deck", "value": "0"}]}, {"name": "STEP_LIG", "type": "dropDown", "label": "Include Ligation Step?", "options": [{"label": "Yes", "value": "1"}, {"label": "No", "value": "0"}]}, {"name": "STEP_LIGDECK", "type": "dropDown", "label": "If yes, ligation Step on or off deck?", "options": [{"label": "On deck", "value": "1"}, {"label": "Off deck", "value": "0"}]}, {"name": "STEP_POSTLIG", "type": "dropDown", "label": "Include Post Ligation Step?", "options": [{"label": "Yes", "value": "1"}, {"label": "No", "value": "0"}]}, {"name": "STEP_PCR", "type": "dropDown", "label": "Include PCR Step?", "options": [{"label": "Yes", "value": "1"}, {"label": "No", "value": "0"}]}, {"name": "STEP_PCRDECK", "type": "dropDown", "label": "If yes, PCR step on or off deck?", "options": [{"label": "On Deck", "value": "1"}, {"label": "Off Deck", "value": "0"}]}, {"name": "STEP_POSTPCR1", "type": "dropDown", "label": "Include First Post PCR Step?", "options": [{"label": "Yes", "value": "1"}, {"label": "No", "value": "0"}]}, {"name": "STEP_POSTPCR2", "type": "dropDown", "label": "Include Second Post PCR Step?", "options": [{"label": "Yes", "value": "1"}, {"label": "No", "value": "0"}]}, {"name": "m20_mount", "type": "dropDown", "label": "P20 Multi-Channel Mount", "options": [{"label": "Right", "value": "right"}, {"label": "Left", "value": "left"}]}, {"name": "m300_mount", "type": "dropDown", "label": "P300 Multi-Channel Mount", "options": [{"label": "Left", "value": "left"}, {"label": "Right", "value": "right"}]}]""")
...
import inspect
metadata = {'protocolName': 'IDT xGEN MC', 'author':
...
def run(protocol: protocol_api.ProtocolContext):
    [SAMPLES, PCRCYCLES, DRYRUN, NOMODULES, TIPREUSE, OFFSET, STEP_ERAT,
        STEP_ERATDECK, STEP_LIG, STEP_LIGDECK, STEP_POSTLIG, STEP_PCR,
        STEP_PCRDECK, STEP_POSTPCR1, STEP_POSTPCR2, m20_mount, m300_mount
        ] = get_values('SAMPLES', 'PCRCYCLES', 'DRYRUN', 'NOMODULES',
        'TIPREUSE', 'OFFSET', 'STEP_ERAT', 'STEP_ERATDECK', 'STEP_LIG',
        'STEP_LIGDECK', 'STEP_POSTLIG', 'STEP_PCR', 'STEP_PCRDECK',
        'STEP_POSTPCR1', 'STEP_POSTPCR2', 'm20_mount', 'm300_mount')
    STEPS = {STEP_ERAT, STEP_LIG, STEP_POSTLIG, STEP_PCR, STEP_POSTPCR1,
        STEP_POSTPCR2}
    ...
    if TIPREUSE == 'NO':
        ...
        Liquid_trash = reservoir['A12']
    if NOMODULES == 'NO':
        p300 = protocol.load_instrument('p300_multi_gen2', m300_mount,
            tip_racks=[tiprack_200_1, tiprack_200_2, tiprack_200_3])
        p20 = protocol.load_instrument('p20_multi_gen2', m20_mount,
            tip_racks=[tiprack_20])
    else:
        p300 = protocol.load_instrument('p300_multi', m300_mount, tip_racks
            =[tiprack_200_1, tiprack_200_2, tiprack_200_3])
        p20 = protocol.load_instrument('p10_multi', m20_mount, tip_racks=[
            tiprack_20])
    ...
    if STEP_ERAT == 1:
        ...
        if samplecolumns >= 1:
            ...
            p20.dispense(ERATVol, sample_plate_thermo.wells_by_name()[X].
    ...
    if STEP_ERATDECK == 1:
        if DRYRUN == 'NO':
            ...
            profile_ERAT = [{'temperature': 20, 'hold_time_minutes': 30}, {
                'temperature': 65, 'hold_time_minutes': 30}]
            thermocycler.execute_profile(steps=profile_ERAT, repetitions=1,
                block_max_volume=50)
    ...
    if STEP_PCRDECK == 1:
        if DRYRUN == 'NO':
            ...
            thermocycler.execute_profile(steps=profile_PCR_2, repetitions=5,
                block_max_volume=50)
