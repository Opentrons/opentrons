def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "num_samples", "type": "int", "label": "Number of Input Samples (up to 96)", "default": 96}, {"name": "deepwell_type", "type": "dropDown", "label": "Labware for 96 Deep-Well Plate (on Magnetic Module)", "options": [{"label": "nest_96_wellplate_2ml_deep", "value": "nest_96_wellplate_2ml_deep"}]}, {"name": "res_type", "type": "dropDown", "label": "Labware for 12-Well Reagent Reservoir", "options": [{"label": "nest_12_reservoir_15ml", "value": "nest_12_reservoir_15ml"}]}, {"name": "starting_vol", "type": "int", "label": "Volume of Input Sample (ul)", "default": 120}, {"name": "binding_buffer_vol", "type": "int", "label": "Volume of Binding Buffer (ul)", "default": 200}, {"name": "wash1_vol", "type": "int", "label": "Volume of Wash1 (ul)", "default": 100}, {"name": "wash2_vol", "type": "int", "label": "Volume of Wash2 (ul)", "default": 100}, {"name": "wash3_vol", "type": "int", "label": "Volume of Wash3 (ul)", "default": 100}, {"name": "elution_vol", "type": "int", "label": "Volume of Elution Buffer (ul)", "default": 50}, {"name": "mix_reps", "type": "int", "label": "Default Number of Mix Repetitions", "default": 10}, {"name": "settling_time", "type": "int", "label": "Magnetic Module Settling Time (min)", "default": 5}, {"name": "park_tips", "type": "dropDown", "label": "Park Tips? (yes or no)", "options": [{"label": "NO", "value": false}, {"label": "YES", "value": true}]}, {"name": "tip_track", "type": "dropDown", "label": "Track Tips? (yes or no)", "options": [{"label": "NO", "value": false}, {"label": "YES", "value": true}]}, {"name": "flash", "type": "dropDown", "label": "Flash OT-2 Deck Lights as Notification to Empty Tip Waste? (yes or no)", "options": [{"label": "NO", "value": false}, {"label": "YES", "value": true}]}]""")
    return [_all_values[n] for n in names]


def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":96,"deepwell_type":"nest_96_wellplate_2ml_deep","res_type":"nest_12_reservoir_15ml","starting_vol":120,"binding_buffer_vol":200,"wash1_vol":100,"wash2_vol":100,"wash3_vol":100,"elution_vol":50,"mix_reps":10,"settling_time":5,"park_tips":false,"tip_track":false,"flash":false}""")
    return [_all_values[n] for n in names]
