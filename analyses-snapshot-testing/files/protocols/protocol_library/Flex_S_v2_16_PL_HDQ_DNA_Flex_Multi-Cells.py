def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "trash_chute", "type": "dropDown", "label": "Trash Chute Present?", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "USE_GRIPPER", "type": "dropDown", "label": "Use Gripper", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "dry_run", "type": "dropDown", "label": "Dry Run", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "mount", "type": "dropDown", "label": "Pipette Mount", "options": [{"label": "left", "value": "left"}, {"label": "right", "value": "right"}]}, {"name": "temp_mod", "type": "dropDown", "label": "Temperature Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "heater_shaker", "type": "dropDown", "label": "Heater-Shaker Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "res_type", "type": "dropDown", "label": "Reseroir Type", "options": [{"label": "Nest 12 Well Reservoir 15ml", "value": "nest_12_reservoir_15ml"}, {"label": "Nest 12 Well Reservoir 22ml", "value": "nest_12_reservoir_22ml"}]}, {"name": "num_samples", "type": "int", "label": "Number of Samples", "default": 8}, {"name": "wash1_vol", "type": "int", "label": "Wash 1 Volume", "default": 600}, {"name": "wash2_vol", "type": "int", "label": "Wash 2 Volume", "default": 600}, {"name": "wash3_vol", "type": "int", "label": "Wash 3 Volume", "default": 600}, {"name": "AL_vol", "type": "int", "label": "AL Volume", "default": 230}, {"name": "sample_vol", "type": "int", "label": "Sample Starting Volume", "default": 180}, {"name": "bind_vol", "type": "int", "label": "Binding Buffer Volume", "default": 320}, {"name": "elution_vol", "type": "int", "label": "Elution Volume", "default": 100}]""")
...
def run(ctx):
    ...
    try:
        [res_type,temp_mod,trash_chute,USE_GRIPPER, dry_run,mount,num_samples,heater_shaker,wash1_vol,wash2_vol,wash3_vol,AL_vol,sample_vol,bind_vol,elution_vol] = get_values(  # noqa: F821
        'res_type','temp_mod','trash_chute','USE_GRIPPER','dry_run','mount','num_samples','heater_shaker','wash1_vol','wash2_vol','wash3_vol','AL_vol','sample_vol','bind_vol','elution_vol')
    ...
    def A_lysis(vol, source):
        ...
        if heater_shaker:
            ...
            if not dry_run:
                ctx.pause(msg='Place on shaker for 15 minutes at 2000 rpm. Then increase temperature to 55C and continue shaking for 10 minutes.')
