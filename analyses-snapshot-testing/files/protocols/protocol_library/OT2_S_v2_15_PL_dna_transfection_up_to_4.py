def get_values(*names):
    import json
    _all_values = json.loads("""{"TRANSFECTION_TYPE": 1, "PIPET_LOCATION": 1, "plate_type_1": 24, "plate_mm_1": 6, "plate_repl_1": 4, "plate_type_2": 24, "plate_mm_2": 6, "plate_repl_2": 4, "plate_type_3": 24, "plate_mm_3": 6, "plate_repl_3": 4, "plate_type_4": 24, "plate_mm_4": 6, "plate_repl_4": 4}""")
