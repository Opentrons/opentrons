def get_values(*names):
    import json
    _all_values = json.loads("""{"no_samps": "8", "pip_tip": "p50_single opentrons_96_tiprack_300ul", "p300gen": "p300_multi", "p300tips": "opentrons_96_filtertiprack_200ul", "magmod": "magnetic module", "a_index": "yes", "cycles": 5, "f_time": 10}""")
