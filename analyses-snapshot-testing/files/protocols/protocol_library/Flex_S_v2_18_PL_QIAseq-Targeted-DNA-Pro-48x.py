...
metadata = {'protocolName': 'QIAseq Targeted DNA 48x v8','author': 'Opentrons <protocols@opentrons.com>','source': 'Protocol Library'}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # =================================================================================================
    #-------PROTOCOL STEP-------
    STEP_FRERAT           = True      # Set to 0 to skip block of commands
    STEP_FRERATDECK       = True      # Set to 0 to skip block of commands
    STEP_LIG              = True      # Set to 0 to skip block of commands
    STEP_LIGDECK          = True      # Set to 0 to skip block of commands
    STEP_POSTLIG          = True      # Set to 0 to skip block of commands
    STEP_ECR1DECK         = True      # Set to 0 to skip block of commands
    STEP_TARGAMP          = True      # Set to 0 to skip block of commands
    STEP_TARGAMPDECK      = True      # Set to 0 to skip block of commands
    STEP_POSTTARGAMP      = True      # Set to 0 to skip block of commands
    STEP_ECR2DECK         = True      # Set to 0 to skip block of commands
    STEP_AMP              = True      # Set to 0 to skip block of commands
    STEP_AMPDECK          = True      # Set to 0 to skip block of commands
    STEP_CLEANUP          = True      # Set to 0 to skip block of commands
    #---------------------------
    ...
    AllSteps=[STEP_FRERAT,STEP_LIG,STEP_POSTLIG,STEP_TARGAMP,STEP_POSTTARGAMP,STEP_AMP,STEP_CLEANUP]
    ...
    def TipCheck(tiptype,tipuse,rep,tipset):
        ...
        if tiptype == 200 and tipuse != 'STP':
            if p200_TIPS == 0 and len(p200_INITIALTIPS) == 0:
                if tipuse == 'REUSE' and tipset == 'ETOH' and REUSE_200_TIPS_ETOH == True:
            ...
            if p200_TIPS == 0 and len(p200_INITIALTIPS) > 0:
                if tipuse == 'REUSE' and REUSE_ANY_200_TIPS == True:
                    if tipset == 'ETOH' and REUSE_200_TIPS_ETOH == True:
                        p1000.pick_up_tip(REUSE_200_TIPS_1[rep])
                    else:
    ...
    sample_plate_3 = heatershaker.load_labware('opentrons_96_wellplate_200ul_pcr_full_skirt','Sample Plate 3')
    mag_block = protocol.load_module('magneticBlockV1', 'D2')
    sample_plate_2 = mag_block.load_labware('opentrons_96_wellplate_200ul_pcr_full_skirt', 'Sample Plate 2')
    # ============ TRASH =============
    if TRASH_POSITION == 'BIN':
    ...
    LIG_Adapt           = reagent_plate_1['A2']
    LIG                 = reagent_plate_1['A3']
    LIG_EC              = reagent_plate_1['A4']
    TARGAMP_Primer      = reagent_plate_1['A5']
    TARGAMP             = reagent_plate_1['A6']
    TARGAMP_EC          = reagent_plate_1['A7']
    #PCR                = reagent_plate_1['A8']
    #PCR                = reagent_plate_1['A9']
    #PCR                = reagent_plate_1['A10']

    # =========================== REAGENT PLATE =============================
    #Barcodes_1         = reagent_plate_1['A1']
    #Barcodes_2         = reagent_plate_1['A2']
    #Barcodes_3         = reagent_plate_1['A3']
    #Barcodes_4         = reagent_plate_1['A4']
    #Barcodes_5         = reagent_plate_1['A5']
    #Barcodes_6         = reagent_plate_1['A6']

    # ============================ RESERVOIR ================================
    QiaSeqBeads         = reservoir['A1']
    H20                 = reservoir['A2']
    #EtOH               = reservoir['A3']
    #EtOH               = reservoir['A4']
    #
    ...
    if COLUMNS == 1:
        column_1_list = ['A1']                                              # Sample_plate_1 FRERAT/LIG/LIGEC/TARGAMP
        column_2_list = ['A7']                                              # Sample_plate_1 TARGAMPEC
        column_3_list = ['A1']                                              # Sample_plate_2 EXCESS SAMPLE
        column_4_list = ['A7',]                                             # Sample_plate_2 POSTCLEANUP
        column_5_list = ['A7',]                                             # Sample_plate_3 FINAL LIBRARY
        ETOH_list = ['A3']
        PCR_list = ['A8']
        barcodes = ['A1']                                                   # Sample_plate_3 BARCODES
    if COLUMNS == 2:
        column_1_list = ['A1','A2']                                         # Sample_plate_1 FRERAT/LIG/LIGEC/TARGAMP
        column_2_list = ['A7','A8']                                         # Sample_plate_1 TARGAMPEC
        column_3_list = ['A1','A2']                                         # Sample_plate_2 EXCESS SAMPLE
        column_4_list = ['A7','A8']                                         # Sample_plate_2 POSTCLEANUP
        column_5_list = ['A7','A8']                                         # Sample_plate_3 FINAL LIBRARY
        ETOH_list = ['A3','A3']
        PCR_list = ['A8','A8']
        barcodes = ['A1','A2']                                              # Sample_plate_3 BARCODES
    if COLUMNS == 3:
        column_1_list = ['A1','A2','A3']                                    # Sample_plate_1 FRERAT/LIG/LIGEC/TARGAMP
        column_2_list = ['A7','A8','A9']                                    # Sample_plate_1 TARGAMPEC
        column_3_list = ['A1','A2','A3']                                    # Sample_plate_2 EXCESS SAMPLE
        column_4_list = ['A7','A8','A9']                                    # Sample_plate_2 POSTCLEANUP
        column_5_list = ['A7','A8','A9']                                    # Sample_plate_3 FINAL LIBRARY
        ETOH_list = ['A3','A3','A3']
        PCR_list = ['A8','A8','A9']
        barcodes = ['A1','A2','A3']                                         # Sample_plate_3 BARCODES
    if COLUMNS == 4:
        column_1_list = ['A1','A2','A3','A4']                               # Sample_plate_1 FRERAT/LIG/LIGEC/TARGAMP
        column_2_list = ['A7','A8','A9','A10']                              # Sample_plate_1 TARGAMPEC
        column_3_list = ['A1','A2','A3','A4']                               # Sample_plate_2 EXCESS SAMPLE
        column_4_list = ['A7','A8','A9','A10']                              # Sample_plate_2 POSTCLEANUP
        column_5_list = ['A7','A8','A9','A10']                              # Sample_plate_3 FINAL LIBRARY
        ETOH_list = ['A3','A3','A3','A3']
        PCR_list = ['A8','A8','A9','A9']
        barcodes = ['A1','A2','A3','A4']                                    # Sample_plate_3 BARCODES
    # ========================== GREATER THAN 4 =============================
    if COLUMNS == 5:
        column_1_list = ['A1','A2','A3','A4','A5']                          # Sample_plate_1 FRERAT/LIG/LIGEC/TARGAMP
        column_2_list = ['A7','A8','A9','A10','A11']                        # Sample_plate_1 TARGAMPEC
        column_3_list = ['A1','A2','A3','A4','A5']                          # Sample_plate_2 EXCESS SAMPLE
        column_4_list = ['A7','A8','A9','A10','A11']                        # Sample_plate_2 POSTCLEANUP
        column_5_list = ['A7','A8','A9','A10','A11']                        # Sample_plate_3 FINAL LIBRARY
        ETOH_list = ['A3','A3','A3','A4','A4']
        PCR_list = ['A8','A8','A9','A9','A10']
        barcodes = ['A1','A2','A3','A4','A5']                               # Sample_plate_3 BARCODES
    if COLUMNS == 6:
        column_1_list = ['A1','A2','A3','A4','A5','A6']                     # Sample_plate_1 FRERAT/LIG/LIGEC/TARGAMP
        column_2_list = ['A7','A8','A9','A10','A11','A12']                  # Sample_plate_1 TARGAMPEC
        column_3_list = ['A1','A2','A3','A4','A5','A6']                     # Sample_plate_2 EXCESS SAMPLE
        column_4_list = ['A7','A8','A9','A10','A11','A12']                  # Sample_plate_2 POSTCLEANUP
        column_5_list = ['A7','A8','A9','A10','A11','A12']                  # Sample_plate_3 FINAL LIBRARY
        ETOH_list = ['A3','A3','A3','A4','A4','A4']
        PCR_list = ['A8','A8','A9','A9','A10','A10']
        barcodes = ['A1','A2','A3','A4','A5','A6']                          # Sample_plate_3 BARCODES
    ...
    if STEP_FRERAT == 1:
        ...
        FRERATVol    = 4.2
        FRERATMixRep = 10 if DRYRUN == False else 1
        FRERATMixVol = 8
        ...
        for loop, X in enumerate(column_1_list):
            ...
            p50.aspirate(FRERATVol, FRERAT.bottom(z=0.3), rate=0.5)
            p50.dispense(FRERATVol, sample_plate_1.wells_by_name()[X].bottom(z=0.3), rate=0.5)
            p50.move_to(sample_plate_1[X].bottom(z=0.3))
            p50.mix(FRERATMixRep,FRERATMixVol, rate=0.5)
    ...
    if STEP_FRERATDECK == 1:
        ...
        if ONDECK_THERMO == True:
            ...
            if DRYRUN == False:
                profile_FRERAT = [
                    {'temperature': 32, 'hold_time_minutes': 10},
            ...
            if DRYRUN == False:
                protocol.pause('Pausing to run Fragmentation and End Repair on an off deck Thermocycler ~15min')
            else:
                protocol.comment('Pausing to run Fragmentation and End Repair on an off deck Thermocycler ~15min')
        ############################################################################################################################################
    ...
    if STEP_LIG == 1:
        ...
        protocol.comment('--> Mixing Lig')
        LIG_AdaptVol = 1.5*COLUMNS
        LIG_AdaptMixRep = 10 if DRYRUN == False else 1
        LIG_AdaptMixVol = 20
        p50.flow_rate.aspirate = p50_flow_rate_aspirate_default*0.5
        p50.flow_rate.dispense = p50_flow_rate_dispense_default*0.5
        p50.flow_rate.blow_out = p50_flow_rate_blow_out_default*0.5
        #===============================================
        TipCheck(50,None,loop,None)
        p50.aspirate(LIG_AdaptVol, LIG_Adapt.bottom(z=0.3), rate=0.5)
        p50.dispense(LIG_AdaptVol, LIG.bottom(z=0.3), rate=0.5)
        p50.move_to(LIG.bottom(z=0.3))
        p50.mix(LIG_AdaptMixRep,LIG_AdaptMixVol, rate=0.5)
        p50.default_speed = 5
        p50.move_to(LIG.top(z=-5))
        protocol.delay(seconds=0.2)
        p50.blow_out(LIG.top(z=-5))
        p50.move_to(LIG.top(z=5))
        ...
        for loop, X in enumerate(column_1_list):
            TipCheck(50,None,loop,None)
            p50.mix(5,LIGVol, LIG.bottom(z=1), rate=0.5)
            p50.aspirate(LIGVol, LIG.bottom(z=1), rate=0.2)
            p50.default_speed = 5
            p50.move_to(LIG.top(5))
            protocol.delay(seconds=0.2)
            p50.default_speed = 400
            p50.dispense(LIGVol, sample_plate_1[X].bottom(z=0.3), rate=0.25)
            p50.move_to(sample_plate_1[X].bottom(z=0.3))
    ...
    if STEP_LIGDECK == 1:
        ...
        if ONDECK_THERMO == True:
            thermocycler.close_lid()
            if DRYRUN == False:
                thermocycler.set_lid_temperature(65)    
            if DRYRUN == False:
                profile_LIG = [
    ...
    if STEP_POSTLIG == 1:
        protocol.comment('==============================================')
        protocol.comment('--> Enzymatic Cleanup')
        protocol.comment('==============================================')

        protocol.comment('--> Adding LIG_EC')
        LIG_ECVol = 2
        LIG_ECMixRep = 20 if DRYRUN == False else 1
        LIG_ECMixVol = 20
        p1000.flow_rate.aspirate = p1000_flow_rate_aspirate_default*0.5
        p1000.flow_rate.dispense = p1000_flow_rate_dispense_default*0.5
        p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default*0.5
        ...
        for loop, X in enumerate(column_1_list):
            TipCheck(50,None,loop,None)
            p50.aspirate(LIG_ECVol, LIG_EC.bottom(z=1), rate=0.2)
            p50.default_speed = 5
            p50.move_to(LIG_EC.top(5))
            protocol.delay(seconds=0.2)
            p50.default_speed = 400
            p50.dispense(LIG_ECVol, sample_plate_1[X].bottom(z=0.3), rate=0.25)
            p50.mix(LIG_ECMixRep,LIG_ECMixVol,rate=0.5)
            p50.blow_out(sample_plate_1[X].top(z=-5))
            TipDone(50,None,loop,None)
        #===============================================
    ...
    if STEP_ECR1DECK == 1:
        ...
        if ONDECK_THERMO == True:
            ...
            if DRYRUN == False:
                ...
                thermocycler.execute_profile(steps=profile_ECR1, repetitions=1, block_max_volume=50)
                thermocycler.set_block_temperature(4)
            thermocycler.open_lid()
        else:
            if DRYRUN == False:
                protocol.pause('Pausing to run Enzymatic Cleanup on an off deck Thermocycler ~25min')
            else:
                protocol.comment('Pausing to run Enzymatic Cleanup on an off deck Thermocycler ~25min')
        ############################################################################################################################################

    if STEP_TARGAMP == 1:
        protocol.comment('==============================================')
        protocol.comment('--> Targeted Amplification')
        protocol.comment('==============================================')

        protocol.comment('--> Mixing TARGAMP')
        TARGAMP_PrimerVol = 10.25*COLUMNS
        TARGAMP_PrimerMixRep = 3 if DRYRUN == False else 1
        TARGAMP_PrimerMixVol = 20
        if COLUMNS >=5:
            p1000.flow_rate.aspirate = p1000_flow_rate_aspirate_default*0.5
            p1000.flow_rate.dispense = p1000_flow_rate_dispense_default*0.5
            p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default*0.5
        ...
        if COLUMNS >=5:
            ...
            p1000.aspirate(TARGAMP_PrimerVol, TARGAMP_Primer.bottom(z=0.3), rate=0.2)
            p1000.dispense(TARGAMP_PrimerVol, TARGAMP.bottom(z=0.3), rate=0.25)
            p1000.move_to(TARGAMP.bottom(z=0.3))
            p1000.mix(TARGAMP_PrimerMixRep,TARGAMP_PrimerMixVol, rate=0.5)
            p1000.blow_out(TARGAMP.top(z=-5))
            TipDone(200,None,loop,None)
        else:
            TipCheck(50,None,loop,None)
            p50.aspirate(TARGAMP_PrimerVol, TARGAMP_Primer.bottom(z=0.3), rate=0.2)
            p50.dispense(TARGAMP_PrimerVol, TARGAMP.bottom(z=0.3), rate=0.25)
            p50.move_to(TARGAMP.bottom(z=0.3))
            p50.mix(TARGAMP_PrimerMixRep,TARGAMP_PrimerMixVol, rate=0.5)
            p50.blow_out(TARGAMP.top(z=-5))
            TipDone(50,None,loop,None)
        #===============================================

        protocol.comment('--> Adding TARGAMP')
        TARGAMPVol = 22.65
        TARGAMPMixRep = 20 if DRYRUN == False else 1
        TARGAMPMixVol = 20
        #===============================================
        for loop, X in enumerate(column_1_list):
            TipCheck(50,None,loop,None)
            p50.mix(3,TARGAMPVol, TARGAMP.bottom(z=1), rate=0.5)
            p50.aspirate(TARGAMPVol, TARGAMP.bottom(z=0.3), rate=0.2)
            p50.default_speed = 5
            p50.move_to(TARGAMP.top(5))
            protocol.delay(seconds=0.2)
            p50.default_speed = 400
            p50.dispense(TARGAMPVol, sample_plate_1[X].bottom(z=0.3), rate=0.25)
            p50.move_to(sample_plate_1[X].bottom(z=0.3))
            p50.mix(TARGAMPMixRep,TARGAMPMixVol, rate=0.5)
            p50.blow_out(sample_plate_1[X].top(z=-5))
            TipDone(50,None,loop,None)
        #===============================================

    if STEP_TARGAMPDECK == 1:
        ############################################################################################################################################
        if ONDECK_THERMO == True:
            if DRYRUN == False:
            ...
            if DRYRUN == False:
                profile_PCR_1 = [
                    {'temperature': 98, 'hold_time_seconds': 2*60}
                    ]
                thermocycler.execute_profile(steps=profile_PCR_1, repetitions=1, block_max_volume=50)
                profile_PCR_2 = [
                    {'temperature': 98, 'hold_time_seconds': 15},
                    {'temperature': 65, 'hold_time_seconds': 2*60}
                    ]
                thermocycler.execute_profile(steps=profile_PCR_2, repetitions=8, block_max_volume=50)
                profile_PCR_3 = [
    ...
    if STEP_POSTTARGAMP == 1:
        protocol.comment('--> Adding SAMPLE')
        SampleVol = 20
        SampleExcessVol = 32.65
        p50.flow_rate.aspirate = p50_flow_rate_aspirate_default*0.5
        p50.flow_rate.dispense = p50_flow_rate_dispense_default*0.5
        p50.flow_rate.blow_out = p50_flow_rate_blow_out_default*0.5
        #===============================================
        for loop, X in enumerate(column_1_list):
            TipCheck(50,None,loop,None)
            p50.aspirate(SampleVol, sample_plate_1[X].bottom(z=0.5), rate=0.2)
            p50.default_speed = 5
            p50.move_to(sample_plate_1[X].top(5))
            protocol.delay(seconds=0.2)
            p50.default_speed = 400
            p50.dispense(SampleVol, sample_plate_1[column_2_list[loop]].bottom(z=0.3),rate=0.2)
            p50.aspirate(SampleExcessVol, sample_plate_1[X].bottom(z=0.75))
            p50.default_speed = 5
            p50.move_to(sample_plate_1[X].top(5))
            protocol.delay(seconds=0.2)
            p50.default_speed = 400
            p50.dispense(SampleExcessVol, sample_plate_3[column_3_list[loop]].bottom(z=0.3))
            TipDone(50,None,loop,None)
        #===============================================

        protocol.comment('--> Adding EC')
        TARGAMP_ECVol = 5
        TARGAMP_ECMixRep = 40 if DRYRUN == False else 1
        TARGAMP_ECMixVol = 20
        p50.flow_rate.aspirate = p50_flow_rate_aspirate_default*0.5
        p50.flow_rate.dispense = p50_flow_rate_dispense_default*0.5
        p50.flow_rate.blow_out = p50_flow_rate_blow_out_default*0.5
        ...
        for loop, X in enumerate(column_2_list):
            TipCheck(50,None,loop,None)
            p50.mix(1,TARGAMP_ECVol+3, TARGAMP_EC.bottom(z=1), rate=0.5)
            p50.aspirate(TARGAMP_ECVol+3, TARGAMP_EC.bottom(z=1), rate=0.2)
            p50.dispense(3, TARGAMP_EC.bottom(z=1), rate=0.2)
            p50.default_speed = 5
            p50.move_to(TARGAMP_EC.top(5))
            protocol.delay(seconds=0.2)
            p50.default_speed = 400
            p50.dispense(TARGAMP_ECVol, sample_plate_1[X].bottom(z=0.3), rate=0.5)
            p50.aspirate(5, sample_plate_1[X].bottom(z=0.3), rate=0.5)
            p50.dispense(5, sample_plate_1[X].bottom(z=0.3), rate=0.5)
            TipDone(50,None,loop,None)
        #===============================================

        protocol.comment('--> Mixing EC')
        TARGAMP_ECMixRep = 20 if DRYRUN == False else 1
        TARGAMP_ECMixVol = 25
        p1000.flow_rate.aspirate = p1000_flow_rate_aspirate_default*0.5
        p1000.flow_rate.dispense = p1000_flow_rate_dispense_default*0.5
        p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default*0.5
        ...
        for loop, X in enumerate(column_2_list):
            ...
            p1000.mix(TARGAMP_ECMixRep,TARGAMP_ECMixVol, rate=0.25)
            TipDone(200,None,loop,None)
        #===============================================
    ...
    if STEP_ECR2DECK == 1:
        ...
        if ONDECK_THERMO == True:
            ...
            if DRYRUN == False:
                ...
                thermocycler.execute_profile(steps=profile_ECR2, repetitions=1, block_max_volume=50)
                thermocycler.set_block_temperature(4)
            thermocycler.open_lid()
        else:
            if DRYRUN == False:
    ...
    if STEP_AMP == 1:
        ...
        BarcodeVol    = 5
        BarcodeMixRep = 2 if DRYRUN == False else 1
        BarcodeMixVol = 10
        p1000.flow_rate.aspirate = p1000_flow_rate_aspirate_default*0.5
        p1000.flow_rate.dispense = p1000_flow_rate_dispense_default*0.5
        p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default*0.5
        ...
        for loop, X in enumerate(column_2_list):
            TipCheck(50,None,loop,None)
            p50.aspirate(BarcodeVol, sample_plate_3.wells_by_name()[barcodes[loop]].bottom(), rate=0.25)
        ...
        for loop, X in enumerate(column_2_list):
            TipCheck(200,None,loop,None)
            p1000.mix(2,PCRVol, reagent_plate_1.wells_by_name()[PCR_list[loop]].bottom(z=1), rate=0.5)
            p1000.aspirate(PCRVol, reagent_plate_1.wells_by_name()[PCR_list[loop]].bottom(z=1), rate=0.25)
    ...
    if STEP_CLEANUP == 1:
        ...
        for loop, X in enumerate(column_2_list):
            TipCheck(200,None,loop,None)
            p1000.aspirate(SampleVol+2, sample_plate_1[X].bottom(z=0.75), rate=0.25)
            p1000.dispense(SampleVol+2, sample_plate_2[column_4_list[loop]].bottom(z=0.3), rate=0.5)
            p1000.blow_out(sample_plate_2[column_4_list[loop]].center())
            p1000.default_speed = 100
            p1000.move_to(sample_plate_2[column_4_list[loop]].top().move(types.Point(x=4,z=-3)))
            p1000.move_to(sample_plate_2[column_4_list[loop]].top().move(types.Point(x=-4,z=-3)))
        ...
        if ONDECK_HEATERSHAKER == True:
            protocol.move_labware(labware=sample_plate_1,new_location=TRASH,use_gripper=USE_GRIPPER,pick_up_offset=hs_pick_up_offset)
        else:
        ...
        #============================================================================================
        # GRIPPER MOVE (sample_plate_3)  HEATERSHAKER --> THERMOCYCLER
        if ONDECK_HEATERSHAKER == True:
            heatershaker.open_labware_latch()
            protocol.move_labware(labware=sample_plate_3,new_location=thermocycler,use_gripper=USE_GRIPPER,pick_up_offset=hs_pick_up_offset,drop_offset=tc_drop_offset)
            heatershaker.close_labware_latch()
        else:
            protocol.move_labware(labware=sample_plate_3,new_location='B1',use_gripper=USE_GRIPPER,pick_up_offset=hs_pick_up_offset,drop_offset=deck_drop_offset)
        #============================================================================================
        ...
        protocol.comment('--> ADDING QiaSeqBeads (0.8x)')
        QiaSeqBeadsVol = 80
        SampleVol = 100
        QiaSeqBeadsMixTime = 5*60 if DRYRUN == False else 0.1*60
        QiaSeqBeadsPremix = 3 if DRYRUN == False else 1
        #===============================================
        for loop, X in enumerate(column_4_list):
            TipCheck(200,None,loop,None)
            p1000.mix(QiaSeqBeadsPremix,QiaSeqBeadsVol+10, QiaSeqBeads.bottom(z=1), rate=0.25)
            p1000.aspirate(QiaSeqBeadsVol+3, QiaSeqBeads.bottom(z=1), rate=0.25)
            p1000.dispense(3, QiaSeqBeads.bottom(z=1), rate=0.25)
            p1000.default_speed = 5
            p1000.move_to(QiaSeqBeads.top(z=-3))
            p1000.default_speed = 100
            p1000.move_to(QiaSeqBeads.top().move(types.Point(x=4,z=-3)))
            p1000.move_to(QiaSeqBeads.top().move(types.Point(x=-4,z=-3)))
            p1000.default_speed = 400
            p1000.dispense(QiaSeqBeadsVol, sample_plate_2[X].bottom(z=1), rate=0.25)
            p1000.default_speed = 5
            p1000.move_to(sample_plate_2[X].bottom(z=3))
            for Mix in range(2):
                p1000.aspirate(50, rate=0.5)
                p1000.move_to(sample_plate_2[X].bottom(z=0.75))
        ...
        if TIP_MIX == False:
            ...
            protocol.delay(QiaSeqBeadsMixTime)
        ...
        for loop, X in enumerate(column_4_list):
            ...
            p1000.move_to(sample_plate_2[X].bottom(z=2))
            p1000.aspirate(RemoveSup-100, rate=0.25)
            protocol.delay(seconds=3)
            p1000.move_to(sample_plate_2[X].bottom(z=0.2))
        ...
        #============================================================================================
        # GRIPPER MOVE (sample_plate_2) FROM MAG BLOCK --> HEATERSHAKER
        if ONDECK_HEATERSHAKER == True:
            heatershaker.open_labware_latch()
            protocol.move_labware(labware=sample_plate_2,new_location=heatershaker,use_gripper=USE_GRIPPER,pick_up_offset=mb_pick_up_offset,drop_offset=hs_drop_offset)
            heatershaker.close_labware_latch()
        ...
        for loop, X in enumerate(column_4_list):
            TipCheck(200,None,loop,None)
            p1000.aspirate(H20Vol, H20.bottom(z=1), rate=0.5)
            p1000.move_to(H20.top(z=0))
            p1000.move_to(H20.top(z=-5))
            p1000.default_speed = 100
            p1000.move_to(H20.top().move(types.Point(x=4,z=-3)))
            p1000.move_to(H20.top().move(types.Point(x=-4,z=-3)))
            p1000.default_speed = 400
            p1000.move_to(sample_plate_2[X].top(z=-2))
            p1000.dispense(H20Vol, rate=0.5)
            protocol.delay(seconds=3)
            p1000.blow_out()
            p1000.move_to(sample_plate_2[X].top(z=5))
            p1000.move_to(sample_plate_2[X].top(z=0))
        ...
        protocol.comment('--> Adding Qiagen Binding Buffer ')
        QBBBufferVol = 80
        QBBBufferMixTime = 5*60 if DRYRUN == False else 0.1*60
        QBBBUfferPremix = 3 if DRYRUN == False else 1
        #===============================================
        for loop, X in enumerate(column_4_list):
            TipCheck(200,None,loop,None)
            p1000.aspirate(QBBBufferVol, QBBBuffer.bottom(z=1), rate=0.25)
            p1000.move_to(QBBBuffer.top(z=0))
            p1000.move_to(QBBBuffer.top(z=-5))
            p1000.default_speed = 100
            p1000.move_to(QBBBuffer.top().move(types.Point(x=4,z=-3)))
            p1000.move_to(QBBBuffer.top().move(types.Point(x=-4,z=-3)))
            p1000.default_speed = 400
            p1000.move_to(sample_plate_2[X].top(z=-2))
            p1000.dispense(QBBBufferVol, rate=0.25)
            p1000.move_to(sample_plate_2[X].bottom(z=3))
            for Mix in range(2):
                p1000.aspirate(70, rate=0.25)
                p1000.move_to(sample_plate_2[X].bottom(z=0.75))
                p1000.aspirate(30, rate=0.25)
                p1000.dispense(30, rate=0.25)
                p1000.move_to(sample_plate_2[X].bottom(z=3))
                p1000.dispense(70,rate=0.25)
                Mix += 1
            p1000.move_to(sample_plate_2[X].top(z=-2))
            protocol.delay(seconds=3)
            p1000.blow_out()
        ...
        if TIP_MIX == False:
            heatershaker.set_and_wait_for_shake_speed(rpm=1800)
            protocol.delay(QBBBufferMixTime)
            heatershaker.deactivate_shaker()
        ...
        for X in range(2):
            ...
            if ETOH_1_AirMultiDis == True:
                TipCheck(200,None,loop,None)
                for loop, X in enumerate(column_4_list):
                    p1000.aspirate(ETOHMaxVol, reservoir.wells_by_name()[ETOH_list[loop]].bottom(z=1), rate=0.5)
                    ...
                    #================================ 
                    p1000.move_to(sample_plate_2[X].top(z=-2))
                    p1000.dispense(ETOHMaxVol, rate=0.5)
                    protocol.delay(seconds=3)
        ...
        for batch in range(BATCHREP):
            ...
            for loop, X in enumerate(column_4_list[batch*(int(len(column_4_list)/BATCHREP)):(1+batch)*int(len(column_4_list)/BATCHREP)]):
                ...
                p50.aspirate(RSBVol, RSB.bottom(z=0.5))
                p50.move_to(sample_plate_2.wells_by_name()[X].bottom(z=1))
                p50.dispense(RSBVol, rate=0.5)
                p50.blow_out(sample_plate_2.wells_by_name()[X].top())
        ...
        for loop, X in enumerate(column_4_list):
            ...
            p50.aspirate((TransferSup/2)+3, rate=0.25)
            p50.dispense(TransferSup+3, sample_plate_3[column_5_list[loop]].bottom(z=1), rate=0.5)
            TipDone(50,'REUSE',loop,'RSB')
        #===============================================
    ...
    if NOLABEL == False:
       # PROTOCOL SETUP - LABELING
        ...
        # ====== CALCULATING LIQUIDS ======
        Sample_Volume = 9.8
        QiaSeqBeads_Volume = COLUMNS*(80)
        ETOH_Volume = COLUMNS*(300)
        RSB_Volume = COLUMNS*(30)
        PCR_Volume = COLUMNS*(70)
        FRERAT_Volume = COLUMNS*(4.2)
        LIG_Adapt_Volume = COLUMNS*(1.5)
        LIG_Volume = COLUMNS*(12.5)
        LIG_EC_Volume = COLUMNS*(2)
        TARGAMP_Primer_Volume = COLUMNS*(10.25)
        TARGAMP_Volume = COLUMNS*(12.4)
        TARGAMP_EC_Volume = COLUMNS*(5)
        QBBBuffer_Volume = COLUMNS*(80)
        H20_Volume = COLUMNS*(100)
        
        TotalColumn = ['A','B','C','D','E','F','G','H']

        # ======== DEFINING LIQUIDS =======
        QiaSeqBeads = protocol.define_liquid(name="QiaSeqBeads", description="QiaSeq Beads", display_color="#704848")                           #704848 = 'AMPure Brown'
        ...
        Placeholder_Sample = protocol.define_liquid(name="Placeholder_Sample", description="Placeholder Sample", display_color="#82A9CF")       #82A9CF = 'Placeholder Sample Blue'
        Excess_Sample = protocol.define_liquid(name="Excess_Sample", description="Excess Sample", display_color="#82A9CF")                      #8193A4 = 'Excess Placeholder Sample Blue'
        ...
        LIG_Adapt = protocol.define_liquid(name="LIG_Adapt", description="Ligation Adapter", display_color="#FFFB00")                           #FFFB00 = 'Base Yellow'
        LIG = protocol.define_liquid(name="LIG", description="Ligation Mix", display_color="#0EFF00")                                           #0EFF00 = 'Base Green'
        LIG_EC = protocol.define_liquid(name="LIG_EC", description="Ligation Enzymatic Cleanup", display_color="#0082FF")                       #0082FF = 'Base  Blue'
        TARGAMP_Primer = protocol.define_liquid(name="TARGAMP_Primer", description="Targted Amplification Primer", display_color="#0004FF")     #0004FF = 'Base Indigo'
        TARGAMP = protocol.define_liquid(name="TARGAMP", description="Targeted Amplification Mix", display_color="#8400FF")                     #8400FF = 'Base Purple'
        TARGAMP_EC = protocol.define_liquid(name="TARGAMP_EC", description="Targeted Amplification Enzymatic Cleanup", display_color="#FF00FF") #FF00FF = 'Base Magenta'
        QBBBuffer = protocol.define_liquid(name="QBBBuffer", description="QiaSeq Binding Buffer", display_color="#FD9CFF")                      #FD9CFF = 'Base Pink'
        ...
        if RES_TYPE_96x == '12x15ml':
            reservoir.wells_by_name()['A1'].load_liquid(liquid=QiaSeqBeads, volume=QiaSeqBeads_Volume)
            reservoir.wells_by_name()['A2'].load_liquid(liquid=H20, volume=H20_Volume)
            if COLUMNS <= 4:
                reservoir.wells_by_name()['A3'].load_liquid(liquid=EtOH, volume=ETOH_Volume)
            if COLUMNS == 5:
                reservoir.wells_by_name()['A3'].load_liquid(liquid=EtOH, volume=ETOH_Volume*(3/5))
                reservoir.wells_by_name()['A4'].load_liquid(liquid=EtOH, volume=ETOH_Volume*(2/5))
            if COLUMNS == 5:
                reservoir.wells_by_name()['A3'].load_liquid(liquid=EtOH, volume=ETOH_Volume*(3/6))
            ...
            reservoir.wells_by_name()['A8'].load_liquid(liquid=QBBBuffer, volume=QBBBuffer_Volume)
        ...
        if RES_TYPE_96x == '96x2ml':
            for loop, X in enumerate(TotalColumn):
                reservoir.wells_by_name()[X+'1'].load_liquid(liquid=QiaSeqBeads, volume=QiaSeqBeads_Volume)
                reservoir.wells_by_name()[X+'2'].load_liquid(liquid=H20, volume=H20_Volume)
                if COLUMNS <= 4:
                    reservoir.wells_by_name()[X+'3'].load_liquid(liquid=EtOH, volume=ETOH_Volume)
                if COLUMNS == 5:
                    reservoir.wells_by_name()[X+'3'].load_liquid(liquid=EtOH, volume=ETOH_Volume*(3/5))
                    reservoir.wells_by_name()[X+'4'].load_liquid(liquid=EtOH, volume=ETOH_Volume*(2/5))
                if COLUMNS == 5:
                    reservoir.wells_by_name()[X+'3'].load_liquid(liquid=EtOH, volume=ETOH_Volume*(3/6))
                ...
                reservoir.wells_by_name()[X+'8'].load_liquid(liquid=QBBBuffer, volume=QBBBuffer_Volume)
        ...
        if COLUMNS >= 1:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_2.wells_by_name()[X+'7'].load_liquid(liquid=Placeholder_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'1'].load_liquid(liquid=Excess_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'7'].load_liquid(liquid=Final_Sample, volume=0)
        if COLUMNS >= 2:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_2.wells_by_name()[X+'8'].load_liquid(liquid=Placeholder_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'2'].load_liquid(liquid=Excess_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'8'].load_liquid(liquid=Final_Sample, volume=0)
        if COLUMNS >= 3:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_2.wells_by_name()[X+'9'].load_liquid(liquid=Placeholder_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'3'].load_liquid(liquid=Excess_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'9'].load_liquid(liquid=Final_Sample, volume=0)
        if COLUMNS >= 4:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_2.wells_by_name()[X+'10'].load_liquid(liquid=Placeholder_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'4'].load_liquid(liquid=Excess_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'10'].load_liquid(liquid=Final_Sample, volume=0)
        if COLUMNS >= 5:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_2.wells_by_name()[X+'11'].load_liquid(liquid=Placeholder_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'5'].load_liquid(liquid=Excess_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'11'].load_liquid(liquid=Final_Sample, volume=0)
        if COLUMNS >= 6:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_2.wells_by_name()[X+'12'].load_liquid(liquid=Placeholder_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'6'].load_liquid(liquid=Excess_Sample, volume=0)
                sample_plate_3.wells_by_name()[X+'12'].load_liquid(liquid=Final_Sample, volume=0)
        for loop, X in enumerate(TotalColumn):
            reagent_plate_1.wells_by_name()[X+'1'].load_liquid(liquid=FRERAT, volume=FRERAT_Volume)
            reagent_plate_1.wells_by_name()[X+'2'].load_liquid(liquid=LIG_Adapt, volume=LIG_Adapt_Volume)
            reagent_plate_1.wells_by_name()[X+'3'].load_liquid(liquid=LIG, volume=PCR_Volume)
            reagent_plate_1.wells_by_name()[X+'4'].load_liquid(liquid=LIG_EC, volume=LIG_EC_Volume)
            reagent_plate_1.wells_by_name()[X+'5'].load_liquid(liquid=TARGAMP_Primer, volume=TARGAMP_Primer_Volume)
            reagent_plate_1.wells_by_name()[X+'6'].load_liquid(liquid=TARGAMP, volume=TARGAMP_Volume)
            reagent_plate_1.wells_by_name()[X+'7'].load_liquid(liquid=TARGAMP_EC, volume=TARGAMP_EC_Volume)
            if COLUMNS == 1:
                reagent_plate_1.wells_by_name()[X+'8'].load_liquid(liquid=PCR, volume=PCR_Volume)
            if COLUMNS == 2:
                reagent_plate_1.wells_by_name()[X+'8'].load_liquid(liquid=PCR, volume=PCR_Volume)
            if COLUMNS == 3:
                reagent_plate_1.wells_by_name()[X+'8'].load_liquid(liquid=PCR, volume=PCR_Volume*(2/3))
                reagent_plate_1.wells_by_name()[X+'9'].load_liquid(liquid=PCR, volume=PCR_Volume*(1/3))
            if COLUMNS == 4:
                reagent_plate_1.wells_by_name()[X+'8'].load_liquid(liquid=PCR, volume=PCR_Volume*(2/4))
                reagent_plate_1.wells_by_name()[X+'9'].load_liquid(liquid=PCR, volume=PCR_Volume*(2/4))
            if COLUMNS == 5:
                reagent_plate_1.wells_by_name()[X+'8'].load_liquid(liquid=PCR, volume=PCR_Volume*(3/5))
                reagent_plate_1.wells_by_name()[X+'9'].load_liquid(liquid=PCR, volume=PCR_Volume*(2/5))
            if COLUMNS == 6:
                reagent_plate_1.wells_by_name()[X+'8'].load_liquid(liquid=PCR, volume=PCR_Volume*(3/6))
                reagent_plate_1.wells_by_name()[X+'9'].load_liquid(liquid=PCR, volume=PCR_Volume*(3/6))
