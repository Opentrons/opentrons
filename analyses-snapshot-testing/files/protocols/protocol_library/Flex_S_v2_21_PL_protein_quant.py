...
metadata = {
    'protocolName': 'Protein Quantification and Normalization - Part 1: Pierce BCA Protein Assay',
    'author': 'Boren Lin, Opentrons',
    'description': 'Samples prepared in 2 dilutions and processed for protein quantification'
}
...
def add_parameters(parameters):
    parameters.add_bool(variable_name="reader_on_deck",
                        ...
                        description="Will the plate be read by the plate reader module on deck?",
                        default=True
                        )
    parameters.add_bool(variable_name="wavelength_ref",
                        display_name="Reference Wavelength",
                        description="If plate read on deck, read the plate at reference wavelength (650nm) as well?",
                        default=True
                        )
