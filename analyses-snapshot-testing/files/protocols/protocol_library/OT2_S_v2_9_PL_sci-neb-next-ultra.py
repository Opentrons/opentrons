def get_values(*names):
    import json
    _all_values = json.loads("""{"SAMPLES": "8x", "DRYRUN": "NO", "NOMODULES": "NO", "TIPREUSE": "YES", "ONDECK": 1, "OFFSET": "YES", "STEP_ERAT": 1, "STEP_LIG": 1, "STEP_POSTLIG": 1, "STEP_PCR": 1, "STEP_POSTPCR": 1}""")
