def get_values(*names):
    import json
    _all_values = json.loads("""{"trash_chute": false, "USE_GRIPPER": true, "dry_run": false, "mount": "left", "temp_mod": true, "heater_shaker": true, "res_type": "nest_12_reservoir_15ml", "num_samples": 8, "wash1_vol": 600, "wash2_vol": 600, "wash3_vol": 600, "TL_vol": 250, "AL_vol": 230, "sample_vol": 200, "bind_vol": 320, "e_one_vol": 350, "elution_vol": 100}""")
...
def run(ctx):
    ...
    try:
        [res_type,temp_mod,trash_chute,USE_GRIPPER, dry_run,mount,num_samples,heater_shaker,wash1_vol,wash2_vol,wash3_vol,TL_vol,AL_vol,sample_vol,bind_vol,e_one_vol,elution_vol] = get_values(  # noqa: F821
        'res_type','temp_mod','trash_chute','USE_GRIPPER','dry_run','mount','num_samples','heater_shaker','wash1_vol','wash2_vol','wash3_vol','TL_vol','AL_vol','sample_vol','bind_vol','e_one_vol','elution_vol')
    ...
    TL_samples_m        = sample_plate.rows()[0][:num_cols]
    samples_m           = sample_plate.rows()[0][num_cols:2*num_cols]
    elution_samples_m   = elutionplate.rows()[0][:num_cols]

    colors = ['#008000','#A52A2A','#A52A2A','#00FFFF','#00FFFF','#0000FF','#800080',\
    '#ADD8E6','#00008B','#FF0000','#FFFF00','#FF00FF','#7FFFD4',\
