...
def run(ctx):
    ...
    [
        ...
        dry_time,
        tip_track,
    ] = [48, 225, 100, 360, 24, 600, 600, 600, 20, 15, 20, 5, 2, 5, 20, False]
    ...
    if not 180 <= starting_vol <= 225:
        raise Exception("Starting volume should be from 180 - 225Âµl.")
