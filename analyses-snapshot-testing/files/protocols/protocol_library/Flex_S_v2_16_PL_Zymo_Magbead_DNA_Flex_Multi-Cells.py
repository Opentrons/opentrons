def get_values(*names):
    import json
    _all_values = json.loads("""{"trash_chute": false, "USE_GRIPPER": true, "dry_run": false, "mount": "left", "temp_mod": true, "res_type": "nest_12_reservoir_15ml", "heater_shaker": true, "num_samples": 8, "wash1_vol": 500, "wash2_vol": 900, "wash3_vol": 900, "lysis_vol": 200, "sample_vol": 10, "bind_vol": 600, "bind2_vol": 500, "elution_vol": 75}""")
...
def run(ctx):
    ...
    try:
        [res_type,temp_mod,trash_chute,USE_GRIPPER, dry_run,mount,num_samples,heater_shaker,wash1_vol,wash2_vol,wash3_vol,lysis_vol,sample_vol,bind_vol,bind2_vol,elution_vol] = get_values(  # noqa: F821
        'res_type','temp_mod','trash_chute','USE_GRIPPER','dry_run','mount','num_samples','heater_shaker','wash1_vol','wash2_vol','wash3_vol','lysis_vol','sample_vol','bind_vol','bind2_vol','elution_vol')
    ...
    def bind(vol1,vol2):
        ...
        for i, well in enumerate(samples_m):
            ...
            if i == 0 and num_cols >= 3:
                height = 10
            elif i == 3 and num_cols == 6:
                height = 10
            else:
                height = 1
            #Transfer beads and binding from source to H-S plate
