def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples": 48, "starting_vol": 100, "elution_vol": 30, "NGS_bead_ratio1": 0.4, "NGS_bead_ratio2": 0.6, "wash1_vol": 200, "wash2_vol": 200, "mix_reps_bind": 15, "mix_reps_wash": 10, "mix_reps_elu": 20, "sep_time": 5, "dry_time": 10, "tip_track": 0}""")
