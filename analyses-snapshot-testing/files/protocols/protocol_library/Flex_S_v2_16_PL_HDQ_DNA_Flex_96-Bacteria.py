def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "trash_chute", "type": "dropDown", "label": "Trash Chute Present?", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "USE_GRIPPER", "type": "dropDown", "label": "Use Gripper", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "dry_run", "type": "dropDown", "label": "Dry Run", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "temp_mod", "type": "dropDown", "label": "Temperature Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "heater_shaker", "type": "dropDown", "label": "Heater-Shaker Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "tip_mixing", "type": "dropDown", "label": "Tip Mixing? (will heater-shaker be replaced with tip mixing-if h-s is present, this will be false)", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "wash_vol", "type": "int", "label": "Wash Volume", "default": 600}, {"name": "TL_vol", "type": "int", "label": "TL Volume", "default": 250}, {"name": "AL_vol", "type": "int", "label": "AL Volume", "default": 230}, {"name": "sample_vol", "type": "int", "label": "Sample Starting Volume", "default": 200}, {"name": "bind_vol", "type": "int", "label": "Binding Buffer Volume", "default": 320}, {"name": "elution_vol", "type": "int", "label": "Elution Volume", "default": 100}]""")
