def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples": 96, "starting_vol": 100, "elution_vol": 20, "NGS_bead_ratio": 1, "wash1_vol": 200, "wash2_vol": 200, "mix_reps_bind": 15, "mix_reps_wash": 10, "mix_reps_elu": 20, "sep_time": 5, "dry_time": 10, "tip_track": 0}""")
