...
metadata = {'protocolName': 'KAPA Library Quant 48x v8','author': 'Opentrons <protocols@opentrons.com>','source': 'Protocol Library',}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    ONDECK_THERMO         = False     # On Deck Thermocycler
    ONDECK_HEATERSHAKER   = False     # On Deck Heater Shaker
    ONDECK_TEMP           = False     # On Deck Thermocycler
    ...
    column_5_list = [['A1','A2','B1','B2'],['A3','A4','B3','B4'],['A5','A6','B5','B6'],['A7','A8','B7','B8'],['A9','A10','B9','B10'],['A11','A12','B11','B12'],['A13','A14','B13','B14']]
