def get_values(*names):
    import json
    _all_values = json.loads("""{"SAMPLES": "24x", "DRYRUN": "NO", "NOMODULES": "NO", "TIPREUSE": "NO", "OFFSET": "YES", "STEP_TAG": 1, "STEP_TAGDECK": 1, "STEP_TSB": 1, "STEP_TSBDECK": 1, "STEP_WASH": 1, "STEP_PCR": 1, "STEP_PCRDECK": 1, "STEP_POSTPCR": 1}""")
