def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples": 96, "deepwell_type": "nest_96_wellplate_2ml_deep", "res_type": "nest_12_reservoir_15ml", "starting_vol": 430, "elution_vol": 50, "park_tips": true, "mag_gen": "magdeck", "m300_mount": "left"}""")
