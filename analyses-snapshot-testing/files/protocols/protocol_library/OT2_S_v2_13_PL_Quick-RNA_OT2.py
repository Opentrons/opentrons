def get_values(*names):
    import json
    _all_values = json.loads("""{"dry_run": false, "mount": "left", "mag_mod_gen2": true, "temp_mod": true, "res_type": "nest_12_reservoir_15ml", "num_samples": 8, "bind_vol": 430, "wash_vol": 500, "stop_vol": 500, "elution_vol": 110, "sample_vol": 200, "lysis_vol": 200, "dnase_vol": 50}""")
