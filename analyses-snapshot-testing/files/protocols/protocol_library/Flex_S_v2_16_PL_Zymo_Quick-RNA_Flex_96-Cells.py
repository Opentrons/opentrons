def get_values(*names):
    import json
    _all_values = json.loads("""{"trash_chute": false, "USE_GRIPPER": true, "dry_run": false, "temp_mod": true, "heater_shaker": true, "tip_mixing": false, "sample_vol": 300, "wash_vol": 400, "stop_vol": 500, "lysis_vol": 200, "bind_vol": 400, "dnase_vol": 50, "elution_vol": 110}""")
