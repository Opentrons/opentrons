def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "trash_chute", "type": "dropDown", "label": "Trash Chute Present?", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "USE_GRIPPER", "type": "dropDown", "label": "Use Gripper", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "Macherey_Nagel_DW", "type": "dropDown", "label": "Macherey Nagel Deepwell", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "dry_run", "type": "dropDown", "label": "Dry Run", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "temp_mod", "type": "dropDown", "label": "Temperature Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "heater_shaker", "type": "dropDown", "label": "Heater-Shaker Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "tip_mixing", "type": "dropDown", "label": "Tip Mixing? (will heater-shaker be replaced with tip mixing-if h-s is present, this will be false)", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "wash1_vol", "type": "int", "label": "Wash 1 Volume", "default": 600}, {"name": "wash2_vol", "type": "int", "label": "Wash 2 Volume", "default": 600}, {"name": "wash3_vol", "type": "int", "label": "Wash 3 Volume", "default": 900}, {"name": "sample_vol", "type": "int", "label": "Starting Sample Volume", "default": 10}, {"name": "bind_vol", "type": "int", "label": "Binding Buffer Volume", "default": 360}, {"name": "lysis_vol", "type": "int", "label": "Lysis Volume", "default": 200}, {"name": "elution_vol", "type": "int", "label": "Elution Volume", "default": 100}]""")
