...
def run(protocol: protocol_api.ProtocolContext):
    ...
    falcontubes = protocol.load_labware('opentrons_15_tuberack_falcon_15ml_conical', 9)
    ...
    # Removing complete medium from cells, add OptiMEM
    ...
    p20.pick_up_tip()
    p20.aspirate(2.49, tubes['D1'])
    p20.dispense(2.49, tubes['B1'])
    p20.drop_tip()
    p1000.pick_up_tip()
    ...
    p20.pick_up_tip()
    p20.aspirate(7.47, tubes['D1'])
    p20.dispense(7.47, tubes['B3'])
    p20.drop_tip()
    p1000.pick_up_tip()
    ...
    p20.pick_up_tip()
    p20.aspirate(6, tubes['A5'])
    p20.dispense(6, tubes['B1'])
    p20.drop_tip()
    ...
    p20.pick_up_tip()
    p20.aspirate(18, tubes['A5'])
    p20.dispense(18, tubes['B3'])
    p20.drop_tip()
    ...
    p20.pick_up_tip()
    p20.aspirate(9, tubes['A4'])
    p20.dispense(9, tubes['B2'])
    p20.drop_tip()

    p1000.pick_up_tip()
    custom_mix(2, p1000, 300, tubes['B2'])
    p1000.drop_tip()

    p20.pick_up_tip()
    p20.aspirate(13.5, tubes['A4'])
    p20.dispense(13.5, tubes['B4'])
    p20.aspirate(13.5, tubes['A4'])
    p20.dispense(13.5, tubes['B4'])
    p20.drop_tip()

    p1000.pick_up_tip()
    custom_mix(2, p1000, 300, tubes['B4'])
    p1000.drop_tip()
    ...
    p20.pick_up_tip()
    p20.aspirate(9.6, tubes['A6'])
    p20.dispense(9.6, tubes['B5'])
    p20.drop_tip()
    p1000.pick_up_tip()
    custom_mix(2, p1000, 500, tubes['B5'])
    p1000.drop_tip()
    ...
    p20.pick_up_tip()
    p20.aspirate(14.4, tubes['A6'])
    p20.dispense(14.4, tubes['B6'])
    p20.aspirate(14.4, tubes['A6'])
    p20.dispense(14.4, tubes['B6'])
    p20.drop_tip()
    p1000.pick_up_tip()
    ...
    # Incubate complexes for 10-15 min at R.T.

    # Pause protocol for 12min-------Incubate
