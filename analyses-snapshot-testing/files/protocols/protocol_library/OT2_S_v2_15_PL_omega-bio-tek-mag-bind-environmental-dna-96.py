def get_values(*names):
    import json
    _all_values = json.loads("""{"_num_samps": 16, "lw_deepwell_plate": "nest_96_wellplate_2ml_deep", "lw_deepwell_plate_open": "", "_m300_mount": "right", "vol_xp1": 320, "vol_removal": 700, "_mag_time": 5, "_air_dry": 10, "_elution_vol": 100, "flow_rate_wash": 150, "_off_deck": 0, "_music": 0}""")
