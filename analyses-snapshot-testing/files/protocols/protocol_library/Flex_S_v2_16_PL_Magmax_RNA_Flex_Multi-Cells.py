def get_values(*names):
    import json
    _all_values = json.loads("""[{"name": "trash_chute", "type": "dropDown", "label": "Trash Chute Present?", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "USE_GRIPPER", "type": "dropDown", "label": "Use Gripper", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "dry_run", "type": "dropDown", "label": "Dry Run", "options": [{"label": "no", "value": false}, {"label": "yes", "value": true}]}, {"name": "mount", "type": "dropDown", "label": "Pipette Mount", "options": [{"label": "left", "value": "left"}, {"label": "right", "value": "right"}]}, {"name": "inc_lysis", "type": "dropDown", "label": "Include Lysis Incubation?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "temp_mod", "type": "dropDown", "label": "Temperature Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "heater_shaker", "type": "dropDown", "label": "Heater-Shaker Module Present?", "options": [{"label": "yes", "value": true}, {"label": "no", "value": false}]}, {"name": "res_type", "type": "dropDown", "label": "Reseroir Type", "options": [{"label": "Nest 12 Well Reservoir 15ml", "value": "nest_12_reservoir_15ml"}, {"label": "Nest 12 Well Reservoir 22ml", "value": "nest_12_reservoir_22ml"}]}, {"name": "num_samples", "type": "int", "label": "Number of Samples", "default": 8}, {"name": "wash_vol", "type": "int", "label": "Wash Volumes", "default": 150}, {"name": "lysis_vol", "type": "int", "label": "Lysis Volume", "default": 140}, {"name": "sample_vol", "type": "int", "label": "Sample Starting Volume", "default": 50}, {"name": "stop_vol", "type": "int", "label": "Stop Solution Volume", "default": 100}, {"name": "dnase_vol", "type": "int", "label": "DNAseI Volume", "default": 50}, {"name": "elution_vol", "type": "int", "label": "Elution Volume", "default": 50}]""")
...
def run(ctx):
    ...
    try:
        [res_type,temp_mod,trash_chute,USE_GRIPPER, dry_run,inc_lysis,mount,num_samples,heater_shaker,wash_vol,lysis_vol,sample_vol,stop_vol,dnase_vol,elution_vol] = get_values(  # noqa: F821
        'res_type','temp_mod','trash_chute','USE_GRIPPER','dry_run','inc_lysis','mount','num_samples','heater_shaker','wash_vol','lysis_vol','sample_vol','stop_vol','dnase_vol','elution_vol')
