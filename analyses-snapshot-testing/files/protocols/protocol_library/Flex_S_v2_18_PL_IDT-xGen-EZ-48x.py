...
metadata = {'protocolName': 'IDT xGen EZ 48x v8','author': 'Opentrons <protocols@opentrons.com>','source': 'Protocol Library',}
...
def add_parameters(parameters):
    ...
    parameters.add_int(
        ...
        default=7,minimum=1,maximum=20,
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    ETOH_1_AirMultiDis    = False     # Default False   | When adding WASH to multiple columns, dispense above the wells and reuse tips (Tip Saving)
    ...
    CUSTOM_OFFSETS        = False     # Default False   | Manually enter offset position settings
    ...
    REUSE_200_TIPS_ETOH_2 = False     # Default False   | Reusing p200 tips
    ...
    if NOLABEL == False:
       # PROTOCOL SETUP - LABELING
        ...
        if RES_TYPE_96x == '12x15ml':
            ...
            reservoir.wells_by_name()['A4'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/2))
            reservoir.wells_by_name()['A5'].load_liquid(liquid=EtOH, volume=(ETOH_Volume/2))
