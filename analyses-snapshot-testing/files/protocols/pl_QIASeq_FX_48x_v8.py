...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if STEP_CLEANUP_1 == True:
        ...
        for batch in range(BATCHREP):
            ...
            p1000.flow_rate.blow_out = p1000_flow_rate_blow_out_default * 0.5
            # ===============================================
            for loop, X in enumerate(
                column_2_list[batch * (int(len(column_2_list) / BATCHREP)) : (1 + batch) * int(len(column_2_list) / BATCHREP)]
            ):
                TipCheck(200, "REUSE", loop, "ETOH_1")
    ...
    if STEP_CLEANUP_2 == True:
        ...
        for batch in range(BATCHREP):
            ...
            # ===============================================
            for loop, X in enumerate(
                column_3_list[batch * (int(len(column_3_list) / BATCHREP)) : (1 + batch) * int(len(column_3_list) / BATCHREP)]
            ):
                TipCheck(200, "REUSE", loop, "ETOH_1")
    ...
    if STEP_CLEANUP_3 == True:
        ...
        for batch in range(BATCHREP):
            ...
            # ===============================================
            for loop, X in enumerate(
                column_5_list[batch * (int(len(column_5_list) / BATCHREP)) : (1 + batch) * int(len(column_5_list) / BATCHREP)]
            ):
                TipCheck(200, "REUSE", loop + COLUMNS, "ETOH_1")
