...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if ONDECK_TEMP == True:
        ...
        reagent_plate_1 = temp_adapter.load_labware("armadillo_96_wellplate_200ul_pcr_full_skirt", "C1", "Reagent Plate")
    reservoir = (
    ...
    if TRASH_POSITION == "BIN":
        ...
        if COLUMNS >= 5:
            sample_plate_2 = protocol.load_labware("armadillo_96_wellplate_200ul_pcr_full_skirt", "B4", "Sample Plate 2")
        else:
    ...
    if TRASH_POSITION == "CHUTE":
        ...
        if COLUMNS >= 5:
            sample_plate_2 = protocol.load_labware("armadillo_96_wellplate_200ul_pcr_full_skirt", "A4", "Sample Plate 2")
        else:
    ...
    if COLUMNS == 4:
        ...
        column_6_list = ["A9", "A10", "A11", "A12"]  # Sample Plate 2: Final
    ...
    if STEP_CLEANUP_1 == True:
        ...
        for loop, X in enumerate(column_1_list):
            ...
            if ONDECK_HEATERSHAKER == True and TIP_MIX == False:
                AmpureMixRep = 2
            if TIP_MIX == True:
                AmpureMixRep = 10
       ...
       # PROTOCOL SETUP - LABELING
        ...
        if COLUMNS >= 1:
            for loop, X in enumerate(TotalColumn):
                ...
                sample_plate_1.wells_by_name()[X+'1'].load_liquid(liquid=Final_Sample, volume=0)
