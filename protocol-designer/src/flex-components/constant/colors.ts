...
export const COLORS = {
  ...
  darkBlackSelected,
  darkBlackLight,
  dandelionYellowEnabled,
  dandelionYellowHover,
  dandelionYellowPressed,
  lightGreyPressed,
  lightGreyHover,
  medGreyEnabled,
  medGreyHover,
  ...
  successBackgroundMed,
  successEnabled,
  successText,
  successDisabled,
  warningBackgroundLight,
  warningBackgroundMed,
  warningEnabled,
  warningText,
  warningDisabled,
  ...
  light_two,
  highlightPurple_one,
  highlightPurple_one_pressed,
  highlightPurple_two,
  highlightPurple_two_pressed,
  foundationalBlue,
  green_one,
  green_two,
  green_three,
