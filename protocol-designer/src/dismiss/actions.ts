...
export const dismissFormWarning = (payload: $PropertyType<DismissFormWarning, "payload">): DismissFormWarning => ({
  type: 'DISMISS_FORM_WARNING',
  payload
});
export const dismissTimelineWarning = (payload: $PropertyType<DismissTimelineWarning, "payload">): DismissTimelineWarning => ({
