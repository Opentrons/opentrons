...
export const changeBatchEditField = (args: $PropertyType<ChangeBatchEditFieldAction, "payload">): ChangeBatchEditFieldAction => ({
  type: 'CHANGE_BATCH_EDIT_FIELD',
  payload: args
});
...
export const saveStepFormsMulti: (selectedStepIds: Array<StepIdType> | null) => ThunkAction<SaveStepFormsMultiAction> = selectedStepIds => (dispatch, getState) => {
