...
function mergeProps(stateProps: SP, dispatchProps: {
  ...
  return { ...passThruProps,
    ...
    saveFileMetadata: (nextFormValues: FileMetadataFields) => dispatch(actions.saveFileMetadata(nextFormValues)),
    swapPipettes: () => dispatch(steplistActions.changeSavedStepForm({
...
export const ConnectedFilePage: React.AbstractComponent<{}> = connect<Props, {}, SP, {}, _, _>(mapStateToProps, null, mergeProps)(FilePage);