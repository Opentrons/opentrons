...
export const saveFileMetadata = (payload: FileMetadataFields): SaveFileMetadataAction => ({
...
export const computeRobotStateTimelineSuccess = (payload: WorkerResponse): ComputeRobotStateTimelineSuccessAction => ({
  type: 'COMPUTE_ROBOT_STATE_TIMELINE_SUCCESS',
  payload
});