...
import { MAGNETIC_MODULE_TYPE, MAGNETIC_MODULE_V1 } from "@opentrons/shared-data";
...
describe('getRequiresAtLeastV4 selector', () => {
  const testCases: Array<{
    ...
    testName: 'should return false if there are no modules and no v4-specific commands',
    expected: false,
    robotStateTimeline: {
      timeline: []
    },
  ...
  testCases.forEach(({
    ...
    it(testName, () => {
      ...
      const result = getRequiresAtLeastV4.resultFunc(robotStateTimeline, moduleEntities);
