...
export const highlightWells = (payload: $PropertyType<HighlightWellsAction, "payload">): HighlightWellsAction => ({
  type: 'HIGHLIGHT_WELLS',
  payload
});
...
export const selectWells = (payload: $PropertyType<SelectWellsAction, "payload">): SelectWellsAction => ({
  type: 'SELECT_WELLS',
  payload
});
...
export const deselectWells = (payload: $PropertyType<DeselectWellsAction, "payload">): DeselectWellsAction => ({
  type: 'DESELECT_WELLS',
  payload
});
