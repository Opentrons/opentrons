...
import type { BlowoutParamsV3, LabwareDefinition2 } from '@opentrons/shared-data'
...
export const blowoutUtil = (args: {
  pipette: $PropertyType<BlowoutParamsV3, 'pipette'>,
  sourceLabwareId: string,
  sourceWell: $PropertyType<BlowoutParamsV3, 'well'>,
  destLabwareId: string,
  destWell: $PropertyType<BlowoutParamsV3, 'well'>,
