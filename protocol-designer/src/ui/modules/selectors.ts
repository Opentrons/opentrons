...
export const getLabwareNamesByModuleId: Selector<LabwareNamesByModuleId> =
  createSelector(
    getInitialDeckSetup,
...
export const getMagneticLabwareOptions: Selector<DropdownOption[]> =
  createSelector(
    getInitialDeckSetup,
    getLabwareNicknamesById,
    (initialDeckSetup, nicknamesById) => {
...
export const getTemperatureLabwareOptions: Selector<DropdownOption[]> =
  createSelector(
    getInitialDeckSetup,
    getLabwareNicknamesById,
    (initialDeckSetup, nicknamesById) => {
...
export const getHeaterShakerLabwareOptions: Selector<DropdownOption[]> =
  createSelector(
    getInitialDeckSetup,
    getLabwareNicknamesById,
    (initialDeckSetup, nicknamesById) => {
...
export const getAbsorbanceReaderLabwareOptions: Selector<DropdownOption[]> =
  createSelector(
...
export const getSingleMagneticModuleId: Selector<string | null> =
  createSelector(
    getInitialDeckSetup,
    initialDeckSetup =>
...
export const getTemperatureModuleIds: Selector<string[] | null> =
  createSelector(
    getInitialDeckSetup,
    initialDeckSetup =>
...
export const getMagnetLabwareEngageHeight: Selector<number | null> =
  createSelector(
    getInitialDeckSetup,
