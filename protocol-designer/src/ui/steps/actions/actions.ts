...
export const expandMultipleSteps = (stepIds: Array<StepIdType>): ExpandMultipleStepsAction => ({
  type: 'EXPAND_MULTIPLE_STEPS',
  payload: stepIds
});
export const collapseMultipleSteps = (stepIds: Array<StepIdType>): CollapseMultipleStepsAction => ({
...
export const hoverOnStep = (stepId: StepIdType | null | undefined): HoverOnStepAction => ({
  type: 'HOVER_ON_STEP',
  payload: stepId
});
export const hoverOnTerminalItem = (terminalId: TerminalItemId | null | undefined): HoverOnTerminalItemAction => ({
  type: 'HOVER_ON_TERMINAL_ITEM',
  payload: terminalId
});
export const setWellSelectionLabwareKey = (labwareName: string | null | undefined): SetWellSelectionLabwareKeyAction => ({
...
export const selectStep = (stepId: StepIdType): ThunkAction<any> => (dispatch: ThunkDispatch<any>, getState: GetState) => {
...
export const selectMultipleSteps = (stepIds: Array<StepIdType>, lastSelected: StepIdType): ThunkAction<SelectMultipleStepsAction> => (dispatch: ThunkDispatch<any>, getState: GetState) => {
...
export const selectAllSteps = (): ThunkAction<SelectMultipleStepsAction | AnalyticsEventAction> => (dispatch: ThunkDispatch<SelectMultipleStepsAction | AnalyticsEventAction>, getState: GetState) => {
...
export const EXIT_BATCH_EDIT_MODE_BUTTON_PRESS: "EXIT_BATCH_EDIT_MODE_BUTTON_PRESS" = 'EXIT_BATCH_EDIT_MODE_BUTTON_PRESS';
export const deselectAllSteps = (meta?: typeof EXIT_BATCH_EDIT_MODE_BUTTON_PRESS): ThunkAction<SelectStepAction | AnalyticsEventAction> => (dispatch: ThunkDispatch<SelectStepAction | AnalyticsEventAction>, getState: GetState) => {
  ...
  if (lastSelectedStepId) {
    ...
    console.warn('something went wrong, cannot deselect all steps if not in multi select mode');
  }
