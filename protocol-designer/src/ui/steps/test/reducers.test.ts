...
import { _allReducers, SINGLE_STEP_SELECTION_TYPE, MULTI_STEP_SELECTION_TYPE, TERMINAL_ITEM_SELECTION_TYPE } from "../reducers";
...
describe('selectedItem reducer', () => {
  ...
  describe('multi-step selection', () => {
    ...
    const multiTestCases: {
      ...
      title: 'should enter multi-select mode from single-selected terminal item',
      prev: {
        selectionType: TERMINAL_ITEM_SELECTION_TYPE,
        id: 'someTerminalItem'
      },
