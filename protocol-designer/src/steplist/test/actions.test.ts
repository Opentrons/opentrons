  ...
  describe('deleteMultipleSteps', () => {
    ...
    describe('when not deleting all steps', () => {
      it('should select the remaining steps', () => {
        ...
        when(getOrderedStepIdsMock).calledWith(expect.anything()).mockReturnValue(allSteps);
        ...
        expect(actions).toEqual([deleteMultipleStepsAction, selectMultipleStepsAction]);
      });
    ...
    describe('when deleting all steps', () => {
      it('should delete all of the steps and clear the selected item', () => {
        ...
        const actions = store.getActions();
        expect(actions).toEqual([deleteMultipleStepsAction, clearSelectedItemAction]);
      });
    });
  });
});