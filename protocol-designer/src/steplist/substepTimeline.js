...
type SubstepContext = {
  channels?: Channels,
  getLabwareType?: (labwareId: string) => ?string,
}
      ...
      const timeline = commandCreators.reduce(
        (
          ...
          if (
            ...
            const labwareType =
              context.getLabwareType && context.getLabwareType(labware)
            const wellsForTips =
              context.channels &&
              labwareType &&
              getWellsForTips(context.channels, labwareType, well).wellsForTips
            const wellInfo = {
              labware,
              wells: wellsForTips || [],
