...
import type { ClearSelectedItemAction, SelectMultipleStepsAction } from "../../ui/steps";
export type ChangeSavedStepFormAction = {
  type: "CHANGE_SAVED_STEP_FORM";
  payload: ChangeFormPayload;
};
export const changeSavedStepForm = (payload: ChangeFormPayload): ChangeSavedStepFormAction => ({
  type: 'CHANGE_SAVED_STEP_FORM',
  payload
});
...
export const deleteMultipleSteps = (stepIds: Array<StepIdType>): ThunkAction<DeleteMultipleStepsAction | ClearSelectedItemAction | SelectMultipleStepsAction> => (dispatch, getState) => {
  ...
  if (stepIds.length === orderedStepIds.length) {
    ...
    if (nextStepId) {
      ...
      console.warn('something went wrong, could not find the next non terminal item');
    }
  }
};
...
export const addProfileStep = (payload: $PropertyType<AddProfileStepAction, "payload">): AddProfileStepAction => ({
  type: 'ADD_PROFILE_STEP',
  payload
});
...
export const deleteProfileCycle = (payload: $PropertyType<DeleteProfileCycleAction, "payload">): DeleteProfileCycleAction => ({
  type: 'DELETE_PROFILE_CYCLE',
  payload
});
...
export const deleteProfileStep = (payload: $PropertyType<DeleteProfileStepAction, "payload">): DeleteProfileStepAction => ({
  type: 'DELETE_PROFILE_STEP',
  payload
});
...
export const editProfileCycle = (payload: $PropertyType<EditProfileCycleAction, "payload">): EditProfileCycleAction => ({
  type: 'EDIT_PROFILE_CYCLE',
  payload
});
...
export const editProfileStep = (payload: $PropertyType<EditProfileStepAction, "payload">): EditProfileStepAction => ({
  type: 'EDIT_PROFILE_STEP',
  payload
});
...
export const addProfileCycle = (payload: $PropertyType<AddProfileCycleAction, "payload">): AddProfileCycleAction => ({
  type: 'ADD_PROFILE_CYCLE',
  payload
});