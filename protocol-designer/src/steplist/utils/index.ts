...
export function getWellRatio(sourceWells: unknown, destWells: unknown): WellRatio | null | undefined {
  if (!Array.isArray(sourceWells) || sourceWells.length === 0 || !Array.isArray(destWells) || destWells.length === 0) {
    return null;
  }
...
export const getNextNonTerminalItemId = (orderedStepIds: Array<StepIdType>, stepsToDelete: Array<StepIdType>): StepIdType | null => {
