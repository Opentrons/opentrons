...
export const profileStepValidDuration = (step: ProfileStepItem): ProfileFormError | null => {
...
export const getProfileFormErrors = (hydratedForm: HydratedFormData): Array<ProfileFormError> => {
  if (hydratedForm.stepType !== 'thermocycler' || hydratedForm.thermocyclerFormType !== THERMOCYCLER_PROFILE) {
    return [];
  }
