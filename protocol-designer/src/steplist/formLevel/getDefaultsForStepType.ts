import { DEFAULT_CHANGE_TIP_OPTION, DEFAULT_MM_FROM_BOTTOM_DISPENSE, DEFAULT_WELL_ORDER_FIRST_OPTION, DEFAULT_WELL_ORDER_SECOND_OPTION, DEFAULT_DELAY_SECONDS, FIXED_TRASH_ID } from "../../constants";
import type { StepType, StepFieldName } from "../../form-types";
export function getDefaultsForStepType(stepType: StepType): Record<StepFieldName, any> {
  switch (stepType) {
    case 'mix':
      return {
        times: null,
