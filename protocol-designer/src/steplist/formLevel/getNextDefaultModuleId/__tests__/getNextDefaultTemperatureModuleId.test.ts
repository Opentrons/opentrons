import { MAGNETIC_MODULE_TYPE, TEMPERATURE_MODULE_TYPE, THERMOCYCLER_MODULE_TYPE, MAGNETIC_MODULE_V1, TEMPERATURE_MODULE_V1, THERMOCYCLER_MODULE_V1 } from "@opentrons/shared-data";
  ...
  describe('NO previous forms', () => {
    ...
    testCases.forEach(({
      ...
      it(testMsg, () => {
        ...
        const result = getNextDefaultTemperatureModuleId(savedForms, orderedStepIds, equippedModulesById);
