...
describe('getNextDefaultEngageHeight', () => {
  ...
  describe('with previous forms', () => {
    const testCases = [{
      testMsg: 'returns null when disengage previous selected and no previous engage height entered',
      orderedStepIds: ['d'],
      expected: null
    }, {
      testMsg: 'returns default when disengage previous selected and previous engage height entered',
