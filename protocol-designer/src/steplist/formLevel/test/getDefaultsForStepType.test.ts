import { DEFAULT_CHANGE_TIP_OPTION, DEFAULT_DELAY_SECONDS, DEFAULT_MM_FROM_BOTTOM_DISPENSE, DEFAULT_WELL_ORDER_FIRST_OPTION, DEFAULT_WELL_ORDER_SECOND_OPTION, FIXED_TRASH_ID } from "../../../constants";
