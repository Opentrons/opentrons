...
const getArgsAndErrorsByStepIdMock: JestMockFn<any, any> = getArgsAndErrorsByStepId;
...
describe('reduxActionToAnalyticsEvent', () => {
  it('should return null for unhandled actions', () => {
    expect(reduxActionToAnalyticsEvent(fooState, {
  ...
  it('should convert a SAVE_STEP_FORM action into a saveStep action with additional properties', () => {
    ...
    const action = {
      ...
      payload: {
        id: 'stepId'
        /* .. other fields don't matter, will be read from getArgsAndErrors */
