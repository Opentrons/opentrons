...
const v1ModelTov2LoadNameMap = {
  ...
  'opentrons-aluminum-block-96-PCR-plate': 'opentrons_96_aluminumblock_biorad_wellplate_200ul',
...
export function v1LabwareModelToV2Def(model: string): LabwareDefinition2 {
  ...
  const uri: string | null | undefined = Object.keys(latestDefs).find(defURI => latestDefs[defURI].parameters.loadName === loadName);
