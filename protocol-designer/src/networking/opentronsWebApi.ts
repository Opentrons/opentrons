...
export type GateStage = "loading" | "promptVerifyIdentity" | "promptCheckEmail" | "failedIdentityVerification" | "promptOptForAnalytics" | "openGate";
type GateState = {
  gateStage: GateStage;
  errorMessage: string | null | undefined;
};
export const getIsProduction = (): boolean => global.location.host === 'designer.opentrons.com';
const OPENTRONS_API_BASE_URL = getIsProduction() ? 'https://web-api.opentrons.com' : 'https://staging.web-api.opentrons.com';
const PROTOCOL_DESIGNER_VERIFY_URL = getIsProduction() ? global.location.origin : 'https://staging.designer.opentrons.com';
...
export const writeFakeIdentityCookie = (): void => writeIdentityCookie({
  name: '_skipped_signup',
  email: 'nobody@email.com'
});

const getStageFromIdentityCookie = (token: string | null | undefined, hasOptedIntoAnalytics: boolean | null) => {
