...
import { MAGNETIC_MODULE_TYPE, TEMPERATURE_MODULE_TYPE, THERMOCYCLER_MODULE_TYPE, THERMOCYCLER, MAGNETIC_MODULE_V1, MAGNETIC_MODULE_V2, TEMPERATURE_MODULE_V1, TEMPERATURE_MODULE_V2, THERMOCYCLER_MODULE_V1 } from "@opentrons/shared-data";
import { i18n } from "./localization";
import type { LabwareDefinition2, DeckSlot as DeckDefSlot, ModuleRealType, ModuleModel } from "@opentrons/shared-data";
import type { DeckSlot, WellVolumes } from "./types";
export const getMaxVolumes = (def: LabwareDefinition2): WellVolumes => mapValues(def.wells, well => well.totalLiquidVolume);
...
export const MODELS_FOR_MODULE_TYPE: Record<ModuleRealType, Array<{
  name: string;
  value: string;
  disabled?: boolean;
}>> = {
...
export const DEFAULT_MODEL_FOR_MODULE_TYPE: Record<ModuleRealType, ModuleModel> = {
