...
export function CrashInfoBox(props: Props): React.ReactNode {
  const moduleMessage = getCrashableModulesCopy(props) || '';
  return <div className={styles.crash_info_container}>
      ...
      {props.showDiagram && <img className={styles.crash_info_diagram} src={getCrashDiagramSrc(props)} />}
    </div>;
}
