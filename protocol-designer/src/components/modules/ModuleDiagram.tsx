...
import { MAGNETIC_MODULE_TYPE, TEMPERATURE_MODULE_TYPE, THERMOCYCLER_MODULE_TYPE, MAGNETIC_MODULE_V1, MAGNETIC_MODULE_V2, TEMPERATURE_MODULE_V1, TEMPERATURE_MODULE_V2, THERMOCYCLER_MODULE_V1 } from "@opentrons/shared-data";
type Props = {
  type: ModuleRealType;
  model: ModuleModel;
};
type ModuleImg = Record<ModuleRealType, Record<ModuleModel, string>>;
...
export function ModuleDiagram(props: Props): React.ReactNode {
