...
const EditAdapterComponent = (props: Props): JSX.Element => {
  const {
    labwareOnDeck,
    isYetUnnamed,
    editLiquids,
  ...
  if (swapBlocked) {
    ...
    contents = (
      ...
      <EditLabware
        labwareOnDeck={labwareOnDeck}
        setHoveredLabware={props.setHoveredLabware}
        setDraggedLabware={props.setDraggedLabware}
...
const DragEditAdapter = DragSource(
  DND_TYPES.LABWARE,
  labwareSource,
...
const DragDropEditAdapter = DropTarget(
  DND_TYPES.LABWARE,
  labwareDropTarget,
...
export const EditAdapter = connect(
  mapStateToProps,
  mapDispatchToProps
)(DragDropEditAdapter)
