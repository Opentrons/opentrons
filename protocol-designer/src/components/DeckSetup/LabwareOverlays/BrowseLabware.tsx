...
function BrowseLabwareOverlay(props: Props) {
  ...
  return <div className={cx(styles.slot_overlay, styles.appear_on_mouseover)}>
...
export const BrowseLabware: React.AbstractComponent<OP> = connect<Props, OP, _, DP, _, _>(null, mapDispatchToProps)(BrowseLabwareOverlay);