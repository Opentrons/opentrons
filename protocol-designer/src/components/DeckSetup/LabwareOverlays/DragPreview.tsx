...
type DragPreviewProps = {
  ...
  itemType: string;
  getRobotCoordsFromDOMCoords: $PropertyType<RobotWorkSpaceRenderProps, "getRobotCoordsFromDOMCoords">;
};
...
const LabwareDragPreview = (props: DragPreviewProps) => {
  ...
  return <LabwareOnDeck className={styles.labware_drag_preview} x={cursor.x} y={cursor.y - item.labwareOnDeck.def.dimensions.yDimension} labwareOnDeck={item.labwareOnDeck} />;
};

export const DragPreview: React.AbstractComponent<$Diff<DragPreviewProps, {
