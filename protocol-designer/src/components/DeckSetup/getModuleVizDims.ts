...
import { STD_SLOT_X_DIM as SLOT_X, STD_SLOT_Y_DIM as SLOT_Y, STD_SLOT_DIVIDER_WIDTH as DIVIDER, SPAN7_8_10_11_SLOT } from "../../constants";
...
export const getModuleVizDims = (orientation: ModuleOrientation, moduleType: ModuleRealType): ModuleVizDims => {
...
const LEFT_SIDE_SLOTS: Array<DeckSlot> = ['1', '4', '7', '10', SPAN7_8_10_11_SLOT];
export const inferModuleOrientationFromSlot = (slot: DeckSlot): ModuleOrientation => {
