...
import { MAGNETIC_MODULE_TYPE, TEMPERATURE_MODULE_TYPE, MAGNETIC_MODULE_V1, TEMPERATURE_MODULE_V1 } from "@opentrons/shared-data";
...
describe('DeckSetup', () => {
  describe('getSwapBlocked', () => {
    ...
    beforeEach(() => {
      getLabwareIsCompatibleSpy = jest.spyOn(labwareModuleCompatibility, 'getLabwareIsCompatible');
    });
    afterEach(() => {
