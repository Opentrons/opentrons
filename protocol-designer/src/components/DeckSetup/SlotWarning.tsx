...
const OVERHANG = 60;
export const SlotWarning = (props: Props): React.ReactNode => {
  const {
    x,
    y,
    xDimension,
  ...
  return <g>
      <rect x={x + rectXOffset} y={y} width={xDimension + OVERHANG} height={yDimension} className={styles.slot_warning} />
      <RobotCoordsForeignDiv x={x + textXOffset} y={y} className={styles.warning_text} width={OVERHANG} height={yDimension}>
