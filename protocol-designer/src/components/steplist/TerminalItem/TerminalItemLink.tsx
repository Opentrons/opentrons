...
class TerminalItemLinkComponent extends React.Component<Props> {
  ...
  render() {
    return <a className={styles.nav_link} onClick={this.handleClick}>
...
export const TerminalItemLink: React.AbstractComponent<OP> = connect<Props, OP, {}, DP, _, _>(null, mapDTP)(TerminalItemLinkComponent);