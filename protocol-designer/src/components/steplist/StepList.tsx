...
type Props = {
  ...
  reorderSteps: (arg0: Array<StepIdType>) => unknown;
};
  ...
  render(): React.ReactNode {
    return <React.Fragment>
        <SidePanel title="Protocol Timeline">
          <MultiSelectToolbar isMultiSelectMode={Boolean(this.props.isMultiSelectMode)} />

          <StartingDeckStateTerminalItem />
          <DraggableStepItems orderedStepIds={this.props.orderedStepIds.slice()} reorderSteps={this.props.reorderSteps} />
          <PresavedStepItem />
          <StepCreationButton />
