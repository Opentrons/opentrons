...
import { getHoveredTerminalItemId, getSelectedTerminalItemId, actions as stepsActions } from "../../ui/steps";
export const PresavedStepItem = (): React.ReactNode => {
  ...
  const toggleStepCollapsed = () => dispatch(stepsActions.toggleStepCollapsed(PRESAVED_STEP_ID));

  const highlightStep = () => dispatch(stepsActions.hoverOnTerminalItem(PRESAVED_STEP_ID));
