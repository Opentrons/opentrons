...
import type { DisabledFields, MultiselectFieldValues } from "../../ui/steps/selectors";
import { getFieldDefaultTooltip, getFieldIndeterminateTooltip } from "../StepEditForm/utils";
import type { FieldPropsByName } from "../StepEditForm/types";
import type { StepFieldName } from "../../form-types";
export const makeBatchEditFieldProps = (fieldValues: MultiselectFieldValues, disabledFields: DisabledFields, handleChangeFormInput: (name: string, value: unknown) => void): FieldPropsByName => {
