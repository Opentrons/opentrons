...
import { getBatchEditSelectedStepTypes, getMultiSelectDisabledFields, getMultiSelectFieldValues, getMultiSelectItemIds } from "../../ui/steps/selectors";
import { getBatchEditFormHasUnsavedChanges } from "../../step-forms/selectors";
import { changeBatchEditField, resetBatchEditFieldChanges, saveStepFormsMulti } from "../../step-forms/actions";
...
export const BatchEditForm = (props: BatchEditFormProps): React.ReactNode => {
  ...
  if (stepType !== null && fieldValues !== null && disabledFields !== null) {
    ...
    const propsForFields = makeBatchEditFieldProps(fieldValues, disabledFields, handleChangeFormInput);
