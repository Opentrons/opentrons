...
export const SourceDestHeaders = (props: Props): React.ReactNode => {
  const {
    className,
    collapsed,
    toggleCollapsed,
  ...
  return <AspDispSection {...{
    ...
    prefix
      ...
      <div className={styles.form_row}>
        ...
        <WellSelectionField {...propsForFields[addFieldNamePrefix('wells')]} labwareId={formData[addFieldNamePrefix('labware')]} pipetteId={formData['pipette']} />
      </div>
    </AspDispSection>;
};