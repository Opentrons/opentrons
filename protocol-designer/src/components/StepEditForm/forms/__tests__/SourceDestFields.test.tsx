  ...
  describe('Aspirate section', () => {
    ...
    it('should render a well order field', () => {
      ...
      expect(wellOrderField.props()).toMatchObject({
        ...
        firstValue: 'r2l',
        secondValue: 'b2t',
        updateFirstWellOrder: props.propsForFields['aspirate_wellOrder_first'].updateValue,
        updateSecondWellOrder: props.propsForFields['aspirate_wellOrder_second'].updateValue
      });
    });
  });
  describe('Dispense section', () => {
    ...
    it('should render a well order field', () => {
      ...
      expect(wellOrderField.props()).toMatchObject({
        ...
        firstValue: 'l2r',
        secondValue: 't2b',
        updateFirstWellOrder: props.propsForFields['dispense_wellOrder_first'].updateValue,
        updateSecondWellOrder: props.propsForFields['dispense_wellOrder_second'].updateValue
      });
    });
  });
});