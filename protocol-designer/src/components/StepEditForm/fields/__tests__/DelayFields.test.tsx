...
import type { DelayFieldProps } from "../DelayFields";
import { DelayFields } from "../DelayFields";
import type { BaseState } from "../../../../types";
import type { FormData } from "../../../../form-types";
jest.mock('../../../../step-forms/selectors');
const getUnsavedFormMock: JestMockFn<[BaseState], FormData | null | undefined> = stepFormSelectors.getUnsavedForm;
const getLabwareEntitiesMock: JestMockFn<[BaseState], any> = stepFormSelectors.getLabwareEntities;
const mockStore = {
  dispatch: jest.fn(),
  subscribe: jest.fn(),
  getState: () => ({})
...
describe('DelayFields', () => {
  const render = (_props: DelayFieldProps) => mount(<DelayFields {..._props} />, {
  ...
  describe('Aspirate Delay', () => {
    ...
    it('should render an aspirate delay field with a tip position field', () => {
      ...
      expect(checkboxField.prop('tooltipContent')).toBe(`tooltip for ${props.checkboxFieldName}`);
