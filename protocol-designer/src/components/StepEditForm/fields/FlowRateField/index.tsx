...
function mapStateToProps(state: BaseState, ownProps: OP): SP {
  ...
  const pipette = pipetteId != null ? stepFormSelectors.getPipetteEntities(state)[pipetteId] : null;
...
export const FlowRateField: React.AbstractComponent<OP> = connect<Props, OP, SP, {}, _, _>(mapStateToProps, null, mergeProps)(FlowRateInputWithKey);