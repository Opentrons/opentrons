...
type Props = JSX.LibraryManagedAttributes<typeof WellSelectionInput, React.ComponentProps<typeof WellSelectionInput>>;
type OP = FieldProps & {
...
const mapStateToProps = (state: BaseState, ownProps: OP): SP => {
  ...
  return {
    primaryWellCount: Array.isArray(selectedWells) ? selectedWells.length : undefined,
    isMulti
  };
};
...
export const WellSelectionField: React.AbstractComponent<OP> = connect<Props, OP, SP, {}, _, _>(mapStateToProps, null, mergeProps)(WellSelectionInput);