...
export const TipPositionZAxisViz = (props: Props): React.ReactNode => {
  ...
  const bottomPx = props.wellDepthMm ? roundedPixelsFromBottom : props.mmFromBottom - WELL_HEIGHT_PIXELS;
  return <div className={styles.viz_wrapper}>
      <img src={PIPETTE_TIP_IMAGE} className={styles.pipette_tip_image} style={{
      bottom: `${bottomPx}px`
    }} />
      {props.wellDepthMm !== null && <span className={styles.well_height_label}>{props.wellDepthMm}mm</span>}
