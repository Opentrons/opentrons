...
import { DEFAULT_MM_FROM_BOTTOM_ASPIRATE, DEFAULT_MM_FROM_BOTTOM_DISPENSE, DEFAULT_MM_TOUCH_TIP_OFFSET_FROM_TOP } from "../../../../constants";
...
export function getDefaultMmFromBottom(args: {
  ...
  switch (name) {
    ...
    default:
      // touch tip fields
      assert(getIsTouchTipField(name), `getDefaultMmFromBottom fn does not know what to do with field ${name}`);
