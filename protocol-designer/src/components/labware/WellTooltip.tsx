...
type WellTooltipParams = {
  ...
  handleMouseLeaveWell: (arg0: unknown) => void;
  tooltipWellName: string | null | undefined;
};
type Props = {
  children: (arg0: WellTooltipParams) => React.ReactNode;
...
export class WellTooltip extends React.Component<Props, State> {
  ...
  makeHandleMouseEnterWell: (wellName: string, wellIngreds: LocationLiquidState) => (e: React.MouseEvent) => void = (wellName, wellIngreds) => e => {
    const {
      target
    } = e;
        ...
        <Manager>
          <Reference>
            ...
            ref
                ...
                <div ref={ref} className={styles.virtual_reference} style={{
              top: tooltipY,
              left: tooltipX
            }} />
              </Portal>}
          ...
          {this.state.tooltipWellName && <Popper modifiers={{
          offset: {
            ...
            return <Portal>
                    <div style={style} ref={ref} data-placement={placement} className={styles.tooltip_box}>
                      <PillTooltipContents well={this.state.tooltipWellName || ''} ingredNames={this.props.ingredNames} ingreds={this.state.tooltipWellIngreds || {}} />
