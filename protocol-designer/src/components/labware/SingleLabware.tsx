...
export function SingleLabware(props: Props): React.ReactNode {
  return <RobotWorkSpace viewBox={`0 0 ${props.definition.dimensions.xDimension} ${props.definition.dimensions.yDimension}`}>
      {() => <LabwareRender {...props} />}
    </RobotWorkSpace>;
}