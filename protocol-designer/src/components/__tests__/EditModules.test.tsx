...
const getInitialDeckSetupMock: JestMockFn<any, any> = stepFormSelectors.getInitialDeckSetup;
const getDismissedHintsMock: JestMockFn<any, any> = tutorialSelectors.getDismissedHints;
describe('Edit Modules', () => {
  ...
  const render = props => mount(<EditModules {...props} />, {
