        ...
        <Card title={i18n.t('card.title.information')}>
          <div className={styles.card_content}>
            <div className={styles.setting_row}>
              <LabeledValue className={styles.labeled_value} label={i18n.t('application.version')} value={process.env.OT_PD_VERSION || OLDEST_MIGRATEABLE_VERSION} />
              {
        ...
        <Card title={i18n.t('card.title.privacy')}>
          <div className={styles.card_content}>
            <div className={styles.setting_row}>
              ...
              <ToggleButton className={styles.toggle_button} toggledOn={Boolean(hasOptedIn)} onClick={toggleOptedIn} />
            </div>
...
function mergeProps(stateProps: SP, dispatchProps: {
  ...
  const _toggleOptedIn = hasOptedIn ? analyticsActions.optOut : analyticsActions.optIn;
...
export const SettingsApp: React.AbstractComponent<{}> = connect<Props, {}, SP, {}, BaseState, _>(mapStateToProps, null, mergeProps)(SettingsAppComponent);