...
function mapStateToProps(state: BaseState): SP {
  ...
  const errors = (timeline.errors || [] as Array<CommandCreatorError>).map(error => ({
  ...
  const warnings = timelineWarningSelectors.getTimelineWarningsForSelectedStep(state).map(warning => ({
...
export const TimelineAlerts: React.AbstractComponent<{}> = connect<Props, {}, SP, {}, _, _>(mapStateToProps, null, mergeProps)(Alerts);