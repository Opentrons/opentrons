...
export const PDAlert = (props: PDAlertProps): React.ReactNode => {
  const {
    alertType,
    title,
    description,
  ...
  return <AlertItem type={alertType} title={<div className={styles.alert_inner_wrapper}>
          ...
          {onDismiss != null && <OutlineButton className={styles.dismiss_button} onClick={onDismiss}>
