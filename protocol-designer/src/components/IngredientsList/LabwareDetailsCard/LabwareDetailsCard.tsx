...
export function LabwareDetailsCard(props: Props): React.ReactNode {
  return <PDTitledList title="labware details" iconName="flask-outline">
      <PDListItem>
      ...
      <PDListItem border>
        <div className={styles.row}>
          ...
          <EditableTextField value={props.nickname} saveEdit={props.renameLabware} />
        </div>
      </PDListItem>
    </PDTitledList>;
}