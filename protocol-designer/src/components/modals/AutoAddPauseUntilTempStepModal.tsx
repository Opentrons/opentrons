...
export const AutoAddPauseUntilTempStepModal = (props: Props): React.ReactNode => <AlertModal alertOverlay className={modalStyles.modal} contentsClassName={modalStyles.modal_contents}>
    ...
    <div className={modalStyles.button_row}>
      <OutlineButton className={styles.later_button} onClick={props.handleCancelClick}>
        {i18n.t('modal.auto_add_pause_until_temp_step.later_button')}
      </OutlineButton>
      <PrimaryButton className={styles.now_button} onClick={props.handleContinueClick}>
