...
const SIGNUP_TYPEFORM_URL = getIsProduction() ? PROD_TYPEFORM_URL : STAGING_TYPEFORM_URL;
export class SignUpForm extends React.Component<{}> {
  ...
  render(): React.ReactNode {
    return <div ref={this.embedElement} className={styles.sign_up_form_wrapper} />;
  }
