...
export const FileUploadMessageModal: React.AbstractComponent<{}> = connect<Props, {}, SP, DP, _, _>(mapStateToProps, mapDispatchToProps)(FileUploadMessageModalComponent);