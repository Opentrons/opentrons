...
const invalidJsonModal = (errorMessage: string | null | undefined): ModalContents => ({
...
export const noBehaviorChangeMessage: ModalContents = {
  title: 'Your protocol was made in an older version of Protocol Designer',
  body: <div className={styles.migration_message}>
...
export function getMigrationMessage(migrationsRan: Array<string>): ModalContents {
...
export function getModalContents(uploadResponse: FileUploadMessage): ModalContents {
    ...
    default:
      {
        ...
        return {
          title: '',
          body: uploadResponse.messageKey
        };
      }
  }
}