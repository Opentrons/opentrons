...
export const announcements: Array<Announcement> = [{
  ...
  image: <div className={styles.modules_diagrams_row}>
        <img className={styles.modules_diagram} src={require('../../../images/modules/magdeck_tempdeck_combined.png')} />
      </div>,
  ...
  image: <div className={styles.thermocycler_diagram_row}>
        <img className={styles.modules_diagram} src={require('../../../images/modules/thermocycler.jpg')} />
      </div>,
  heading: "We've updated the Protocol Designer",
  message: <>
  ...
  image: <Flex css={batchEditStyles}>
