...
describe('AnnouncementModal', () => {
  ...
  const getLocalStorageItemMock: JestMockFn<[string], unknown> = persist.getLocalStorageItem;
  ...
  it('button click saves announcement announcementKey to localStorage and closes modal', () => {
    ...
    expect(persist.setLocalStorageItem).toHaveBeenCalledWith(persist.localStorageAnnouncementKey, newAnnouncementKey);
    expect(wrapper.find(Modal)).toHaveLength(0);
  });
});