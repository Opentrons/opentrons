...
metadata = {
    "protocolName": "P50MTransferMulti",
    "created": "2025-05-28T21:27:06.797Z",
    "lastModified": "2025-06-24T20:55:19.925Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    # Load Pipettes:
    pipette_left = protocol.load_instrument("flex_8channel_50", "left", tip_racks=[tip_rack_1])
