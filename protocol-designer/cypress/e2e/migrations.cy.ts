...
describe('Protocol fixtures migrate and match snapshots', () => {
  ...
  const testCases: MigrateTestCase[] = [
    {
      title: 'example_1_1_0 (schema 1, PD version 1.1.1) -> PD 8.4.x, schema 8',
    ...
    {
      title: 'doItAllV3 (schema 3, PD version 4.0.0) -> PD 8.4.x, schema 8',
    ...
    {
      title: 'doItAllV4 (schema 4, PD version 4.0.0) -> PD 8.4.x, schema 8',
    ...
    {
      title:
        'doItAllv7MigratedToV8 (schema 7, PD version 8.0.0) -> should migrate to 8.4.x, schema 8',
    ...
    {
      title:
        '96-channel full and column schema 8 -> should migrate to 8.4.x, schema 8',
    ...
    {
      title:
        'doItAllV8 flex robot -> reimported, should migrate to 8.4.x, schema 8',
    ...
    {
      title:
        'new advanced settings with multi temp => reimported, should not migrate and stay at 8.4.x, schema 8',
    ...
    {
      title:
        'thermocycler on Ot2 (schema 7, PD version 7.0.0) -> should migrate to 8.4.x, schema 8',
