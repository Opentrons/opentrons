...
export enum TestFilePath {
  ...
  P50MultiImportTransferLiquid = 'fixtures/protocol/8/P50MTransferMulti.json',
  P10000SingleTransferLiquid = 'fixtures/protocol/8/P1000STransferSingle.json',
  P1000MultiTransferLiquid = 'fixtures/protocol/8/P1000MTransferMulti.json',
