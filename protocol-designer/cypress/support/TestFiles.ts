...
export enum TestFilePath {
  ...
  P50_Single_Import_T_Liquid = 'fixtures/protocol/8/P50_Single_Import_T_Liquid.py',
  P1000MTransferMulti = 'fixtures/protocol/8/P1000MTransferMulti.py',
  P1000STransferSingle = 'fixtures/protocol/8/P1000STransferSingle.py',
  P50MTransferMulti = 'fixtures/protocol/8/P50MTransferMulti.py',
  GEN2P20MultiOT2 = 'fixtures/protocol/8/GEN2P20MultiOT2.py',
  GEN2P20SingleOT2 = 'fixtures/protocol/8/GEN2P20SingleOT2.py',
  GEN2P300MultiOT2 = 'fixtures/protocol/8/GEN2P300MultiOT2.py',
  GEN2P300SingleOT2 = 'fixtures/protocol/8/GEN2P300SingleOT2.py',
  GEN2P1000SingleOT2 = 'fixtures/protocol/8/GEN2P1000SingleOT2.py',
  // cypress fixtures
