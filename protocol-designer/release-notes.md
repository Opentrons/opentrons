...
This hotfix release addresses issues when uploading protocols containing custom labware and viewing the step details of consolidate steps with irregular labware.
