...
- Protocol Designer allows more safe nozzle and well selections without including excess collision errors:
...
- Select the source or destination for a final blowout with the default well position.
