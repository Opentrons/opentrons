...
- When you zoom into a slot that has an older version of a labware definition, it no longer whitescreens.

### Improved Features

- Increased responsiveness and alignment with deck setup
