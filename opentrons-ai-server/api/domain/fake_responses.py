...
reagent_transfer: ChatResponse = ChatResponse(
    ...
    fake=True,
    protocol_content="PDJSON is here",
)
...
no_markdown: ChatResponse = ChatResponse(
    reply="👀 at me I am a response without markdown! 😊 99.99µl", fake=True, protocol_content="PDJSON is here"
)

empty_reply: ChatResponse = ChatResponse(reply="", fake=True, protocol_content="PDJSON is here")
