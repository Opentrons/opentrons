...
_property_ fixed_trash*: [Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.labware.Labware') \| [TrashBin](index.html#opentrons.protocol_api.TrashBin 'opentrons.protocol_api.disposal_locations.TrashBin')*
...
_class_ opentrons.protocol*api.InstrumentContext(\_core: AbstractInstrument\[AbstractWellCore]*, _protocol_core: AbstractProtocol\[AbstractInstrument\[AbstractWellCore], AbstractLabware\[AbstractWellCore], AbstractModuleCore]_, _broker: LegacyBroker_, _api_version: APIVersion_, _tip_racks: [List](https://docs.python.org/3/library/typing.html#typing.List '(in Python v3.12)')\[[Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.labware.Labware')]_, _trash: [Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.labware.Labware') \| [TrashBin](index.html#opentrons.protocol_api.TrashBin 'opentrons.protocol_api.disposal_locations.TrashBin') \| [WasteChute](index.html#opentrons.protocol_api.WasteChute 'opentrons.protocol_api.disposal_locations.WasteChute') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')_, _requested_as: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)')_)
...
_property_ starting_tip*: [Well](index.html#opentrons.protocol_api.Well 'opentrons.protocol_api.labware.Well') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ trash_container*: [Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.labware.Labware') \| [TrashBin](index.html#opentrons.protocol_api.TrashBin 'opentrons.protocol_api.disposal_locations.TrashBin') \| [WasteChute](index.html#opentrons.protocol_api.WasteChute 'opentrons.protocol_api.disposal_locations.WasteChute')*
...
_property_ child*: [Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.labware.Labware') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ magdeck_engage_height*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ parent*: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.Labware') \| ModuleTypes \| OffDeckType*
...
_property_ diameter*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ length*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ width*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
The width, in mm, of a rectangular well along the y\-axis (front to back).
Returns `None` if the well is not rectangular.

Added in version 2\.9\.

_class_ opentrons.protocol*api.Liquid(*\_id: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)')_, \_name: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)')_, _description: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')_, _display_color: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')_)
...
_property_ labware*: [Labware](index.html#opentrons.protocol_api.Labware 'opentrons.protocol_api.labware.Labware') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
Added in version 2\.1: The _label,_ _namespace,_ and _version_ parameters.
...
_property_ target_speed*: [int](https://docs.python.org/3/library/functions.html#int '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
Target speed of the Heater\-Shaker’s plate in rpm.

Added in version 2\.13\.

_property_ target_temperature*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ target*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ block_target_temperature*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
The target temperature of the well block in °C.

Added in version 2\.0\.

_property_ block_temperature*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ lid_position*: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
...
_property_ lid_target_temperature*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
The target temperature of the lid in °C.

Added in version 2\.0\.

_property_ lid_temperature*: [float](https://docs.python.org/3/library/functions.html#float '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
The current temperature of the lid in °C.

Added in version 2\.0\.

_property_ lid_temperature_status*: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')*
One of five possible temperature statuses:
...
opentrons.execute.get*protocol_api(\_version: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| opentrons.protocols.api_support.types.APIVersion*, _bundled_labware: Optional\[Dict\[str, ForwardRef('LabwareDefinitionDict')]] \= None_, _bundled_data: Dict\[[str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)'), [bytes](https://docs.python.org/3/library/stdtypes.html#bytes '(in Python v3.12)')] \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)') \= None_, _extra_labware: Optional\[Dict\[str, ForwardRef('LabwareDefinitionDict')]] \= None_) → [opentrons.protocol_api.protocol_context.ProtocolContext](index.html#opentrons.protocol_api.ProtocolContext 'opentrons.protocol_api.protocol_context.ProtocolContext')
...
opentrons.simulate.simulate(_protocol_file: BinaryIO \| TextIO_, _file_name: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)') \= None_, _custom_labware_paths: List\[[str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)')] \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)') \= None_, _custom_data_paths: List\[[str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)')] \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)') \= None_, _propagate_logs: [bool](https://docs.python.org/3/library/functions.html#bool '(in Python v3.12)') \= False_, _hardware_simulator_file_path: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)') \= None_, _duration_estimator: opentrons.protocols.duration.estimator.DurationEstimator \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)') \= None_, _log_level: [str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)') \= 'warning'_) → Tuple\[List\[Mapping\[[str](https://docs.python.org/3/library/stdtypes.html#str '(in Python v3.12)'), Any]], opentrons.protocols.types.BundleContents \| [None](https://docs.python.org/3/library/constants.html#None '(in Python v3.12)')]
