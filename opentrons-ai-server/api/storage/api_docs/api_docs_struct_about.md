# Curated API doc descriptions

Source of truth for `<about>` text keyed by synced markdown path under `docs/v2/`.
Regenerated into `api_docs_struct.md` by `make sync-api-docs`.

Each entry is a `###` heading with the markdown path, followed by an `<about>` block.
...
### advanced-control/command-line.md
...
### advanced-control/robot-motors.md
...
### building-block-commands/index.md
...
### building-block-commands/liquids.md
...
### building-block-commands/pipette-tips.md
...
### building-block-commands/utilities.md
...
### complex-commands/order-operations.md
...
### complex-commands/sources-destinations.md
...
### modules/absorbance-plate-reader.md
...
### reference/absorbance-plate-reader.md
...
### reference/flex-stacker.md

<about>
Flex Stacker Module API reference.
</about>

### reference/heater-shaker.md
...
### reference/magnetic-block.md

<about>
Magnetic Block API reference for Flex protocols.
</about>

### reference/magnetic-module.md
...
### reference/temperature-module.md

<about>
Temperature Module API reference.
</about>

### reference/thermocycler.md
...
### runtime-parameters/choosing.md
...
### runtime-parameters/use-case-cherrypicking.md
...
### runtime-parameters/use-case-dry-run.md
...
### runtime-parameters/use-case-sample-count.md
...
### runtime-parameters/using-values.md
