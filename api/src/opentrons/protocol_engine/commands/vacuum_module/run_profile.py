...
class RunProfileImpl(
    AbstractCommandImpl[
        RunProfileParams, SuccessData[RunProfileResult]
    ]
):
    ...
    async def execute(
        ...
        return SuccessData(
            public=RunProfileResult(), state_update=state_update
        )


class RunProfile(
    BaseCommand[RunProfileParams, RunProfileResult, ErrorOccurrence]
):
