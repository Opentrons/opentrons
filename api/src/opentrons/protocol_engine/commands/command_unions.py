...
CommandParams = Union[
    ...
    thermocycler.StartSetTargetBlockTemperatureParams,
    thermocycler.WaitForBlockTemperatureParams,
    thermocycler.SetTargetLidTemperatureParams,
    thermocycler.StartSetTargetLidTemperatureParams,
...
CommandType = Union[
    ...
    thermocycler.StartSetTargetBlockTemperatureCommandType,
    thermocycler.WaitForBlockTemperatureCommandType,
    thermocycler.SetTargetLidTemperatureCommandType,
    thermocycler.StartSetTargetLidTemperatureCommandType,
...
CommandCreate = Annotated[
    Union[
        ...
        thermocycler.StartSetTargetBlockTemperatureCreate,
        thermocycler.WaitForBlockTemperatureCreate,
        thermocycler.SetTargetLidTemperatureCreate,
        thermocycler.StartSetTargetLidTemperatureCreate,
...
CommandResult = Union[
    ...
    thermocycler.StartSetTargetBlockTemperatureResult,
    thermocycler.WaitForBlockTemperatureResult,
    thermocycler.SetTargetLidTemperatureResult,
    thermocycler.StartSetTargetLidTemperatureResult,
