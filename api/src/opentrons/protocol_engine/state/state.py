...
class StateStore(StateView, ActionHandler):
    ...
    def __init__(
        ...
        *,
        ...
        notify_robot_server: Optional[Callable] = None,
    ) -> None:
        ...
        Arguments:
            ...
            notify_robot_server: Notifies the robot server of internal state change.
        """
        ...
        self._notify_robot_server = notify_robot_server
