...
import enum
from numpy import array, dot, double as npdouble, roots, iscomplex, pi
...
class GeometryView:
    ...
    def _volume_from_height(
        ...
        if shape == "rectangular":
            ...
            volume_polynomial_form = GeometryView._rectangular_frustum_polynomial_roots(
            ...
            volume_polynomial_form = GeometryView._circular_frustum_polynomial_roots(
