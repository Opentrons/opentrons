...
class InstrumentCore(AbstractInstrument[WellCore, LabwareCore]):
    ...
    def load_liquid_class(
        ...
        """
        log.warn(f"Ryan setting aspirate {transfer_properties.aspirate}")
        log.warn(
            f"Ryan setting aspirate {transfer_properties.aspirate.as_shared_data_model()}"
        )
    ...
    def aspirate_liquid_class(
        ...
        log.warn(f"Ryan: end position{aspirate_props.aspirate_end_position}")
