...
from typing import NamedTuple, Optional, cast, Tuple, Union, List, Callable, Dict, TypeVar
...
def subsystem_to_mount(subsystem: OT3SubSystem) -> OT3Mount:
    mount_lookup = {subsystem: mount for mount, subsystem in _subsystem_mount_lookup.items()}
