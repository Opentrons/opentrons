...
class OT3Controller:
    ...
    def get_instrument_updates(self, attached_pipettes: Dict[OT3Mount, PipetteSubType]) -> Dict[OT3Mount, int]:
        ...
        for node_id in firmware_updates:
            ...
            if node_id not in [NodeId.pipette_left, NodeId.pipette_right, NodeId.gripper]:
                continue
    ...
    async def update_firmware(
        ...
        async for node_id, status_element in updater.run_updates():
            progress = self._update_tracker.update(
