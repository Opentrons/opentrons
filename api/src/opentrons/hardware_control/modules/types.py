...
class ModuleDisconnectedCallbackFn(Protocol):
...
ModuleDisconnectedCallback = ModuleDisconnectedCallbackFn | None


class ModuleErrorCallbackFn(Protocol):
...
ModuleErrorCallback = Optional[ModuleErrorCallbackFn]
