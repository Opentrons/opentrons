...
- When you upload a protocol to an OT-2 that already has a lot of big protocols stored, the OT-2 is now less likely to show connection errors.
- When you upload a Protocol Designer protocol that has many steps, the OT-2 is now less likely to show connection errors.
