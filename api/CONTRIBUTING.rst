.. _readme: https://github.com/Opentrons/opentrons/blob/edge/api/README.rst

.. _contributing: https://github.com/Opentrons/opentrons/blob/edge/CONTRIBUTING.md

.. _documentation: https://docs.opentrons.com
...
This page is about how to get set up to work on the API itself. For information on how to use the API to simulate protocols or run protocols on an OT2, see the `readme`_ or the `documentation`_.

Setting Up For Development
-----------------------------

See the top-level `contributing guide`_. The API server is written in Python 3.6.
