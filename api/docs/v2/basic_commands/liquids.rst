...
This example draws 100 µL from the current well and mixes it three times, with an ``aspirate_flow_rate`` of 50 µL/sec and a 5 second delay after each aspirate::
