...
.. tabs::
    ...
    .. tab:: 1-ch. 1000 µL
        ...
        +==============================+=====================+=================================+=================================+
        |        Submerge speed        |      50 mm/sec      |             100 mm/sec          |            100 mm/sec           |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        ...
        |     Correction by volume     |          --         |                 --              |                --               |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |    Delay after aspirating    |       1.0 sec       |              0.75 sec           |             0.5 sec             |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
    ...
    .. tab:: 8-ch. 1000 µL
        ...
        |    Delay after retracting    |          --         |                 --              |               --                |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |       Air gap by volume      | - 1--49 µL: 0.1 µL  |       - 1--195 µL: 5 µL         |      - 10--990 µL: 10 µL        | 
        |                              | - 50 µL: 0 µL       |       - 200 µL: 0 µL            |      - 1000 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 200 µL
        ...
        +------------------------------+---------------------+---------------------------------+
        |           Behavior           |        50 µL        |               200 µL            |
        +==============================+=====================+=================================+
        |        Submerge speed        |      35 mm/sec      |             35 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        |      Aspirate flow rate      |     6.5 µL/sec      |             80 µL/sec           |
        +------------------------------+---------------------+---------------------------------+
        |     Correction by volume     |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after aspirating    |       0.5 sec       |              0.75 sec           |
        +------------------------------+---------------------+---------------------------------+
        |         Retract speed        |      35 mm/sec      |             35 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after retracting    |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        |       Air gap by volume      |  - 1--49 µL: 0.1 µL |       - 1 µL: 2 µL              | 
        |                              |  - 50 µL: 0 µL      |       - 50 µL: 3.5 µL           |
        |                              |                     |       - 198 µL: 2 µL            |
        |                              |                     |       - 200 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 1000 µL
        ...
        |    Delay after retracting    |          --         |                 --              |               --                |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |       Air gap by volume      |  - 1--49 µL: 1 µL   |       - 1--195 µL: 5 µL         |      - 10--990 µL: 10 µL        | 
        |                              |  - 50 µL: 0 µL      |       - 200 µL: 0 µL            |      - 1000 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 1-ch. 1000 µL
        ...
        |    Delay after retracting    |          --         |                 --              |               --                |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |       Push out by volume     |        5 µL         |               15 µL             |             20 µL               |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |       Air gap by volume      |  - 1--49.9 µL: 1 µL |       - 1--195 µL: 5 µL         |      - 10--990 µL: 10 µL        | 
        |                              |  - 50 µL: 0 µL      |       - 200 µL: 0 µL            |      - 1000 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 200 µL
        ...
        |    Delay after retracting    |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        |       Push out by volume     |        5 µL         |               5 µL              |
        +------------------------------+---------------------+---------------------------------+
        |       Air gap by volume      |  - 1--49 µL: 1 µL   |       - 1 µL: 5 µL              | 
        |                              |  - 50 µL: 0 µL      |       - 195 µL: 5 µL            |
        |                              |                     |       - 200 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+
        |           Blow out           |  - at destination   |       - at destination          | 
        |                              |  - 80 µL/sec        |       - 80 µL/sec               |
        +------------------------------+---------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 1-ch. 1000 µL
        ...
        |                              |  - 50 µL: 0 µL      |       - 200 µL: 0 µL            |      - 1000 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |           Blow out           |  - at trash         |       - at trash                |      - at trash                 | 
        |                              |  - 478 µL/sec       |       - 716 µL/sec              |      - 716 µL/sec               |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 200 µL
        ...
        +------------------------------+---------------------+---------------------------------+
        |      Dispense flow rate      |                     |                                 |
        |                              |     80 µL/sec       |             200 µL/sec          |
        |                              |                     |                                 |
        +------------------------------+---------------------+---------------------------------+
        |     Correction by volume     |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        |    Conditioning by volume    |  - 1--45 µL: 5 µL   |          - 1--195 µL: 5 µL      | 
        |                              |  - 50 µL: 0 µL      |          - 200 µL: 0 µL         |
        +------------------------------+---------------------+---------------------------------+
        |       Disposal by volume     |  - 1--45 µL: 5 µL   |          - 1--195 µL: 5 µL      | 
        |                              |  - 50 µL: 0 µL      |          - 200 µL: 0 µL         |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after dispensing    |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        ...
        |    Delay after retracting    |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        |       Air gap by volume      |  - 1--49 µL: 1 µL   |       - 1--195 µL: 5 µL         | 
        |                              |  - 50 µL: 0 µL      |       - 200 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+
        |            Blow out          |  - at trash         |       - at trash                | 
        |                              |  - 80 µL/sec        |       - 80 µL/sec               |
        +------------------------------+---------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 1000 µL
        ...
        |     Correction by volume     |          --         |                 --              |                --               |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |    Conditioning by volume    |  - 1--45 µL: 5 µL   |          - 1--195 µL: 5 µL      |       - 1--995 µL: 5 µL         | 
        |                              |  - 50 µL: 0 µL      |          - 200 µL: 0 µL         |       - 1000 µL: 0 µL           |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |       Disposal by volume     |  - 1--45 µL: 5 µL   |          - 1--195 µL: 5 µL      |       - 1--995 µL: 5 µL         | 
        |                              |  - 50 µL: 0 µL      |          - 200 µL: 0 µL         |       - 1000 µL: 0 µL           |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |    Delay after dispensing    |          --         |                 --              |                --               |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 1-ch. 50 µL
        ...
        |                              | - 50 µL: 50 µL/sec  |
        +------------------------------+---------------------+
        |     Correction by volume     | - 1 µL: -0.2 µL     |
        |                              | - 10 µL: 0.1 µL     |
        |                              | - 50 µL: -0.2 µL    |
        +------------------------------+---------------------+
    ...
    .. tab:: 1-ch. 1000 µL
        ...
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |     Correction by volume     |  - 5 µL: -0.25 µL   |    - 5 µL: -0.2 µL              |         - 10 µL: -0.2 µL        |
        |                              |  - 10 µL: 0.1 µL    |    - 50 µL: -0.3 µL             |         - 100 µL: -0.1 µL       |
        |                              |  - 50 µL: 0.2 µL    |    - 200 µL: -0.8 µL            |         - 1000 µL: 12 µL        |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 200 µL
        ...
        |           Behavior           |        50 µL        |               200 µL            |
        +==============================+=====================+=================================+
        |        Submerge speed        |      10 mm/sec      |             10 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        | Aspirate flow rate by volume |  - 1 µL: 7 µL/sec   |  - 5 µL: 10 µL/sec              |
        |                              |  - 10 µL: 10 µL/sec |  - 50 µL: 50 µL/sec             |
        |                              |  - 50 µL: 40 µL/sec |  - 200 µL: 200 µL/sec           |
        +------------------------------+---------------------+---------------------------------+
        |     Correction by volume     |  - 0 µL: -0.1 µL    | - 0 µL: 0 µL                    |
        |                              |  - 5 µL: -0.25 µL   | - 5 µL: -0.2 µL                 |
        |                              |  - 10 µL: 0.1 µL    | - 50 µL: -0.3 µL                |
        |                              |  - 50 µL: 0.2 µL    | - 200 µL: -0.8 µL               |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after aspirating    |      2.0 sec        |           1.0 sec               |
        +------------------------------+---------------------+---------------------------------+
        |         Retract speed        |      10 mm/sec      |             10 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after retracting    |          --         |                 --              |
        +------------------------------+---------------------+---------------------------------+
        |       Air gap by volume      |         0 µL        |               0 µL              | 
        |                              |                     |                                 |
        +------------------------------+---------------------+---------------------------------+   
    ...
    .. tab:: 96-ch. 1000 µL
        ...
        |           Behavior           |        50 µL        |               200 µL            |             1000 µL             |
        +==============================+=====================+=================================+=================================+
        |        Submerge speed        |      10 mm/sec      |             10 mm/sec           |             10 mm/sec           |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        | Aspirate flow rate by volume |  - 1 µL: 7 µL/sec   |     - 5 µL: 10 µL/sec           |       - 10 µL: 10 µL/sec        |
        |                              |  - 10 µL: 10 µL/sec |     - 50 µL: 50 µL/sec          |       - 100 µL: 100 µL/sec      |
        ...
        |    Delay after aspirating    |       2 sec         |              1 sec              |             0.7 sec             |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |         Retract speed        |      10 mm/sec      |             10 mm/sec           |            10 mm/sec            |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |    Delay after retracting    |          --         |                 --              |               --                |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |              Air gap         |        0 µL         |                0 µL             |               0 µL              | 
...
.. tabs::
    ...
    .. tab:: 96-ch. 200 µL 
        ...
        |                              | - 50 µL: 0.2 µL       |  - 200 µL: -0.8 µL              |
        +------------------------------+-----------------------+---------------------------------+
        |    Delay after dispensing    |        1.0 sec        |            0.5 sec              |
        +------------------------------+-----------------------+---------------------------------+
        |         Retract speed        |      10 mm/sec        |             10 mm/sec           |
        +------------------------------+-----------------------+---------------------------------+
        |    Delay after retracting    |          --           |                 --              |
        +------------------------------+-----------------------+---------------------------------+
        |       Push out by volume     | - 1--4.9 µL: 11.7 µL  |              3.9 µL             |
        |                              | - 10--50 µL: 3.9 µL   |                                 |
        +------------------------------+-----------------------+---------------------------------+
        |       Air gap by volume      |        0 µL           |               0 µL              | 
        +------------------------------+-----------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 96-ch. 200 µL 
        ...
        +------------------------------+---------------------+---------------------------------+
        | Dispense flow rate by volume | - 1 µL: 7 µL/sec    |                                 |
        |                              | - 10 µL: 10 µL/sec  |             50 µL/sec           |
        |                              | - 50 µL: 40 µL/sec  |                                 |
        +------------------------------+---------------------+---------------------------------+
        |     Correction by volume     | - 5 µL: -0.3 µL     | - 0 µL: 0 µL                    |
        |                              | - 10 µL: -0.2 µL    | - 5--50 µL: -0.3 µL             | 
        |                              | - 50 µL: 0 µL       | - 200 µL: -0.8 µL               |
        +------------------------------+---------------------+---------------------------------+
        |    Conditioning by volume    |  - 1--40 µL: 5 µL   |          - 1--190 µL: 5 µL      | 
        |                              |  - 45--50 µL: 0 µL  |          - 195--200 µL: 0 µL    |
        +------------------------------+---------------------+---------------------------------+
        |       Disposal by volume     |  - 1--40 µL: 5 µL   |          - 1--190 µL: 5 µL      | 
        |                              |  - 45--50 µL: 0 µL  |          - 195--200 µL: 0 µL    |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after dispensing    |        1.0 sec      |            0.5 sec              |
        +------------------------------+---------------------+---------------------------------+
    ...
    .. tab:: 96-ch. 1000 µL
        ...
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |            Blow out          |  - at trash         |  - at trash                     |  - at trash                     |
        |                              |  - 40 µL/sec        |  - 50 µL/sec                    |  - 224 µL/sec                   | 
        +------------------------------+---------------------+---------------------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 96-ch. 200 µL 
        ...
        |        Submerge speed        |      35 mm/sec      |             35 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        | Aspirate flow rate by volume |  - 1 µL: 7 µL/sec   |   - 5 µL: 7 µL/sec              |
        |                              |  - 10 µL: 10 µL/sec |   - 50 µL: 50 µL/sec            |
        |                              |  - 50 µL: 30 µL/sec |   - 200 µL: 200 µL/sec          |
        +------------------------------+---------------------+---------------------------------+
        |     Correction by volume     |  - 0 µL: -0.1 µL    |   - 0 µL: 0 µL                  |
        |                              |  - 5 µL: -0.35 µL   |   - 5 µL: 0.7 µL                |
        |                              |  - 10 µL: -0.08 µL  |   - 50 µL: -2.2 µL              |
        |                              |  - 50 µL: -1.34 µL  |   - 200 µL: -8.9 µL             |
        +------------------------------+---------------------+---------------------------------+
        |    Conditioning by volume    |  - 1--45 µL: 5 µL   |          - 1--195 µL: 5 µL      | 
        |                              |  - 50 µL: 0 µL      |          - 200 µL: 0 µL         |
        +------------------------------+---------------------+---------------------------------+
        ...
        |         Retract speed        |      35 mm/sec      |             35 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after retracting    |      0.2 sec        |             0.5 sec             |
        +------------------------------+---------------------+---------------------------------+
        |       Air gap by volume      |  - 1--45 µL: 5 µL   |       - 5--190 µL: 10 µL        | 
        |                              |  - 50 µL: 0 µL      |       - 200 µL: 0 µL            |
        +------------------------------+---------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 96-ch. 200 µL 
        ...
        |        Submerge speed        |      35 mm/sec        |             35 mm/sec           |
        +------------------------------+-----------------------+---------------------------------+
        |      Dispense flow rate      |- 0 µL: 7 µL/sec       |   - 0 µL: 7 µL/sec              |
        |                              |- 10--50 µL: 60 µL/sec |   - 10--200 µL: 100 µL/sec      |
        |                              |                       |                                 |
        +------------------------------+-----------------------+---------------------------------+
        |     Correction by volume     | - 0 µL: -0.1 µL/sec   | - 0 µL: 0 µL                    |
        |                              | - 5 µL: -0.35 µL/sec  | - 5 µL: 0.7 µL                  |
        |                              | - 10 µL: 0.08 µL/sec  | - 50 µL: -2.2 µL                |
        |                              | - 50 µL: -1.34 µL/sec | - 200 µL: -8.9 µL               |
        +------------------------------+-----------------------+---------------------------------+
        |    Conditioning by volume    |  - 1--45 µL: 5 µL     |          - 1--195 µL: 5 µL      | 
        |                              |  - 50 µL: 0 µL        |          - 200 µL: 0 µL         |
        +------------------------------+-----------------------+---------------------------------+
        ...
        |                              |  - 50 µL: 0 µL        |          - 200 µL: 0 µL         |
        +------------------------------+-----------------------+---------------------------------+
        |    Delay after dispensing    |       0.2 sec         |               0.2 sec           |
        +------------------------------+-----------------------+---------------------------------+
        |         Retract speed        |      35 mm/sec        |             35 mm/sec           |
        +------------------------------+-----------------------+---------------------------------+
        |    Delay after retracting    |       0.5 sec         |              0.5 sec            |
        +------------------------------+-----------------------+---------------------------------+
        |     Push out by volume       |         0 µL          |             0 µL                |
        +------------------------------+-----------------------+---------------------------------+
        |       Air gap by volume      |  - 1--45 µL: 5 µL     |       - 5--190 µL: 10 µL        | 
        |                              |  - 50 µL: 0 µL        |       - 200 µL: 0 µL            |
        +------------------------------+-----------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 96-ch. 200 µL 
        ...
        +------------------------------+---------------------+---------------------------------+
        |      Dispense flow rate      |                     |                                 |
        |                              |     100 µL/sec      |             100 µL/sec          |
        |                              |                     |                                 |
        +------------------------------+---------------------+---------------------------------+
        |    Correction by volume      |  - 0 µL: 0 µL       |  - 0 µL: 0 µL                   | 
        |                              |  - 5 µL:-2.1 µL     |  - 5 µL: -1.5 µL                |
        |                              |  - 10 µL: -1.7 µL   |  - 50 µL: -2.2 µL               |
        |                              |  - 50 µL: -3.3 µL   |  - 200 µL: -7.4 µL              |
        +------------------------------+---------------------+---------------------------------+
        |    Conditioning by volume    |  - 1--40 µL: 5 µL   |          - 1--190 µL: 5 µL      | 
        |                              |  - 45--50 µL: 0 µL  |          - 195--200 µL: 0 µL    |
        |                              |                     |                                 |
        |                              |                     |                                 |
        +------------------------------+---------------------+---------------------------------+
        |       Disposal by volume     |  - 1--40 µL: 5 µL   |          - 1--195 µL: 5 µL      | 
        |                              |  - 45--50 µL: 0 µL  |          - 200 µL: 0 µL         |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after dispensing    |       2.0 sec       |              1.0 sec            |
        +------------------------------+---------------------+---------------------------------+
        |         Retract speed        |      35 mm/sec      |             35 mm/sec           |
        +------------------------------+---------------------+---------------------------------+
        |    Delay after retracting    |        0.5 sec      |              0.5 sec            |
