...
.. tabs::
    ...
    .. tab:: 96-ch. 1000 µL
        ...
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        | Aspirate flow rate by volume |     200 µL/sec      |             200 µL/sec          |            200 µL/sec           |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |     Correction by volume     |          --         |                 --              |                --               |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |    Delay after aspirating    |       0.5 sec       |              0.75 sec           |             0.5 sec             |
...
.. tabs::
    ...
    .. tab:: 1-ch. 50 µL
        ...
        |        Submerge speed        |     100 mm/sec       |
        +------------------------------+----------------------+
        | Dispense flow rate by volume |        50 µL         |
        +------------------------------+----------------------+
        |     Correction by volume     |         --           |
        +------------------------------+----------------------+
...
.. tabs::
    ...
    .. tab:: 1-ch. 1000 µL
        ...
        |    Delay after retracting    |          --         |                 --              |               --                |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        |       Air gap by volume      |        0 µL         |                0 µL             |               0 µL              | 
        +------------------------------+---------------------+---------------------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 1-ch. 50 µL 
        ...
        |        Submerge speed        |       4 mm/sec        |
        +------------------------------+-----------------------+
        | Dispense flow rate by volume |      25 µL/sec        |
        +------------------------------+-----------------------+
        |     Correction by volume     |  - 1 µL: -0.5 µL      |
        |                              |  - 10--50 µL: -0.2 µL |
        +------------------------------+-----------------------+
    ...
    .. tab:: 1-ch. 1000 µL
        ...
        |        Submerge speed        |      4 mm/sec       |              4 mm/sec           |            4 mm/sec             |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
        | Dispense flow rate by volume |      50 µL/sec      |              50 µL/sec          |          250 µL/sec             |
        +------------------------------+---------------------+---------------------------------+---------------------------------+
...
.. tabs::
    ...
    .. tab:: 1-ch. 50 µL
        ...
        |        Submerge speed        |       100 mm/sec      |
        +------------------------------+-----------------------+
        | Dispense flow rate by volume |      30 µL/sec        |
        +------------------------------+-----------------------+
        |     Correction by volume     |  - 1 µL: -1.6 µL      |
        |                              |  - 10 uL: -1.1 uL     |
        |                              |  - 50 µL: -3.0 µL     |
...
.. tabs::
    ...
    .. tab:: 1-ch. 50 µL
        ...
        |        Submerge speed        |     100 mm/sec       |
        +------------------------------+----------------------+
        | Dispense flow rate by volume |        30 µL         |
        +------------------------------+----------------------+
        |     Correction by volume     |  - 1 µL: -1.6 µL     |
        |                              |  - 10 µL: -1.1 µL    |
        |                              |  - 50 µL: -3.0 µL    |
