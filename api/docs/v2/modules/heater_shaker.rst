...
The Heater-Shaker Module provides on-deck heating and orbital shaking. The module can heat from 20 to 95 °C, and can shake samples from 200 to 3000 rpm.
...
.. versionchanged:: 2.25
  The Heater-Shaker can cool samples as low as 20 °C.


You can also hold samples at room temperature. Set the Heater-Shaker's temperature at least 1.5 °C higher than room temperature, or the API will raise an error. 
