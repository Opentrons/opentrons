...
# We're using a custom layout.html to only output the body or <article> tags
# but with the all the tags associated with the style
# this allows us directly grab the HTML and pipe it into the new tool
...
html_theme_options = {
    ...
    'nav_title': 'Opentrons Python API V2 Documentation',
