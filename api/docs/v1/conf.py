...
# -*- coding: utf-8 -*-
#
# Opentrons API V1 documentation build configuration file, created by
...
html_theme_options = {
    ...
    'extra_nav_links': {
        'Download As PDF': '../OpentronsPythonAPIV1.pdf',
        'OT-2 Python API Version 2': '../v2/index.html',
        'OT-One API': '../ot1/index.html'
    }
}
...
#
html_title = 'OT-2 Python API Version 1 Documentation'
...
htmlhelp_basename = 'OpentronsAPIV1doc'
