...
.. testcode:: examples
  ...
  trough = containers.load('trough-12row', '7')

  tiprack_1 = containers.load('tiprack-200ul', '1')
  tiprack_2 = containers.load('tiprack-200ul', '2')
...
.. testcode:: examples
  ...
  for i in range(12):
    p300.distribute(20, trough.wells(i), plate.rows(i))
...
.. testcode:: examples
  ...
  for well in trough.wells():
    p300.aspirate(5, well).air_gap(10)
...
.. testcode:: examples
  ...
  for i in range(8):
    ...
    p300.transfer(10, source, column.wells('1'))
