...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ["p50_single_v2.0", ("p50", 1, 2.0)],
        ["p1000_multi_v1.0", ("p1000", 8, 1.0)],
        ["p1000_96_v1.0", ("p1000", 96, 1.0)],
    ],
)
def test_convert_pipette_model(
    model: PipetteModel, output: Tuple[str, int, float]
) -> None:
...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ["p50_single", ("p50", 1, 1.0)],
        ["p1000_multi_gen3", ("p1000", 8, 3.0)],
        ["p300_single_gen2", ("p300", 1, 2.0)],
    ],
)
def test_convert_pipette_name(
    name: PipetteName, output: Tuple[str, int, float]
) -> None:
