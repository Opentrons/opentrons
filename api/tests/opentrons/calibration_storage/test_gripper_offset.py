...
def starting_calibration_data(
    ...
    gripper.save_gripper_calibration(Point(1, 2, 1), cs_types.GripperId("gripper2"))
...
def test_delete_all_gripper_calibration(starting_calibration_data: typing.Any) -> None:
    ...
    assert (
        gripper.get_gripper_calibration_offset(cs_types.GripperId("gripper2"))
        is not None
    )
    ...
    assert (
        gripper.get_gripper_calibration_offset(cs_types.GripperId("gripper2")) is None
    )
