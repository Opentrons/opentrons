...
def run(protocol_context):
    ...
    p300.flow_rate.aspirate = 10
    p300.pick_up_tip()
    p300.aspirate(22, mag_samples[0].bottom(0.25))
    ...
    # Transfer beads to the samples in PCR strip3
