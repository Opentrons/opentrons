...
def subject() -> LiquidView:
    ...
    state = LiquidState(liquids=[Liquid(id="water-id", display_name="water", description="water desc")])
...
def test_get_all(subject: LiquidView) -> None:
    ...
    assert subject.get_all() == [Liquid(id="water-id", display_name="water", description="water desc")]
