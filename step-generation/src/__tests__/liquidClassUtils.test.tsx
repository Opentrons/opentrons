    ...
    expect(
      getCustomLiquidClassProperties({
        args: {
          ...
          aspirateSubmergeDelay: { seconds: 5, mmFromBottom: 0 },
          aspirateRetractDelay: { seconds: 10, mmFromBottom: 0 },
          dispenseSubmergeDelay: { seconds: 50, mmFromBottom: 0 },
          dispenseRetractDelay: { seconds: 40, mmFromBottom: 0 },
          sourceWells: ['A1'],
          destWells: ['A2'],
          ...
          aspirateDelay: { seconds: 12, mmFromBottom: 0 },
          dispenseDelay: { seconds: 20, mmFromBottom: 0 },
      ...
      `
custom_liquid_class_properties = {"p20_single_gen2": {"opentrons/opentrons_96_tiprack_20ul/1": {
    "aspirate": {
        "aspirate_position": {
            "offset": {"x": 0, "y": 0, "z": 2},
