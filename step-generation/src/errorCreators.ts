...
export const thermocyclerLidClosed = (): CommandCreatorError => {
  return {
    ...
    message: 'Attempted to interact with contents of a thermocycler with the lid closed.',
  }
}
...
export const heaterShakerLatchOpen = (): CommandCreatorError => {
  return {
    ...
    message: 'Attempted to interact with contents of a heater-shaker with the latch open.',
  }
}
...
export const heaterShakerIsShaking = (): CommandCreatorError => {
  return {
    ...
    message: 'Attempted to interact with the contents of a heater-shaker when it is shaking.',
  }
}
