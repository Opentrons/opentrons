...
def run(ctx):
    ...
    def lysis(vol, source):
        ...
        for i in range(num_cols):
            ...
            for x in range(8 if not dry_run else 1):
                m1000.aspirate(tvol * 0.75, cells_m[i].bottom(0.5))  # original = 0.5
        ...
        ctx.delay(
            ...
            msg="Please allow 1 minute incubation for cells to lyse",
        )
    ...
    def bind():
        ...
        ctx.delay(
            ...
            msg="Please allow 5 minute incubation for beads to bind to DNA",
        )
        h_s.deactivate_shaker()
    ...
    def wash(vol, source):
        ...
        ctx.delay(
            minutes=5 if not dry_run else 0.25,
            msg="Please allow 5 minute incubation for beads to mix in wash buffer",
        )
        h_s.deactivate_shaker()
    ...
    def dnase(vol, source):
        ...
        ctx.delay(
            ...
            msg="Please allow 10 minute incubation for DNAse1 to work",
        )
        h_s.deactivate_shaker()
    ...
    def stop_reaction(vol, source):
        ...
        ctx.delay(
            ...
            msg="Please allow 3 minute incubation to inactivate DNAse1",
        )
        h_s.deactivate_shaker()
    ...
    def elute(vol):
        ...
        ctx.delay(
            minutes=3 if not dry_run else 0.25,
            msg="Please allow 3 minute incubation to elute RNA from beads",
        )
        h_s.deactivate_shaker()
