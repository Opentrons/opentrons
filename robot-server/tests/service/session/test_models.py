...
def test_command_type_validation_jog():
    c = models.SessionCommand(**{'command': models.SessionCommands.jog,
                                 'data': {'vector': [1, 2, 3]}})
...
def test_command_type_validation_jog_fail():
    with pytest.raises(ValueError):
        models.SessionCommand(**{'command': models.SessionCommands.jog,
                                 'data': {}})
...
def test_command_type_empty():
    ...
    c = models.SessionCommand(
        **{'command': models.SessionCommands.prepare_pipette,
           'data': {}})
