...
from robot_server.service.legacy.models.settings import FactoryResetOption, FactoryResetOptions
...
def test_get_reset_options(subject: ResetOptionsManager):
    ...
    expected_options = FactoryResetOptions(options=[
        FactoryResetOption(id='bootScripts', name='Boot Scripts', description='Clear custom boot scripts'),
        FactoryResetOption(id='deckCalibration', name='Deck Calibration', description='Clear deck calibration (will also clear pipette offset)'),
        FactoryResetOption(id='pipetteOffsetCalibrations', name='Pipette Offset Calibrations', description='Clear pipette offset calibrations'),
        FactoryResetOption(id='tipLengthCalibrations', name='Tip Length Calibrations', description='Clear tip length calibrations (will also clear pipette offset)'),
        FactoryResetOption(id='dbHistory', name='Clear Data and Restart Robot', description='Clear run/protocols history')])
