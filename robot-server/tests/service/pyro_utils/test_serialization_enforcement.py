...
PARAMETERS_MOCK_TABLE: Dict[str, Dict[type, Any]] = {
    ...
    "kwargs": {Any: {}},
    "machine_pos": {Dict[hw_types.Axis, float]: {hw_types.Axis.X: 0.0, hw_types.Axis.Y: 1.0, hw_types.Axis.Z: 3.0}},
    ...
    "position": {Mapping[hw_types.Axis, float]: {hw_types.Axis.X: 0.0, hw_types.Axis.Y: 1.0, hw_types.Axis.Z: 3.0}},
    "message": {str: "message"},
