...
def find_initial_speed(
    ...
    for axis in Axis.get_all_axes():
        ...
        if not axis_component or not prev_move:
...
def achievable_final(
    ...
    acceleration = np.dot(max_acceleration_vector, move.unit_vector)  # type: ignore[no-untyped-call]
