...
export const MAGNETIC_MODULE_V2_MAX_ENGAGE_HEIGHT = 40
export const MAGNETIC_MODULE_V2_DISNEGAGED_HEIGHT = -5

//  GEN 1 magnetic module info
export const MAGNETIC_MODULE_V1_MAX_ENGAGE_HEIGHT = 16
export const MAGNETIC_MODULE_V1_DISNEGAGED_HEIGHT = -4
