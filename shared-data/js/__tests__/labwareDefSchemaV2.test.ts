...
const expectedWellsHigherThanZDimension: Record<string, Set<string>> = {
  ...
  "opentrons_24_tuberack_eppendorf_2ml_safelock_snapcap/1.json":
    standard24WellNames,
  "opentrons_24_tuberack_eppendorf_2ml_safelock_snapcap/2.json":
    standard24WellNames,
...
const expectedWellsNotMatchingZDimension: Record<string, Set<string>> = {
  ...
  "opentrons_40_aluminumblock_eppendorf_24x2ml_safelock_snapcap_generic_16x0.2ml_pcr_strip/1.json":
    new Set([
      "A3",
      "B3",
      "C3",
  ...
  "opentrons_96_flat_bottom_adapter_nest_wellplate_200ul_flat/1.json":
    standard96WellNames,
  "opentrons_96_pcr_adapter_nest_wellplate_100ul_pcr_full_skirt/1.json":
    standard96WellNames,
  "opentrons_universal_flat_adapter_corning_384_wellplate_112ul_flat/1.json":
