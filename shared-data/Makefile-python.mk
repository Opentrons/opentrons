...
lint: $(py_sources)
	...
	$(python) -m ruff check python/opentrons_shared_data python_tests tools

.PHONY: format
format:
	$(python) -m ruff format python/opentrons_shared_data python_tests tools
	$(python) -m ruff check --fix --unsafe-fixes python/opentrons_shared_data python_tests tools
