...
import one_tiprack from './oneTiprack.json'
import simple_v6 from './simpleV6.json'
import temp_and_mag_module_commands from './tempAndMagModuleCommands.json'
import transfer_settings from './transferSettings.json'
