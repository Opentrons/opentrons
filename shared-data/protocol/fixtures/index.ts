...
import multiple_tipracks from './6/multipleTipracks.json'
import multiple_tipacks_with_tc from './6/multipleTipracksWithTC.json'
import one_tiprack from './6/oneTiprack.json'
...
export { simple_v4, test_modules_protocol }
