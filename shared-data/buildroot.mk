...
PYTHON_OPENTRONS_SHARED_DATA_SETUP_TYPE = hatch
PYTHON_OPENTRONS_SHARED_DATA_SITE_METHOD = local
PYTHON_OPENTRONS_SHARED_DATA_SITE = $(BR2_EXTERNAL_OPENTRONS_MONOREPO_PATH)
PYTHON_OPENTRONS_SHARED_DATA_DEPENDENCIES = host-python-hatch-vcs host-python-hatch-vcs-tunable
PYTHON_OPENTRONS_SHARED_DATA_SUBDIR = shared-data
PYTHON_OPENTRONS_SHARED_DATA_ENV = \
  HATCH_VCS_TUNABLE_TAG_PATTERN="$(call git_tag_regex_for_project,$(PROJECT))" \
  HATCH_VCS_TUNABLE_RAW_OPTIONS="$(call hatch_raw_options_for_project,$(PROJECT));root=$(shell realpath --relative-to=$(PYTHON_OPENTRONS_SHARED_DATA_BUILDDIR) $(BR2_EXTERNAL_OPENTRONS_MONOREPO_PATH))"
