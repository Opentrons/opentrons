...
PYTHON_OPENTRONS_SHARED_DATA_SETUP_TYPE = pep517
PYTHON_OPENTRONS_SHARED_DATA_SITE_METHOD = local
PYTHON_OPENTRONS_SHARED_DATA_SITE = $(BR2_EXTERNAL_OPENTRONS_MONOREPO_PATH)
PYTHON_OPENTRONS_SHARED_DATA_DEPENDENCIES = host-python-hatchling host-python-hatch-vcs host-python-hatch-vcs-tunable
