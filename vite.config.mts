...
export default defineConfig({
  ...
  define: {
    ...
    _OT_PD_BUILD_DATE_: process.env.OT_PD_BUILD_DATE,
    _OT_PD_MIXPANEL_DEV_ID_: process.env.OT_PD_MIXPANEL_DEV_ID,
    _OT_PD_MIXPANEL_ID_: process.env.OT_PD_MIXPANEL_ID,
    _OT_PD_SENTRY_DEV_DSN_: process.env.OT_PD_SENTRY_DEV_DSN,
    _OT_PD_SENTRY_DSN_: process.env.OT_PD_SENTRY_DSN,
    _OT_PD_VERSION_: process.env.OT_PD_VERSION,
    global: 'globalThis',
  },
  resolve: {
    alias: {
