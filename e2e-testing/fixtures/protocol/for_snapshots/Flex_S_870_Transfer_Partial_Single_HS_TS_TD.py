...
metadata = {
    ...
    "lastModified": "2026-01-09T20:17:56.004Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    adapter_3 = temperature_module_1.load_adapter(
    ...
    well_plate_1 = adapter_3.load_labware(
        "nest_96_wellplate_2ml_deep",
        namespace="opentrons",
        version=5,
    )
    well_plate_2 = adapter_2.load_labware(
