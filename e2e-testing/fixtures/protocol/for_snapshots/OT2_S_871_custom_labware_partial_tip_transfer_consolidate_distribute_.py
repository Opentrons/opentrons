...
metadata = {
    ...
    "lastModified": "2026-01-09T19:06:22.372Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    pipette_right.distribute_with_liquid_class(
        ...
        dest=[well_plate_2["A3"], well_plate_2["A4"], well_plate_2["A5"], well_plate_2["A6"], well_plate_2["A7"], well_plate_2["A8"]],
        new_tip="once",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    pipette_right.transfer_with_liquid_class(
        ...
        dest=[well_plate_2["A1"], well_plate_2["A2"], well_plate_2["A3"], well_plate_2["A4"], well_plate_2["A5"], well_plate_2["A6"], well_plate_2["A7"], well_plate_2["A8"]],
        new_tip="once",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    # Step 4: pause
    protocol.pause("Cover DeepWell plates with sealing mat and shake at RT and 1000 rpm for 30 min in the dark. Then, place them back on positions 5 and 6 and resume protocol!")
    ...
    pipette_right.transfer_with_liquid_class(
        ...
        dest=[well_plate_3["A1"], well_plate_3["A2"], well_plate_3["A3"], well_plate_3["A4"], well_plate_3["A5"], well_plate_3["A6"], well_plate_3["A7"], well_plate_3["A8"]],
        new_tip="always",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    pipette_right.transfer_with_liquid_class(
        volume=10,
        source=[well_plate_3["A3"], well_plate_3["A4"], well_plate_3["A5"], well_plate_3["A6"], well_plate_3["A7"], well_plate_3["A8"]],
        dest=[well_plate_1["A12"], well_plate_1["A12"], well_plate_1["A12"], well_plate_1["A12"], well_plate_1["A12"], well_plate_1["A12"]],
        new_tip="always",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
