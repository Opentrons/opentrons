...
metadata = {
    ...
    "lastModified": "2026-05-29T16:17:35.832Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    tip_rack_4 = adapter_1.load_labware(
        "opentrons_flex_96_filtertiprack_1000ul",
    ...
    pipette.transfer_with_liquid_class(
        ...
        keep_last_tip=True,
        group_wells=False,
        tip_racks=[tip_rack_2, tip_rack_6, tip_rack_1, tip_rack_3],
    ...
    # Step 25: move
    protocol.move_labware(tip_rack_5, "B2", use_gripper=True)
    ...
    pipette.transfer_with_liquid_class(
        ...
        keep_last_tip=True,
        group_wells=False,
        tip_racks=[tip_rack_2, tip_rack_1, tip_rack_3, tip_rack_6],
        liquid_class=protocol.define_liquid_class(
    ...
    # Step 51: move
    protocol.move_labware(tip_rack_4, "C4", use_gripper=True)
    ...
    pipette.transfer_with_liquid_class(
        ...
        return_tip=True,
        group_wells=False,
        tip_racks=[tip_rack_2, tip_rack_6, tip_rack_1, tip_rack_4],
        liquid_class=protocol.define_liquid_class(
    ...
    # Step 72: move
    protocol.move_labware(tip_rack_3, "B4", use_gripper=True)
    ...
    # Step 77: move
    protocol.move_labware(tip_rack_5, "D4", use_gripper=True)
