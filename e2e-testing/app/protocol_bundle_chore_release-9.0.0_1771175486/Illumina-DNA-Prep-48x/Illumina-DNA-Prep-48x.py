...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if COLUMNS == 4:
        ...
        EPM_list =['A2','A2','A2','A2']
        TWB_list = ['A8','A8','A8','A8']
        ETOH_list = ['A6','A6','A6','A6']
    ...
    if COLUMNS == 5:
        ...
        EPM_list =['A2','A2','A2','A3','A3']
        TWB_list = ['A8','A8','A8','A9','A9']
        ETOH_list = ['A6','A6','A6','A7','A7']
    ...
    if COLUMNS == 6:
        ...
        EPM_list =['A2','A2','A2','A3','A3','A3']
        TWB_list = ['A8','A8','A8','A9','A9','A9']
        ETOH_list = ['A6','A6','A6','A7','A7','A7']
    ...
    if STEP_CLEANUP == True:
        ...
        for loop, X in enumerate(column_3_list):
            ...
            p50.move_to(CleanupBead.top(z=-3))
            #=====Reservoir Tip Touch========
            p50.default_speed = 100
            p50.move_to(CleanupBead.top().move(types.Point(x=4,z=-3)))
            p50.move_to(CleanupBead.top().move(types.Point(x=-4,z=-3)))
    ...
    if NOLABEL == False:
        ...
        if RES_TYPE_96x == False:
            ...
            reservoir.wells_by_name()['A3'].load_liquid(liquid=H20, volume=H20_Volume)
            reservoir.wells_by_name()['A4'].load_liquid(liquid=TAGSTOP, volume=TAGSTOP_Volume)
            if COLUMNS < 5:
                reservoir.wells_by_name()['A6'].load_liquid(liquid=EtOH, volume=ETOH_Volume)
                reservoir.wells_by_name()['A8'].load_liquid(liquid=TWB, volume=TWB_Volume)
            if COLUMNS == 5:
                reservoir.wells_by_name()['A6'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(3/5)))
                reservoir.wells_by_name()['A7'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(2/5)))
                reservoir.wells_by_name()['A8'].load_liquid(liquid=TWB, volume=(TWB_Volume*(3/5)))
                reservoir.wells_by_name()['A9'].load_liquid(liquid=TWB, volume=(TWB_Volume*(2/5)))
            if COLUMNS == 6:
                reservoir.wells_by_name()['A6'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(3/6)))
                reservoir.wells_by_name()['A7'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(3/6)))
                reservoir.wells_by_name()['A8'].load_liquid(liquid=TWB, volume=(TWB_Volume*(3/6)))
                reservoir.wells_by_name()['A9'].load_liquid(liquid=TWB, volume=(TWB_Volume*(3/6)))
        ...
        if RES_TYPE_96x == True:
            for loop, X in enumerate(TotalColumn):
                ...
                reservoir.wells_by_name()[X+'3'].load_liquid(liquid=H20, volume=H20_Volume)
                reservoir.wells_by_name()[X+'4'].load_liquid(liquid=TAGSTOP, volume=TAGSTOP_Volume)
                if COLUMNS < 5:
                    reservoir.wells_by_name()[X+'6'].load_liquid(liquid=EtOH, volume=ETOH_Volume)
                    reservoir.wells_by_name()[X+'8'].load_liquid(liquid=TWB, volume=TWB_Volume)
                if COLUMNS == 5:
                    reservoir.wells_by_name()[X+'6'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(3/5)))
                    reservoir.wells_by_name()[X+'7'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(2/5)))
                    reservoir.wells_by_name()[X+'8'].load_liquid(liquid=TWB, volume=(TWB_Volume*(3/5)))
                    reservoir.wells_by_name()[X+'9'].load_liquid(liquid=TWB, volume=(TWB_Volume*(2/5)))
                if COLUMNS == 6:
                    reservoir.wells_by_name()[X+'6'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(3/6)))
                    reservoir.wells_by_name()[X+'7'].load_liquid(liquid=EtOH, volume=(ETOH_Volume*(3/6)))
                    reservoir.wells_by_name()[X+'8'].load_liquid(liquid=TWB, volume=(TWB_Volume*(3/6)))
                    reservoir.wells_by_name()[X+'9'].load_liquid(liquid=TWB, volume=(TWB_Volume*(3/6)))
        ...
        for loop, X in enumerate(TotalColumn):
            ...
            if COLUMNS >= 5:
                reagent_plate_1.wells_by_name()[X+'2'].load_liquid(liquid=EPM, volume=EPM_Volume)
            if COLUMNS == 5:
                reagent_plate_1.wells_by_name()[X+'2'].load_liquid(liquid=EPM, volume=(EPM_Volume*(3/5)))
                reagent_plate_1.wells_by_name()[X+'3'].load_liquid(liquid=EPM, volume=(EPM_Volume*(2/5)))
            if COLUMNS == 6:
                reagent_plate_1.wells_by_name()[X+'2'].load_liquid(liquid=EPM, volume=(EPM_Volume*(3/6)))
                reagent_plate_1.wells_by_name()[X+'3'].load_liquid(liquid=EPM, volume=(EPM_Volume*(3/6)))
