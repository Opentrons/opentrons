...
def test_full_onboarding_flow(page: Page, pd_base_url: str) -> None:
    ...
    transfer_page.wells_select(location="Source", labwareName=labware_on_deck, wells=["A1"])
    transfer_page.wells_select(location="Destination", labwareName=labware_on_deck, wells=["A2"])
