...
metadata = {
    ...
    "lastModified": "2026-01-26T18:54:21.868Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    aluminum_block_1.load_liquid(
        wells=["A1", "B1", "A2", "B2", "A3", "B3", "A4", "B4", "A5", "B5", "A6", "B6"],
        liquid=liquid_2,
        volume=1800,
    )
    aluminum_block_1.load_liquid(
        wells=["C1", "D1", "C2", "D2", "C3", "D3", "C4", "D4", "C5", "D5", "C6", "D6"],
        liquid=liquid_3,
        volume=1800,
    )
