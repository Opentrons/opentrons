...
metadata = {
    ...
    "lastModified": "2026-01-26T19:57:31.801Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    pipette_right.distribute_with_liquid_class(
        ...
        dest=[well_plate_2["A8"], well_plate_2["A9"]],
        new_tip="always",
        trash_location=trash_bin_1,
        keep_last_tip=True,
        group_wells=False,
            ...
            properties={"flex_8channel_1000": {"opentrons/opentrons_flex_96_filtertiprack_1000ul/1": {
                ...
                "dispense": {
                    ...
                    "retract": {
                        ...
                        "speed": 100,
                        "touch_tip": {"enabled": False},
                        "blowout": {"enabled": True, "location": "trash", "flow_rate": 300},
                    },
                    "correction_by_volume": [(0, 0), (10, -0.9), (100, -2.6), (1000, -32.2)],
                    "push_out_by_volume": [(0, 0)],
                    "mix": {"enabled": False},
    ...
    pipette_right.consolidate_with_liquid_class(
        volume=100,
        source=[well_plate_1["A7"], well_plate_1["A8"]],
    ...
    pipette_right.distribute_with_liquid_class(
        volume=11,
        source=[well_plate_1["A7"]],
        dest=[well_plate_2["A2"], well_plate_2["B2"], well_plate_2["C2"]],
        new_tip="always",
        trash_location=trash_bin_1,
        keep_last_tip=True,
        group_wells=False,
    ...
    pipette_left.consolidate_with_liquid_class(
        volume=30,
        source=[well_plate_2["A8"], well_plate_2["B8"], well_plate_2["C8"], well_plate_2["D8"], well_plate_2["E8"], well_plate_2["F8"], well_plate_2["G8"], well_plate_2["H8"], well_plate_2["A9"], well_plate_2["B9"], well_plate_2["C9"], well_plate_2["D9"], well_plate_2["E9"], well_plate_2["F9"], well_plate_2["G9"], well_plate_2["H9"]],
        dest=[well_plate_1["B11"]],
        new_tip="always",
        trash_location=trash_bin_1,
        keep_last_tip=True,
        tip_racks=[tip_rack_1],
        liquid_class=protocol.define_liquid_class(
            name="consolidate_step_10",
