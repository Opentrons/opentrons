...
metadata = {
    ...
    "lastModified": "2026-01-26T19:57:21.984Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    lid_stack_C3 = protocol.load_lid_stack(
