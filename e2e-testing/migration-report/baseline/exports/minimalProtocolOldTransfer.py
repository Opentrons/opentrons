...
metadata = {
    ...
    "lastModified": "2026-01-26T18:53:03.497Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    well_plate_1.load_liquid(
        wells=["A1", "A2", "B1", "B2", "C1", "C2", "D1", "D2", "E1", "E2", "F1", "F2", "G1", "G2", "H1", "H2"],
        liquid=liquid_1,
        volume=200,
    )
