...
metadata = {
    ...
    "lastModified": "2026-01-26T19:58:09.034Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    pipette_left.transfer_with_liquid_class(
        volume=100,
        source=[well_plate_2["A1"], well_plate_2["B1"], well_plate_2["A2"], well_plate_2["B2"], well_plate_2["A3"], well_plate_2["B3"]],
        dest=[well_plate_2["A1"], well_plate_2["A1"], well_plate_2["A1"], well_plate_2["A1"], well_plate_2["A1"], well_plate_2["A1"]],
        new_tip="always",
