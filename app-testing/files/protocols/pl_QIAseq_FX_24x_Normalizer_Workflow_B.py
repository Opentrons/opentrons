def get_values(*names):
            import json
            _all_values = json.loads("""{"DRYRUN":false,"USE_GRIPPER":true,"TIP_TRASH":true,"DEACTIVATE_TEMP":true,"COLUMNS":3,"FRAGTIME":15,"PCRCYCLES":6,"DEFAULT_OFFSETS":true,"protocol_filename":"QIAseq_FX_24x_Normalizer_Workflow_B"}""")
