def get_values(*names):
            import json
            _all_values = json.loads("""{"pipette_type":"flex_8channel_1000","mount_side":"right","tip_type":"1000f","trough_type":"nest_12_reservoir_15ml","plate_type":"nest_96_wellplate_200ul_flat","dilution_factor":3,"num_of_dilutions":10,"total_mixing_volume":150,"blank_on":true,"tip_use_strategy":"never","air_gap_volume":10,"protocol_filename":"Flex_customizable_serial_dilution_upload"}""")
