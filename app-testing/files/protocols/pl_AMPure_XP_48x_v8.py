...
def add_parameters(parameters):
    ...
    parameters.add_str(
        ...
        choices=[
        {"display_name": "Single Sided", "value": "Single Sided"},
        {"display_name": "Double Sided", "value": "Double Sided"}])
    parameters.add_bool(
    ...
    parameters.add_str(
        ...
        choices=[
        {"display_name": "Trash Chute in D3", "value": "CHUTE"},
        {"display_name": "Trash Bin in A3", "value": "BIN"}])
    parameters.add_str(
