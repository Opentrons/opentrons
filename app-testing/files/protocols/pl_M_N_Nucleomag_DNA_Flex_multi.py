...
def run(ctx):
    ...
    try:
        [res_type,temp_mod,trash_chute,USE_GRIPPER, Macherey_Nagel_DW,dry_run,inc_lysis,mount,num_samples,heater_shaker,wash1_vol,wash2_vol,wash3_vol,wash4_vol,lysis_vol,bind_vol,elution_vol] = get_values(  # noqa: F821
        'res_type','temp_mod','trash_chute','USE_GRIPPER','Macherey_Nagel_DW','dry_run','inc_lysis','mount','num_samples','heater_shaker','wash1_vol','wash2_vol','wash3_vol','wash4_vol','lysis_vol','bind_vol','elution_vol')
