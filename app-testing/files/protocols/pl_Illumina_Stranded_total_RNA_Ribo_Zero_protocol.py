...
def run(ctx):
    ...
    if Columns==1:
        ...
        if Columns==5:
            p50             =ctx.load_instrument('flex_8channel_50','right', tip_racks=[tip50_1,tip50_2,tip50_3,tip50_4,tip50_5,tip50_6,tip50_7,tip50_8,tip50_9,tip50_10,tip50_11,tip50_12])
        ...
        if Columns==6:
            p50				=ctx.load_instrument('flex_8channel_50','right', tip_racks=[tip50_1,tip50_2,tip50_3,tip50_4,tip50_5,tip50_6,tip50_7,tip50_8,tip50_9,tip50_10,tip50_11,tip50_12,tip50_13,tip50_14])
            p200			=ctx.load_instrument('flex_8channel_1000','left',tip_racks=[tip200_1,tip200_2,tip200_3,tip200_4,tip200_5,tip200_6,tip200_7,tip200_8,tip200_9,tip200_10,tip200_11,tip200_12,tip200_13])
    ...
    for x in range(Columns): #remove excess liquid
        get_next_tip(p50)
        p50.aspirate(50,sample_1_as[x].bottom(z=.5))
    ...
    for x in range(Columns): #remove supernatant
        ...
        if Columns>3:
            ...
            p200.aspirate(65,sample_1_as[x+4].bottom(z=.5))
    ...
    for x in range(Columns): #break surface tension here
        ...
        ctx.delay(seconds=3)
        p50.aspirate(2.5,LIGX.bottom(z=.3))
    ...
    if on_deck_thermo==True:
        ...
        if DryRun==False:
            profile_PCR_1 = [
                {'temperature':98, 'hold_time_minutes': 30}
                ]
