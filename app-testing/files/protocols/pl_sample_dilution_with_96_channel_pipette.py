...
def run(ctx: protocol_api.ProtocolContext):
    ...
    tiprack_adapter = ctx.load_labware('opentrons_flex_96_tiprack_50ul',
                       'A1', adapter='opentrons_flex_96_tiprack_adapter')
    ...
    pip = ctx.load_instrument(
        "flex_96channel_1000", 'left', tip_racks = [tiprack_adapter])
