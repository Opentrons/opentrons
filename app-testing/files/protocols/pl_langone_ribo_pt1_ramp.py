def get_values(*names):
            import json
            _all_values = json.loads("""{"num_samp":8,"real_mode":true,"m50_mount":"left","m200_mount":"right","protocol_filename":"langone_ribo_pt1_ramp"}""")
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    [num_samp, real_mode, m50_mount, m200_mount] = get_values(  # noqa: F821
        "num_samp", "real_mode", "m50_mount", "m200_mount")
