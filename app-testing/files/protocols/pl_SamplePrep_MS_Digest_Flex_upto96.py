def get_values(*names):
            import json
            _all_values = json.loads("""{"NUM_SAMPLES":96,"LABWARE_SAMPLE":24,"PIPET_LOCATION":1,"DIGESTION_TIME_PRESET":1,"DIGESTION_TIME":24,"protocol_filename":"SamplePrep_MS_Digest_Flex_upto96"}""")
...
def run(ctx):
    ...
    if LABWARE_SAMPLE == 24: s1000 = ctx.load_instrument('flex_1channel_1000', s1000_loc)
    ...
    if DIGESTION_TIME_PRESET == 1: ctx.delay(minutes=DIGESTION_TIME*60)
