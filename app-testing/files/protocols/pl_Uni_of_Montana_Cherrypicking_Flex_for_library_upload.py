def get_values(*names):
            import json
            _all_values = json.loads("""{"pipette_type":"flex_1channel_50","pipette_mount":"right","transfer_csv":"Source Labware,Source Slot,Source Well,Source Aspiration Height Above Bottom (in mm),Dest Labware,Dest Slot,Dest Well,Volume (in ul)\\nagilent_1_reservoir_290ml,1,A1,1,nest_96_wellplate_100ul_pcr_full_skirt,4,A11,1\\nnest_12_reservoir_15ml,2,A1,1,nest_96_wellplate_2ml_deep,5,A5,3\\nnest_1_reservoir_195ml,3,A1,1,nest_96_wellplate_2ml_deep,5,H12,7\\n","protocol_filename":"Uni of Montana_Cherrypicking_Flex_for library upload"}""")
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    tiprack_map = {
        ...
        'p1000_single': {
            'standard': 'opentrons_flex_96_tiprack_1000ul',
            'filter': 'opentrons_flex_96_filtertiprack_1000ul',
