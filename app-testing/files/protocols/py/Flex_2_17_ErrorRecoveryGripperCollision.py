...
# metadata
metadata = {
    'protocolName': 'Error Recovery Testing Protocol - Gripper Collision',
    'author': 'Sara Kowalski',
    'description': 'Simple Protocol that user can use to trigger a gripper collision on the deck',
}
