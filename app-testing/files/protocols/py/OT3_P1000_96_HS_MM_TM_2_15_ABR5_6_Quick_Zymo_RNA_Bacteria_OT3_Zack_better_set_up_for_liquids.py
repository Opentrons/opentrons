...
Slot 1 = H-S with Nest DW (300 ul each well)
Slot 2 = Nest DW (800 ul each well)
Slot 3 = Temp Mod with Armadillo PCR plate (100ul each well)
Slot 4 = Magblock (empty)
Slot 5 = Nest DW (600 ul each well)
Slot 6 = Nest DW (500 ul each well)
Slot 7 = Nest DW (1600 ul each well)
Slot 8 = Nest DW (600 ul each well)
Slot 9 = Armadillo PCR plate (50 ul each well)
Slot 10 = 1000ul tips
