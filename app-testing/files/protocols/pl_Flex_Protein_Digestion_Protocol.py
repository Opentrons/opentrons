def get_values(*names):
            import json
            _all_values = json.loads("""{"num_plates":4,"aspirate_height":5,"dispense_height":5,"buffer_vol":100,"num_mix":3,"mix_vol":100,"mix_height":5,"protocol_filename":"Flex_Protein_Digestion_Protocol"}""")
...
def run(ctx: protocol_api.ProtocolContext):
    ...
    # labware
    assay_plates = (ctx.load_labware("thermo_96_wellplate_2200ul", location= slot, namespace = "custom_beta")
