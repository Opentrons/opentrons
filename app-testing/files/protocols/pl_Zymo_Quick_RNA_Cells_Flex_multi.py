def get_values(*names):
            import json
            _all_values = json.loads("""{"trash_chute":false,"USE_GRIPPER":true,"dry_run":false,"mount":"left","temp_mod":true,"heater_shaker":true,"res_type":"nest_12_reservoir_15ml","num_samples":8,"wash_vol":500,"stop_vol":500,"wash2_vol":700,"lysis_vol":200,"sample_vol":400,"bind_vol":400,"dnase_vol":50,"elution_vol":100,"protocol_filename":"Zymo_Quick-RNA_Cells-Flex_multi"}""")
