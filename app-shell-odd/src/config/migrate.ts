...
const CONFIG_VERSION_LATEST = 31 // update this after each config version bump
...
const toVersion28 = (prevConfig: ConfigV27): ConfigV28 => {
  const nextConfig = {
    ...prevConfig,
    version: 28 as const,
    ui: {
...
const toVersion31 = (prevConfig: ConfigV30): ConfigV31 => {
  const nextConfig = {
    ...prevConfig,
    version: 31 as const,
    protocols: {
      ...prevConfig.protocols,
      includeProtocolSourceInRunDownload: false,
    },
  }
  return nextConfig
}
...
const MIGRATIONS: [
  ...
  (prevConfig: ConfigV30) => ConfigV31,
] = [
  toVersion13,
  toVersion14,
  toVersion15,
