import { HostConfig, CalibrationStatus, getCalibrationStatus} from '@opentrons/api-client'
...
export function useCalibrationStatusQuery(
  options: UseQueryOptions<CalibrationStatus, Error, CalibrationStatus, Array<string | HostConfig>> = {},
