...
| ![Biohazard warning symbol](images/regulatory-marks/warning-biohazard.png "Warning: Biohazard") | **Warning: Biohazard!** The HEPA/UV Module is not a biosafety cabinet. <br> - Do not use it with pathogens. <br> - Do not use it in situations where volatiles or hazardous aerosolized materials are present. <br> - Do not use to filter particles smaller than 0.3 micrometers (µm). |
