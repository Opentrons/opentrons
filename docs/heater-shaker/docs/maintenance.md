...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>Includes ethyl/ethanol, isopropyl, and methanol.</li>
          <li>Dilute to 70% for cleaning.</li>
          <li>Do not use 100% alcohol.</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
          <li>Dilute to 10% (1:10 bleach/water ratio) for cleaning.</li>
          <li>Do not use 100% bleach.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>Distilled Water</td>
      <td>You can use distilled water to clean or rinse your Heater-Shaker.</td>
    </tr>
  </tbody>
</table>
