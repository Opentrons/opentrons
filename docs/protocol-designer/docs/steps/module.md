...
In this example, a Corning 96-well flat plate is placed on top of an Opentrons Uuniversal Flat Heater-Shaker adapter. Both are on the Heater-Shaker in deck slot D1. To safely shake labware with a lid, use the Universal Flat Heater-Shaker Adapter Type B. 
