...
You can customize settings for your mix step in a four-part form. Just like in a transfer step, start by selecting a pipette, tip rack, and labware. You can customize volume per well and the number of times the robot will mix. In the following forms, you can customize: 

- whether to use liquid class settings.
- aspirate and dispense settings like flow rate. 
- tip management settings, including how often the robot will select a new tip and which tip should be picked up.
- the tip drop location. 
