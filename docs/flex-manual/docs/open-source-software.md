...
Most of our software is in the [Opentrons/opentrons](https://github.com/Opentrons/opentrons) _monorepo_: a single repository that
...
| [`/app-shell-odd/`](https://github.com/Opentrons/opentrons/tree/edge/app-shell-odd)                                            | Electron application wrapper for the touchscreen software — "odd" stands for _on-device display_.                                                                                                                                                                       |
