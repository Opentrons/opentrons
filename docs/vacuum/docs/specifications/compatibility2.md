...
| Hydrochloric Acid (37% concentration) | :material-check-circle:{ .dark-green } Excellent |
...
| Dimethyl Sulfoxide (DMSO) | :material-alert-circle-outline:{ .gray } Moderate |
| Dimethylformamide (DMF) | :material-check-circle:{ .dark-green } Excellent |
| Ethanol | :material-check-circle:{ .dark-green } Excellent |
| Ethyl Acetate | :material-check-circle:{ .dark-green } Excellent |
| Formic Acid | :material-close-circle:{ .red } Not Recommended |
...
| Methylene Chloride (Dichloromethane/DCM) | :material-alert-circle-outline:{ .gray } Moderate |
...
| Trichloroacetic Acid (TCA) | :material-alert-circle-outline:{ .gray } Moderate |
...
| Hexane | :material-close-circle:{ .red } Not Recommended |
| Hydrochloric Acid (37% concentration) | :material-alert-circle-outline:{ .gray } Moderate |
| Isopropanol (IPA) | :material-check-circle:{ .dark-green } Excellent |
