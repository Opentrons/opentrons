...
!!! tip
    - For complete instructions on module installation, refer to the guide that shipped with your unit or the [online modules documentation](https://docs.opentrons.com/modules).
