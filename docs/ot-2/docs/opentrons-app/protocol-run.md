...
5. Review all the instruments and settings used by your protocol. For example, you can check instruments, perform a labware position check, check the camera status, and review each step in the protocol.
