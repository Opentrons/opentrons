...
<figcaption>The Protocols tab (empty vs. populated list).</figcaption>
</figure>
...
To add another protocol to your existing list, click **Import** in the top right corner of the app. This opens a file picker that lets you browse for the protocol file and add it to the list.
...
See the [Features Summary](./features.md) for more information about other protocol controls and settings in the Opentrons App.