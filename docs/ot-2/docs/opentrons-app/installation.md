...
The app opens automatically once installed. Grant it security or firewall permissions, if prompted, to make sure the app can launch and communicate with the OT-2 over your network.
