---
title: "Opentrons OT-2: Transferring Protocols"
---
...
Click the three-dot menu (⋮) on your protocol and choose **Send to Opentrons OT-2**. Choose a connected and available robot from the list to transfer the protocol. A message indicating a successful transfer will appear in the app. To set up your protocol, you need to move to the touchscreen and follow the steps in the Protocol Setup section.

<font color="red">CHECK THIS ON AN OT-2</font>
