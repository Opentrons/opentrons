...
> [!note]
> The Magnetic Block is compatible with Opentrons Flex only. If you have an OT-2, use the [Magnetic Module](magnetic_module.md).
...
Because the Magnetic Block is unpowered, neither your robot nor the Opentrons App is aware of this module. You "control" it via protocols to load labware onto the module and use the Opentrons Flex Gripper to move labware on and off the module. See [Moving Labware](../moving_labware.md) for more information.
