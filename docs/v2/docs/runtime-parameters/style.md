...
|---------------|----------------------|
| Dry run | ✅ Skip incubation delays and shorten mix steps.<br>❌ Whether to do a dry run. |
| Aspirate volume | ✅ How much to aspirate from each sample.<br>❌ Volume that the pipette will aspirate |
| Dilution factor | ✅ Each step uses this ratio of total liquid to original solution. Express the ratio as a decimal.<br>❌ total/diluent ratio for the process |
...
| Parameter name | Parameter description |
|---------------|----------------------|
| Number of columns | ✅ 1, 2, 3<br>❌ 1 column, 2 columns, 3 columns |
| Aspirate volume | ✅ 10 µL, 20 µL, 50 µL<br>✅ Low (10 µL), Medium (20 µL), High (50 µL)<br>❌ Low volume, Medium volume, High volume |
