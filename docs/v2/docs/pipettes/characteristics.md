...
[Pipette flow rates](#pipette-flow-rates) discuss how quickly each type of pipette can handle liquids. The defaults are designed to operate quickly, based on the pipette's hardware and assuming that you're handling aqueous liquids. You can speed up or slow down a pipette's flow rate to suit your protocol's needs.

Finally, the volume ranges of pipettes affect what you can do with them. The volume ranges for current pipettes are listed on the [Loading Pipettes](loading.md) page. The [OT-2 Pipette Generations](#ot2-pipette-generations) section of this page describes how the API behaves when running protocols that specify older OT-2 pipettes.
...
The eight pipette channels will only aspirate from every other well in the column: A1, C1, E1, G1, I1, K1, M1, and O1. Dispensing into B1 will only dispense into every other well in the column: B1, D1, F1, H1, J1, L1, N1, and P1.
...
|----------------------------|-------------|-------------------|
| P20 Single-Channel GEN2    | 1–20        | API v2.6+: 7.56<br>API v2.5-: 3.78 |
| P300 Single-Channel GEN2   | 20–300      | API v2.6+: 92.86<br>API v2.5-: 46.43 |
| P1000 Single-Channel GEN2  | 100–1000    | API v2.6+: 274.7<br>API v2.5-: 137.35 |
...
| GEN2 Pipette                | GEN1 Pipette                | GEN1 Volume (µL) |
|-----------------------------|-----------------------------|------------------|
| P20 Single-Channel GEN2     | P10 Single-Channel GEN1     | 1–10             |
| P20 Multi-Channel GEN2      | P10 Multi-Channel GEN1      | 1–10             |
| P300 Single-Channel GEN2    | P300 Single-Channel GEN1    | 30–300           |
| P300 Multi-Channel GEN2     | P300 Multi-Channel GEN1     | 20–200           |
| P1000 Single-Channel GEN2   | P1000 Single-Channel GEN1   | 100–1000         |
