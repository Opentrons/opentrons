...
| ![Symbol for warning](images/regulatory-marks/warning-label-caution.svg "Warning") | The Flex weighs 88.5 kg (195 lbs). As a result, moving or lifting it requires a team with sufficient personnel to ensure safe handling. See the [Relocation section](installation/relocation.md) in the Installation and Relocation chapter.                                                                        |
