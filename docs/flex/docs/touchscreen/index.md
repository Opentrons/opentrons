...
You can perform most functions either from the touchscreen or from a computer running the [Opentrons App](../opentrons-app/index.md). You can choose how to control Opentrons Flex, depending on the needs of your lab.  
