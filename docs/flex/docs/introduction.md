...
| **Compliance Ready Software** | [Opentrons Flex Compliance Ready Software](advanced-operation/compliance-ready.md) is an additional software feature that can be permanently installed on your Flex to enable 21 CFR part 11–ready operation. The software includes role-based user access, required logins, and documented user actions with timestamps and robot-generated records. |
