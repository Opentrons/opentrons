...
| **Opentrons Flex Compliance Ready Software** | [Opentrons Flex Compliance Ready Software](https://opentrons.com/compliance-ready-software/) is additional software installed on your Flex to enable 21 CFR part 11–ready operation. The software permanently adds features like authorized user access, required documentation, and audit logs to your Flex. |
