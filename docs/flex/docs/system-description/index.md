...
- [Wired and wireless connectivity](connections.md) enables additional control from the Opentrons App (see the [Opentrons App chapter](../opentrons-app/index.md) for more details) and extending the system's features by attaching peripherals (see the [Modules chapter](../modules/index.md)).
