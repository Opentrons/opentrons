...
<p class="title">Stacker Instruction Manual</p>

<p><img src="../images/stacker-hero.png" alt="Opentrons Flex Stacker" title="Opentrons Flex Stacker" style="max-width: 100%;" /></p>
