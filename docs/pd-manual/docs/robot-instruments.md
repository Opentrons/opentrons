Click **Create a protocol** or **Create new** to get started building your protocol. First, select the robot you'll use. You can use Protocol Designer to create protocols that run on either the Opentrons Flex or the OT-2. 
...
To start, Protocol Designer will automatically assign deck space for modules and fixtures in your protocol. To avoid deck conflicts, choose whether your Flex protocol will include a Thermocycler module or waste chute. Both occupy a fixed deck space.
