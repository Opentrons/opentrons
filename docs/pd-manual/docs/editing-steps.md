...
[//]: # (work on the intro to this section; pulling apart existing text that no longer works)
...
<figure class="screenshot" markdown>
  ...
  <figcaption>Hover over a step to view details below.</figcaption>
  </figure>
...
The step name is displayed in the Opentrons App during your
protocol run.  
...
[//]: # (not sure about these headers. trying different things throughout to break up these pages)
