...
Swapping between Magnetic Module generations on the protocol
starting deck will clear any custom engage height values you
have entered. 

<figure class="screenshot" markdown>
  ![magnet step](images/engage_height.png)
  <figcaption>Protocol Designer includes instructions for converting engage heights between GEN1 and GEN2 modules.</figcaption>
  </figure>
