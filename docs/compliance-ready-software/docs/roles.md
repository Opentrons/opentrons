...
| **Administrator** | <ul><li>Full system access</li><li>Can change Flex system settings</li><li>Can send protocols to the Flex</li><li>Can view, download, and manage files</li><li>Day-to-day operation of the Flex</li></ul> |
| **User** | <ul><li>Day-to-day operation of the Flex</li><li>By default, can't send protocols to the Flex</li><li>Can view and download files</li></ul> |
...
Administrators can customize settings to change some user permissions. Read more in [Administrator settings](admin.md).
