---
title: "Compliance Ready Software: Accessing files"
...
By default, protocol run records are automatically deleted when the Flex's storage reaches its maximum of 20 run records. Administrators can [change this setting](../features/admin.md).
...
Like the Opentrons App, the Flex touchscreen includes a reminder to make sure you're ready to delete files. For safety, you're required to download your selected logs before deleting every time, even if you've already downloaded them.
