...
The Flex also supports external keyboards connect via [USB port]. When you use an external keyboard, the keyboard on the Flex touchscreen is hidden by default.
...
You can connect a USB storage device using one of the Flex's USB ports.