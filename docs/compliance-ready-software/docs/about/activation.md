...
- again, might need to choose and use a different word rather than "log files" that better encapsulates all the log types that are going to be generated by compliance-ready Flex 
