...
User actions, like setting up and running a protocol, require [documentation](documentation.md) on a compliance ready Flex. You can use a built-in or external keyboard to make adding documentation easier on the Flex touchscreen.
