...
When you update settings or software, you may need to use the encryption key to re-establish your Flex's connection.
...
1. On the Flex touchscreen, choose **Settings**, then tap **Robot encryption key**. 
2. Tap **View encryption key** to see the current key and the countdown to a new one.
