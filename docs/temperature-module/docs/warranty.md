...
Please have the module’s serial number available when contacting support. You can find the serial number on the bottom of the module or in the Opentrons App. To find the module serial number in the app, go to the Instruments and Modules section of your robot’s device details page, click the three dot menu ( ⋮ ) and then click About.
...
If you have any questions about the use of the system, abnormal phenomena, or special needs, please contact: support@opentrons.com. Also visit [opentrons.com](https://www.opentrons.com).
